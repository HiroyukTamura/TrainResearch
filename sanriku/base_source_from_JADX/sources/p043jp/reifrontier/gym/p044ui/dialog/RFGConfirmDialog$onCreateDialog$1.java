...
/* renamed from: jp.reifrontier.gym.ui.dialog.RFGConfirmDialog$onCreateDialog$1 */
final class RFGConfirmDialog$onCreateDialog$1 implements DialogInterface.OnClickListener {
    final /* synthetic */ RFGConfirmDialog this$0;

    RFGConfirmDialog$onCreateDialog$1(RFGConfirmDialog rFGConfirmDialog) {
    ...
    public final void onClick(DialogInterface dialogInterface, int i) {
        ...
        if (access$getMListener$p != null) {
            access$getMListener$p.onDismiss(false);
        }
    }
}
