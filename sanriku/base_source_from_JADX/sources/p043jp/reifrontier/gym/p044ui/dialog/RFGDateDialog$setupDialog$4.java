...
/* renamed from: jp.reifrontier.gym.ui.dialog.RFGDateDialog$setupDialog$4 */
final class RFGDateDialog$setupDialog$4 implements NumberPicker.OnValueChangeListener {
    final /* synthetic */ NumberPicker $dayPicker;
    final /* synthetic */ RFGDateDialog this$0;

    RFGDateDialog$setupDialog$4(RFGDateDialog rFGDateDialog, NumberPicker numberPicker) {
        this.this$0 = rFGDateDialog;
        this.$dayPicker = numberPicker;
    }

    public final void onValueChange(NumberPicker numberPicker, int i, int i2) {
        this.this$0.currentMonth = i2;
