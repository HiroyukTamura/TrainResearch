...
/* renamed from: jp.reifrontier.gym.ui.dialog.RFGEditActDialog$setupDialog$1 */
final class RFGEditActDialog$setupDialog$1 implements View.OnClickListener {
    final /* synthetic */ RFGEditActDialog this$0;

    RFGEditActDialog$setupDialog$1(RFGEditActDialog rFGEditActDialog) {
    ...
    public final void onClick(View view) {
        ...
        if (access$getMListener$p != null) {
            access$getMListener$p.finishEdit("bicycle");
        }
    }
}
