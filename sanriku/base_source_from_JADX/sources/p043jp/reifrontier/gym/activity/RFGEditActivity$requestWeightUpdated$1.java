...
/* renamed from: jp.reifrontier.gym.activity.RFGEditActivity$requestWeightUpdated$1 */
final class RFGEditActivity$requestWeightUpdated$1<T> implements C1741d<RFGH2Client.H2APIResponse> {
    final /* synthetic */ RFGEditActivity this$0;

    RFGEditActivity$requestWeightUpdated$1(RFGEditActivity rFGEditActivity) {
    ...
    public final void accept(RFGH2Client.H2APIResponse h2APIResponse) {
        ...
        RFGEditActivity rFGEditActivity = this.this$0;
        String string = rFGEditActivity.getString(R.string.error_update_user_info);
        Intrinsics.checkExpressionValueIsNotNull(string, "getString(R.string.error_update_user_info)");
        rFGEditActivity.errorDialog(string);
    }
}
