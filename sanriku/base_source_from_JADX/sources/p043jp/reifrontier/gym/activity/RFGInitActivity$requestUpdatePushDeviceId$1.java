...
/* renamed from: jp.reifrontier.gym.activity.RFGInitActivity$requestUpdatePushDeviceId$1 */
final class RFGInitActivity$requestUpdatePushDeviceId$1<T> implements C1741d<RFGH2Client.H2APIResponse> {
    final /* synthetic */ RFGInitActivity this$0;

    RFGInitActivity$requestUpdatePushDeviceId$1(RFGInitActivity rFGInitActivity) {
        this.this$0 = rFGInitActivity;
    }

    public final void accept(RFGH2Client.H2APIResponse h2APIResponse) {
        if (h2APIResponse.getCode() == 200) {
            this.this$0.requestUserAfterLogin();
        } else {
