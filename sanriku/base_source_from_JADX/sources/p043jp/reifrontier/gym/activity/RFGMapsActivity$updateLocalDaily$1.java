...
/* renamed from: jp.reifrontier.gym.activity.RFGMapsActivity$updateLocalDaily$1 */
final class RFGMapsActivity$updateLocalDaily$1<T> implements C1741d<String> {
    final /* synthetic */ RFGMapsActivity this$0;

    RFGMapsActivity$updateLocalDaily$1(RFGMapsActivity rFGMapsActivity) {
        this.this$0 = rFGMapsActivity;
    }

    public final void accept(String str) {
        RFGDaily rFGDaily;
        Intrinsics.checkExpressionValueIsNotNull(str, "dailyResult");
        if ((str.length() > 0) && (rFGDaily = (RFGDaily) new Gson().fromJson(str, new RFGMapsActivity$updateLocalDaily$1$turnsType$1().getType())) != null) {
