...
/* renamed from: jp.reifrontier.gym.activity.RFGInitActivity$requestResetPassword$1 */
final class RFGInitActivity$requestResetPassword$1<T> implements C1741d<RFGH2Client.H2APIResponse> {
    final /* synthetic */ RFGInitActivity this$0;

    RFGInitActivity$requestResetPassword$1(RFGInitActivity rFGInitActivity) {
        this.this$0 = rFGInitActivity;
    }

    public final void accept(RFGH2Client.H2APIResponse h2APIResponse) {
        RFGInitActivity rFGInitActivity;
        String str;
        if (h2APIResponse.getCode() == 200) {
            ...
            if (data != null) {
                ...
                if (rFGResponse.getResult() == null || !Intrinsics.areEqual((Object) rFGResponse.getResult(), (Object) FirebaseAnalytics.Param.SUCCESS)) {
                    ...
                    rFGInitActivity = this.this$0;
                    str = rFGInitActivity.getResources().getString(R.string.password_reset_error);
                } else {
                    this.this$0.stopLoading();
                    this.this$0.isLoading = false;
                    rFGInitActivity = this.this$0;
                    str = rFGInitActivity.getResources().getString(R.string.password_reset_success);
                    str2 = "resources.getString(R.st…g.password_reset_success)";
                }
                Intrinsics.checkExpressionValueIsNotNull(str, str2);
                rFGInitActivity.alertWith(str);
                return;
            }
