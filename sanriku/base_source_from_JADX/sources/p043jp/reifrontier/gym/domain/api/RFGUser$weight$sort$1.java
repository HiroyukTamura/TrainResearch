...
/* renamed from: jp.reifrontier.gym.domain.api.RFGUser$weight$sort$1 */
final class RFGUser$weight$sort$1<T> implements Comparator<RFGHistory> {
    public static final RFGUser$weight$sort$1 INSTANCE = new RFGUser$weight$sort$1();

    RFGUser$weight$sort$1() {
    }
