...
/* renamed from: jp.reifrontier.gym.data.RFGDataRemover$deleteRealm$1 */
final class RFGDataRemover$deleteRealm$1 implements Realm.Transaction {
    final /* synthetic */ Realm $realm;

    RFGDataRemover$deleteRealm$1(Realm realm) {
        this.$realm = realm;
    }
