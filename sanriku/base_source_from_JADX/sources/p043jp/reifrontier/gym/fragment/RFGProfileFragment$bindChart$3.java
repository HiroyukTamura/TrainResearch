...
/* renamed from: jp.reifrontier.gym.fragment.RFGProfileFragment$bindChart$3 */
final class RFGProfileFragment$bindChart$3<T> implements Comparator<RFGUserChartData> {
    public static final RFGProfileFragment$bindChart$3 INSTANCE = new RFGProfileFragment$bindChart$3();

    RFGProfileFragment$bindChart$3() {
    }
