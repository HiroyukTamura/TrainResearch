...
/* renamed from: jp.reifrontier.gym.fragment.RFGProfileFragment$bindChart$4 */
final class RFGProfileFragment$bindChart$4<T> implements Comparator<RFGUserChartData> {
    public static final RFGProfileFragment$bindChart$4 INSTANCE = new RFGProfileFragment$bindChart$4();

    RFGProfileFragment$bindChart$4() {
    }
