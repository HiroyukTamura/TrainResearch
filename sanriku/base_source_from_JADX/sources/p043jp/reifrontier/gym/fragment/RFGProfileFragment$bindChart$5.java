...
/* renamed from: jp.reifrontier.gym.fragment.RFGProfileFragment$bindChart$5 */
final class RFGProfileFragment$bindChart$5<T> implements Comparator<RFGUserChartData> {
    public static final RFGProfileFragment$bindChart$5 INSTANCE = new RFGProfileFragment$bindChart$5();

    RFGProfileFragment$bindChart$5() {
    }
