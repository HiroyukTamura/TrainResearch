...
/* renamed from: jp.reifrontier.gym.fragment.RFGProfileFragment$bindChart$1 */
final class RFGProfileFragment$bindChart$1<T> implements Comparator<RFGUserChartData> {
    public static final RFGProfileFragment$bindChart$1 INSTANCE = new RFGProfileFragment$bindChart$1();

    RFGProfileFragment$bindChart$1() {
    }
