...
final class Utils {
    ...
    private static final class GenericArrayTypeImpl implements GenericArrayType {
        ...
        public String toString() {
            return C0681a.m324a(new StringBuilder(), Utils.typeToString(this.componentType), "[]");
        }
    }
    ...
    private static final class WildcardTypeImpl implements WildcardType {
        ...
        public String toString() {
            ...
            if (this.lowerBound != null) {
                sb = C0681a.m330a("? super ");
                type = this.lowerBound;
            } else if (this.upperBound == Object.class) {
                return "?";
            } else {
                sb = C0681a.m330a("? extends ");
    ...
    static C0980J buffer(C0980J j) throws IOException {
        C2068f fVar = new C2068f();
        j.source().mo29134a((C2090x) fVar);
        return C0980J.create(j.contentType(), j.contentLength(), (C2072h) fVar);
    }
    ...
    static Type getParameterUpperBound(int i, ParameterizedType parameterizedType) {
        ...
        if (i < 0 || i >= actualTypeArguments.length) {
            StringBuilder b = C0681a.m338b("Index ", i, " not in range [0,");
            b.append(actualTypeArguments.length);
            b.append(") for ");
            b.append(parameterizedType);
    ...
    static RuntimeException methodError(Method method, Throwable th, String str, Object... objArr) {
        StringBuilder c = C0681a.m340c(String.format(str, objArr), "\n    for method ");
    ...
    static RuntimeException parameterError(Method method, int i, String str, Object... objArr) {
        StringBuilder c = C0681a.m340c(str, " (parameter #");
        c.append(i + 1);
        c.append(")");
        return methodError(method, c.toString(), objArr);
    }
    ...
    static RuntimeException parameterError(Method method, Throwable th, int i, String str, Object... objArr) {
        ...
        c.append(i + 1);
        c.append(")");
        return methodError(method, th, c.toString(), objArr);
    }
