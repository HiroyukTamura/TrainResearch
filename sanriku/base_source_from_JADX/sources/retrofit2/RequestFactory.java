...
final class RequestFactory {
    ...
    static final class Builder {
        ...
        private C1952y parseHeaders(String[] strArr) {
        ...
        private ParameterHandler<?> parseParameterAnnotation(int i, Type type, Annotation[] annotationArr, Annotation annotation) {
            ...
            Class<C1748C.C1751c> cls2 = C1748C.C1751c.class;
            if (annotation instanceof Url) {
                ...
                if (this.gotUrl) {
                    ...
                    this.gotUrl = true;
                    if (type == C1955z.class || type == cls || type == URI.class || ((type instanceof Class) && "android.net.Uri".equals(((Class) type).getName()))) {
                ...
                if (this.isMultipart) {
                    ...
                    if (!value5.isEmpty()) {
                        C1952y a = C1952y.f2848b.mo28130a("Content-Disposition", C0681a.m321a("form-data; name=\"", value5, "\""), "Content-Transfer-Encoding", part.encoding());
                        if (Iterable.class.isAssignableFrom(rawType8)) {
                            if (type instanceof ParameterizedType) {
                                ...
                                if (!cls2.isAssignableFrom(Utils.getRawType(parameterUpperBound4))) {
                                    return new ParameterHandler.Part(this.method, i, a, this.retrofit.requestBodyConverter(parameterUpperBound4, annotationArr, this.methodAnnotations)).iterable();
                                }
                            ...
                            if (!cls2.isAssignableFrom(boxIfPrimitive)) {
                                return new ParameterHandler.Part(this.method, i, a, this.retrofit.requestBodyConverter(boxIfPrimitive, annotationArr, this.methodAnnotations)).array();
                            }
                            throw Utils.parameterError(this.method, i, "@Part parameters using the MultipartBody.Part must not include a part name in the annotation.", new Object[0]);
                        } else if (!cls2.isAssignableFrom(rawType8)) {
                            return new ParameterHandler.Part(this.method, i, a, this.retrofit.requestBodyConverter(type, annotationArr, this.methodAnnotations));
                        } else {
                            throw Utils.parameterError(this.method, i, "@Part parameters using the MultipartBody.Part must not include a part name in the annotation.", new Object[0]);
                        }
                ...
                while (i2 >= 0) {
                    ...
                    if (!(parameterHandler instanceof ParameterHandler.Tag) || !((ParameterHandler.Tag) parameterHandler).cls.equals(rawType10)) {
                        ...
                        StringBuilder a2 = C0681a.m330a("@Tag type ");
                        a2.append(rawType10.getName());
                        a2.append(" is duplicate of parameter #");
                        a2.append(i2 + 1);
                        a2.append(" and would always overwrite its value.");
                        throw Utils.parameterError(method2, i, a2.toString(), new Object[0]);
                    }
                }
    ...
    /* access modifiers changed from: package-private */
    public C1755F create(Object[] objArr) throws IOException {
        ParameterHandler<?>[] parameterHandlerArr = this.parameterHandlers;
        ...
        if (length == parameterHandlerArr.length) {
            ...
            C1755F.C1756a aVar = requestBuilder.get();
            aVar.mo27547a(Invocation.class, new Invocation(this.method, arrayList));
            return aVar.mo27551a();
        }
        throw new IllegalArgumentException(C0681a.m322a(C0681a.m338b("Argument count (", length, ") doesn't match expected count ("), parameterHandlerArr.length, ")"));
    }
}
