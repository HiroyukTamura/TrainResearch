...
public class JsonReader implements Closeable {
        ...
        JsonReaderInternalAccess.INSTANCE = new JsonReaderInternalAccess() {
            public void promoteNameToValue(JsonReader jsonReader) throws IOException {
                ...
                if (i2 == 13) {
                    ...
                    StringBuilder a = C0681a.m330a("Expected a name but was ");
                    ...
                    while (i5 < i6) {
                        ...
                        if (c3 < '0' || c3 > '9') {
                            if (c3 >= 'a' && c3 <= 'f') {
                                ...
                                StringBuilder a = C0681a.m330a("\\u");
                                a.append(new String(this.buffer, this.pos, 4));
    ...
    public void beginArray() throws IOException {
        ...
        StringBuilder a = C0681a.m330a("Expected BEGIN_ARRAY but was ");
        a.append(peek());
        a.append(locationString());
        throw new IllegalStateException(a.toString());
    }
    ...
    public void beginObject() throws IOException {
        ...
        StringBuilder a = C0681a.m330a("Expected BEGIN_OBJECT but was ");
        a.append(peek());
        a.append(locationString());
        throw new IllegalStateException(a.toString());
    }
    ...
    public void endArray() throws IOException {
        ...
        StringBuilder a = C0681a.m330a("Expected END_ARRAY but was ");
        a.append(peek());
        a.append(locationString());
        throw new IllegalStateException(a.toString());
    }
    ...
    public void endObject() throws IOException {
        ...
        StringBuilder a = C0681a.m330a("Expected END_OBJECT but was ");
        a.append(peek());
        a.append(locationString());
        throw new IllegalStateException(a.toString());
    }
    ...
    public String getPath() {
        StringBuilder a = C0681a.m329a((char) Typography.dollar);
        int i = this.stackSize;
        for (int i2 = 0; i2 < i; i2++) {
            int i3 = this.stack[i2];
            if (i3 == 1 || i3 == 2) {
                a.append('[');
                a.append(this.pathIndices[i2]);
                a.append(']');
    ...
    public boolean nextBoolean() throws IOException {
        ...
        if (i == 5) {
            ...
            StringBuilder a = C0681a.m330a("Expected a boolean but was ");
            a.append(peek());
            a.append(locationString());
            throw new IllegalStateException(a.toString());
        }
    ...
    public double nextDouble() throws IOException {
        ...
        if (i == 16) {
            ...
            if (i == 8 || i == 9) {
                ...
                StringBuilder a = C0681a.m330a("Expected a double but was ");
                a.append(peek());
                a.append(locationString());
                throw new IllegalStateException(a.toString());
            }
    ...
    public int nextInt() throws IOException {
        ...
        if (i == 15) {
            ...
            StringBuilder a = C0681a.m330a("Expected an int but was ");
            a.append(this.peekedLong);
            a.append(locationString());
            throw new NumberFormatException(a.toString());
        }
        if (i == 16) {
            ...
            StringBuilder a2 = C0681a.m330a("Expected an int but was ");
            a2.append(peek());
        ...
        StringBuilder a3 = C0681a.m330a("Expected an int but was ");
        a3.append(this.peekedString);
        a3.append(locationString());
    ...
    public long nextLong() throws IOException {
        ...
        if (i == 16) {
            ...
            StringBuilder a = C0681a.m330a("Expected a long but was ");
            a.append(peek());
            a.append(locationString());
            throw new IllegalStateException(a.toString());
        }
        ...
        StringBuilder a2 = C0681a.m330a("Expected a long but was ");
        a2.append(this.peekedString);
        a2.append(locationString());
    ...
    public void nextNull() throws IOException {
        ...
        StringBuilder a = C0681a.m330a("Expected null but was ");
        a.append(peek());
        a.append(locationString());
        throw new IllegalStateException(a.toString());
    }
    ...
    public String nextString() throws IOException {
        ...
        if (i == 10) {
            ...
            if (i == 8) {
                ...
                StringBuilder a = C0681a.m330a("Expected a string but was ");
                a.append(peek());
                a.append(locationString());
                throw new IllegalStateException(a.toString());
            }
