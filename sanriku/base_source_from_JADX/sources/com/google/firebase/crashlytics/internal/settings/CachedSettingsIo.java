...
public class CachedSettingsIo {
    ...
    public JSONObject readCachedSettings() {
        ...
        Logger.getLogger().mo25712d("Reading cached settings...");
        ...
        try {
            ...
            if (settingsFile.exists()) {
                ...
                try {
                    ...
                    e = e;
                    try {
                        Logger.getLogger().mo25715e("Failed to fetch cached settings", e);
                ...
                Logger.getLogger().mo25712d("No cached settings found.");
                jSONObject = null;
            }
    ...
    public void writeCachedSettings(long j, JSONObject jSONObject) {
        Logger.getLogger().mo25712d("Writing settings to cache file...");
        if (jSONObject != null) {
            ...
            try {
                ...
                try {
                    ...
                    try {
                        Logger.getLogger().mo25715e("Failed to cache settings", e);
