...
public class CommonUtils {
    ...
    enum Architecture {
        ...
        static Architecture getValue() {
            ...
            if (TextUtils.isEmpty(str)) {
                Logger.getLogger().mo25712d("Architecture#getValue()::Build.CPU_ABI returned null or empty");
                return UNKNOWN;
            }
    ...
    public static void closeOrLog(Closeable closeable, String str) {
        if (closeable != null) {
            try {
                ...
                Logger.getLogger().mo25715e(str, e);
            }
        }
    }
    ...
    public static java.lang.String extractFieldFromSystemFile(java.io.File r6, java.lang.String r7) {
        ...
        L_0x0040:
            ...
            r3.mo25715e(r6, r7)     // Catch:{ all -> 0x0059 }
            goto L_0x0036
        L_0x0059:
            r6 = move-exception
            r2 = r1
    ...
    public static String getAppIconHashOrNull(Context context) {
        ...
        try {
            ...
            try {
                ...
                e = e;
                try {
                    Logger.getLogger().mo25722w("Could not calculate hash for app icon:" + e.getMessage());
                    closeOrLog(inputStream, "Failed to close icon input stream.");
                    return null;
                } catch (Throwable th) {
                    th = th;
                ...
                if (!TextUtils.isEmpty(extractFieldFromSystemFile)) {
                    ...
                    try {
                        if (upperCase.endsWith("KB")) {
                            ...
                            logger.mo25712d("Unexpected meminfo format while computing RAM: " + upperCase);
                        }
                    } catch (NumberFormatException e) {
                        Logger logger2 = Logger.getLogger();
                        logger2.mo25715e("Unexpected meminfo format while computing RAM: " + upperCase, e);
                    }
                }
                totalRamInBytes = j2;
            }
    ...
    private static String hash(InputStream inputStream, String str) {
        try {
            ...
            Logger.getLogger().mo25715e("Could not calculate hash for app icon.", e);
            return "";
        }
    }
    ...
    private static String hash(byte[] bArr, String str) {
        try {
            ...
            Logger logger = Logger.getLogger();
            logger.mo25715e("Could not create hashing algorithm: " + str + ", returning empty string.", e);
            return "";
        }
    }
    ...
    public static String resolveUnityEditorVersion(Context context) {
        ...
        Logger logger = Logger.getLogger();
        logger.mo25712d("Unity Editor version is: " + string);
        return string;
    }
