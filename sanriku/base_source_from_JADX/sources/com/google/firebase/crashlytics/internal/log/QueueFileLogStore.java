...
class QueueFileLogStore implements FileLogStore {
    ...
    private void doWriteToLog(long j, String str) {
        if (this.logFile != null) {
            ...
            try {
                ...
                Logger.getLogger().mo25715e("There was a problem writing to the Crashlytics log.", e);
            }
        }
    }
    ...
    private LogBytes getLogBytes() {
        ...
        try {
            ...
            Logger.getLogger().mo25715e("A problem occurred while reading the Crashlytics log file.", e);
        }
    ...
    private void openLogFile() {
        if (this.logFile == null) {
            try {
                ...
                StringBuilder a = C0681a.m330a("Could not open log file: ");
