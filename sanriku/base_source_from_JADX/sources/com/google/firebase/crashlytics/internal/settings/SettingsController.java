        ...
        try {
            ...
            if (readCachedSettings != null) {
                ...
                if (parseSettingsJson != null) {
                    ...
                    try {
                        Logger.getLogger().mo25712d("Returning cached settings.");
                        return parseSettingsJson;
                    } catch (Exception e) {
                        e = e;
                        settingsData = parseSettingsJson;
                        Logger.getLogger().mo25715e("Failed to get cached settings", e);
                        return settingsData;
                    }
                } else {
                    Logger.getLogger().mo25715e("Failed to parse cached settings data.", (Throwable) null);
                    return null;
                }
            } else {
                logger = Logger.getLogger();
