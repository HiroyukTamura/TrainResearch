...
public abstract class AbstractSpiCall {
    ...
    public HttpRequest getHttpRequest(Map<String, String> map) {
        ...
        StringBuilder a = C0681a.m330a(CRASHLYTICS_USER_AGENT);
        a.append(CrashlyticsCore.getVersion());
        return buildHttpRequest.header(HEADER_USER_AGENT, a.toString()).header(HEADER_DEVELOPER_TOKEN, "470fa2b4ae81cd56ecbcda9735803434cec591fa");
    }
