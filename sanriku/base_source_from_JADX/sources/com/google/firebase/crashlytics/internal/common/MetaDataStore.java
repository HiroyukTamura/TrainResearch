...
class MetaDataStore {
    ...
    public File getKeysFileForSession(String str) {
        return new File(this.filesDir, C0681a.m321a(str, KEYDATA_SUFFIX, METADATA_EXT));
    }

    @NonNull
    public File getUserDataFileForSession(String str) {
        return new File(this.filesDir, C0681a.m321a(str, USERDATA_SUFFIX, METADATA_EXT));
    }
    ...
    public Map<String, String> readKeyData(String str) {
        ...
        try {
            ...
            try {
                ...
                try {
                    Logger.getLogger().mo25715e("Error deserializing user metadata.", e);
    ...
    public void writeKeyData(String str, Map<String, String> map) {
        ...
        try {
            ...
            try {
                ...
                try {
                    Logger.getLogger().mo25715e("Error serializing key/value metadata.", e);
    ...
    public void writeUserData(String str, UserMetadata userMetadata) {
        ...
        try {
            ...
            try {
                ...
                bufferedWriter = bufferedWriter2;
                try {
                    Logger.getLogger().mo25715e("Error serializing user metadata.", e);
