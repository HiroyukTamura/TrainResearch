...
abstract class AbstractAppSpiCall extends AbstractSpiCall implements AppSpiCall {
    ...
    public boolean invoke(AppRequestData appRequestData, boolean z) {
        if (z) {
            ...
            StringBuilder a = C0681a.m330a("Sending app info to ");
            a.append(getUrl());
            ...
            try {
                ...
                logger2.mo25712d(str + " app request ID: " + execute.header(AbstractSpiCall.HEADER_REQUEST_ID));
                Logger logger3 = Logger.getLogger();
                logger3.mo25712d("Result was " + code);
                return ResponseParser.parse(code) == 0;
            } catch (IOException e) {
                Logger.getLogger().mo25715e("HTTP request failed.", e);
