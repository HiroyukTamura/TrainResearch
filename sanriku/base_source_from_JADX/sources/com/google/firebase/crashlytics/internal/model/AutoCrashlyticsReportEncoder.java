...
public final class AutoCrashlyticsReportEncoder implements Configurator {
    ...
    private static final class C1293x99c932db implements ObjectEncoder<CrashlyticsReport.Session.Event.Application.Execution.BinaryImage> {
        static final C1293x99c932db INSTANCE = new C1293x99c932db();

        private C1293x99c932db() {
        }
    ...
    private static final class C1294x55689506 implements ObjectEncoder<CrashlyticsReport.Session.Event.Application.Execution.Exception> {
        static final C1294x55689506 INSTANCE = new C1294x55689506();

        private C1294x55689506() {
        }
    ...
    private static final class C1295xc3999712 implements ObjectEncoder<CrashlyticsReport.Session.Event.Application.Execution.Thread.Frame> {
        static final C1295xc3999712 INSTANCE = new C1295xc3999712();

        private C1295xc3999712() {
        }
    ...
    public void configure(EncoderConfig<?> encoderConfig) {
        ...
        encoderConfig.registerEncoder((Class<U>) C1313x7e3e3ebd.class, (ObjectEncoder<? super U>) CrashlyticsReportSessionEventApplicationExecutionThreadEncoder.INSTANCE);
        encoderConfig.registerEncoder((Class<U>) CrashlyticsReport.Session.Event.Application.Execution.Thread.Frame.class, (ObjectEncoder<? super U>) C1295xc3999712.INSTANCE);
        encoderConfig.registerEncoder((Class<U>) C1315xce3d994b.class, (ObjectEncoder<? super U>) C1295xc3999712.INSTANCE);
        encoderConfig.registerEncoder((Class<U>) CrashlyticsReport.Session.Event.Application.Execution.Exception.class, (ObjectEncoder<? super U>) C1294x55689506.INSTANCE);
        encoderConfig.registerEncoder((Class<U>) C1309xc2f5febc.class, (ObjectEncoder<? super U>) C1294x55689506.INSTANCE);
        ...
        encoderConfig.registerEncoder((Class<U>) C1311x7c929f5b.class, (ObjectEncoder<? super U>) CrashlyticsReportSessionEventApplicationExecutionSignalEncoder.INSTANCE);
        encoderConfig.registerEncoder((Class<U>) CrashlyticsReport.Session.Event.Application.Execution.BinaryImage.class, (ObjectEncoder<? super U>) C1293x99c932db.INSTANCE);
        encoderConfig.registerEncoder((Class<U>) C1307xfe724d07.class, (ObjectEncoder<? super U>) C1293x99c932db.INSTANCE);
