...
final class zzbb implements Runnable {
    ...
    private final boolean zzc() throws IOException {
        ...
        try {
            ...
            if ((zzb2 == null || !zzc2.equals(zzb2.zza)) && FirebaseApp.DEFAULT_APP_NAME.equals(this.zzc.zza().getName())) {
                if (Log.isLoggable("FirebaseInstanceId", 3)) {
            ...
            if (z) {
                ...
                str = C0681a.m313a(C0681a.m336b(message2, 52), "Token retrieval failed: ", message2, ". Will retry token retrieval");
