            ...
            for (Api next : this.zaca.keySet()) {
                ...
                if (buildClient.providesSignIn()) {
                    if (api == null) {
                        ...
                        throw new IllegalStateException(C0681a.m313a(C0681a.m336b(name2, C0681a.m336b(name, 21)), name, " cannot be used with ", name2));
                    }
                }
            }
            if (api != null) {
                if (!z) {
                    ...
                    throw new IllegalStateException(C0681a.m313a(C0681a.m336b(name3, 82), "With using ", name3, ", GamesOptions can only be specified within GoogleSignInOptions.Builder"));
                }
            }
