...
public final class DataHolder extends AbstractSafeParcelable implements Closeable {
    ...
    @SafeParcelable.Field(getter = "getColumns", mo11969id = 1)
    private final String[] zalt;
    private Bundle zalu;
    @SafeParcelable.Field(getter = "getWindows", mo11969id = 2)
    private final CursorWindow[] zalv;
    @SafeParcelable.Field(getter = "getStatusCode", mo11969id = 3)
    private final int zalw;
    @SafeParcelable.Field(getter = "getMetadata", mo11969id = 4)
    ...
    DataHolder(@SafeParcelable.Param(mo11972id = 1000) int i, @SafeParcelable.Param(mo11972id = 1) String[] strArr, @SafeParcelable.Param(mo11972id = 2) CursorWindow[] cursorWindowArr, @SafeParcelable.Param(mo11972id = 3) int i2, @SafeParcelable.Param(mo11972id = 4) Bundle bundle) {
        this.mClosed = false;
        this.zama = true;
        this.zali = i;
        this.zalt = strArr;
    ...
    private static CursorWindow[] zaa(Builder builder, int i) {
        ...
        List zab = (i < 0 || i >= builder.zamc.size()) ? builder.zamc : builder.zamc.subList(0, i);
        int size = zab.size();
