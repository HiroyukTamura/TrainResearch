...
public final class zaj extends AbstractSafeParcelable {
    ...
    @SafeParcelable.Field(getter = "getSerializedDictionary", mo11969id = 2)
    private final ArrayList<zam> zark;
    @SafeParcelable.Field(getter = "getRootClassName", mo11969id = 3)
    private final String zarl;

    @SafeParcelable.Constructor
    zaj(@SafeParcelable.Param(mo11972id = 1) int i, @SafeParcelable.Param(mo11972id = 2) ArrayList<zam> arrayList, @SafeParcelable.Param(mo11972id = 3) String str) {
        this.zali = i;
        this.zark = null;
