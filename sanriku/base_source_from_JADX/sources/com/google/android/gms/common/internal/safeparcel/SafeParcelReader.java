...
public class SafeParcelReader {
    ...
    public static class ParseException extends RuntimeException {
        ...
        public ParseException(java.lang.String r4, android.os.Parcel r5) {
            /*
                ...
                int r5 = r5.dataSize()
                r1 = 41
                int r1 = p009e.p010a.p011a.p012a.C0681a.m336b((java.lang.String) r4, (int) r1)
    ...
    public static void ensureAtEnd(Parcel parcel, int i) {
        if (parcel.dataPosition() != i) {
            throw new ParseException(C0681a.m309a(37, "Overread allowed size end=", i), parcel);
        }
    }
    ...
    public static int validateObjectHeader(Parcel parcel) {
        ...
        throw new ParseException(C0681a.m311a(54, "Size read is invalid start=", dataPosition, " end=", i), parcel);
    }
    ...
    private static void zza(Parcel parcel, int i, int i2) {
        ...
        if (readSize != i2) {
            ...
            StringBuilder sb = new StringBuilder(C0681a.m336b(hexString, 46));
