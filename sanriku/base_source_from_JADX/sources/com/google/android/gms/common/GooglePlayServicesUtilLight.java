...
public class GooglePlayServicesUtilLight {
    ...
    public static int isGooglePlayServicesAvailable(Context context, int i) {
        try {
            context.getResources().getString(C0668R.string.common_google_play_services_unknown_issue);
    ...
    private static int zza(Context context, boolean z, int i) {
        ...
        try {
            ...
            if (!GoogleSignatureVerifier.zza(packageInfo2, true)) {
                ...
                Log.w("GooglePlayServicesUtil", C0681a.m311a(77, "Google Play services out of date.  Requires ", i, " but found ", packageInfo2.versionCode));
                return 2;
            } else {
