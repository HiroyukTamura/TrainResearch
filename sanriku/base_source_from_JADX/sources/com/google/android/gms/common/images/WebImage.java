...
public final class WebImage extends AbstractSafeParcelable {
    ...
    @SafeParcelable.Field(getter = "getUrl", mo11969id = 2)
    private final Uri zani;
    @SafeParcelable.Field(getter = "getWidth", mo11969id = 3)
    private final int zanj;
    @SafeParcelable.Field(getter = "getHeight", mo11969id = 4)
    private final int zank;

    @SafeParcelable.Constructor
    WebImage(@SafeParcelable.Param(mo11972id = 1) int i, @SafeParcelable.Param(mo11972id = 2) Uri uri, @SafeParcelable.Param(mo11972id = 3) int i2, @SafeParcelable.Param(mo11972id = 4) int i3) {
        this.zali = i;
        this.zani = uri;
        this.zanj = i2;
        this.zank = i3;
