...
public final class LocationSettingsResult extends AbstractSafeParcelable implements Result {
    ...
    @SafeParcelable.Field(getter = "getLocationSettingsStates", mo11969id = 2)
    ...
    public LocationSettingsResult(@SafeParcelable.Param(mo11972id = 1) Status status, @SafeParcelable.Param(mo11972id = 2) LocationSettingsStates locationSettingsStates) {
        this.zzbl = status;
