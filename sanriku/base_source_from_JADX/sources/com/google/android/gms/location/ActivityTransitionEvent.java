...
public class ActivityTransitionEvent extends AbstractSafeParcelable {
    ...
    @SafeParcelable.Field(getter = "getActivityType", mo11969id = 1)
    private final int zzi;
    @SafeParcelable.Field(getter = "getTransitionType", mo11969id = 2)
    private final int zzj;
    @SafeParcelable.Field(getter = "getElapsedRealTimeNanos", mo11969id = 3)
    private final long zzk;

    @SafeParcelable.Constructor
    public ActivityTransitionEvent(@SafeParcelable.Param(mo11972id = 1) int i, @SafeParcelable.Param(mo11972id = 2) int i2, @SafeParcelable.Param(mo11972id = 3) long j) {
