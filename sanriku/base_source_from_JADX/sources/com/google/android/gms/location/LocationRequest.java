...
public final class LocationRequest extends AbstractSafeParcelable implements ReflectedParcelable {
    ...
    @SafeParcelable.Field(defaultValueUnchecked = "LocationRequest.DEFAULT_PRIORITY", mo11969id = 1)
    private int priority;
    @SafeParcelable.Field(defaultValueUnchecked = "LocationRequest.DEFAULT_EXPIRE_AT", mo11969id = 5)
    private long zzaf;
    @SafeParcelable.Field(defaultValueUnchecked = "LocationRequest.DEFAULT_INTERVAL", mo11969id = 2)
    private long zzaw;
    @SafeParcelable.Field(defaultValueUnchecked = "LocationRequest.DEFAULT_FASTEST_INTERVAL", mo11969id = 3)
    private long zzax;
    @SafeParcelable.Field(defaultValueUnchecked = "LocationRequest.DEFAULT_EXPLICIT_FASTEST_INTERVAL", mo11969id = 4)
    private boolean zzay;
    @SafeParcelable.Field(defaultValueUnchecked = "LocationRequest.DEFAULT_SMALLEST_DISPLACEMENT", mo11969id = 7)
    private float zzaz;
    @SafeParcelable.Field(defaultValueUnchecked = "LocationRequest.DEFAULT_MAX_WAIT_TIME", mo11969id = 8)
    private long zzba;
    @SafeParcelable.Field(defaultValueUnchecked = "LocationRequest.DEFAULT_NUM_UPDATES", mo11969id = 6)
    private int zzx;
    ...
    LocationRequest(@SafeParcelable.Param(mo11972id = 1) int i, @SafeParcelable.Param(mo11972id = 2) long j, @SafeParcelable.Param(mo11972id = 3) long j2, @SafeParcelable.Param(mo11972id = 4) boolean z, @SafeParcelable.Param(mo11972id = 5) long j3, @SafeParcelable.Param(mo11972id = 6) int i2, @SafeParcelable.Param(mo11972id = 7) float f, @SafeParcelable.Param(mo11972id = 8) long j4) {
        this.priority = i;
        this.zzaw = j;
        this.zzax = j2;
        this.zzay = z;
    ...
    public final LocationRequest setNumUpdates(int i) {
        ...
        throw new IllegalArgumentException(C0681a.m309a(31, "invalid numUpdates: ", i));
    }
    ...
    public final LocationRequest setPriority(int i) {
        ...
        throw new IllegalArgumentException(C0681a.m309a(28, "invalid quality: ", i));
    }
    ...
    public final String toString() {
        StringBuilder a = C0681a.m330a("Request[");
        int i = this.priority;
