...
public class ActivityRecognitionResult extends AbstractSafeParcelable implements ReflectedParcelable {
    ...
    public ActivityRecognitionResult(@SafeParcelable.Param(mo11972id = 1) List<DetectedActivity> list, @SafeParcelable.Param(mo11972id = 2) long j, @SafeParcelable.Param(mo11972id = 3) long j2, @SafeParcelable.Param(mo11972id = 4) int i, @SafeParcelable.Param(mo11972id = 5) Bundle bundle) {
        boolean z = true;
