...
public class ActivityTransitionResult extends AbstractSafeParcelable {
    ...
    @SafeParcelable.Field(getter = "getTransitionEvents", mo11969id = 1)
    private final List<ActivityTransitionEvent> zzn;

    @SafeParcelable.Constructor
    public ActivityTransitionResult(@SafeParcelable.Param(mo11972id = 1) List<ActivityTransitionEvent> list) {
