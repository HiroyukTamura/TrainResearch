...
public final class zzal extends AbstractSafeParcelable {
    ...
    @SafeParcelable.Field(getter = "getGeofenceIds", mo11969id = 1)
    private final List<String> zzbu;
    @SafeParcelable.Field(getter = "getPendingIntent", mo11969id = 2)
    private final PendingIntent zzbv;

    @SafeParcelable.Constructor
    zzal(@SafeParcelable.Param(mo11972id = 1) @Nullable List<String> list, @SafeParcelable.Param(mo11972id = 2) @Nullable PendingIntent pendingIntent, @SafeParcelable.Param(mo11972id = 3) String str) {
