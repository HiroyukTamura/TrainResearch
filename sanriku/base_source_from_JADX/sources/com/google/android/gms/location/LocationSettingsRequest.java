...
public final class LocationSettingsRequest extends AbstractSafeParcelable {
    ...
    @SafeParcelable.Field(getter = "getLocationRequests", mo11969id = 1)
    private final List<LocationRequest> zzbg;
    @SafeParcelable.Field(defaultValue = "false", getter = "alwaysShow", mo11969id = 2)
    private final boolean zzbh;
    @SafeParcelable.Field(getter = "needBle", mo11969id = 3)
    private final boolean zzbi;
    @SafeParcelable.Field(getter = "getConfiguration", mo11969id = 5)
    private zzae zzbj;
    ...
    LocationSettingsRequest(@SafeParcelable.Param(mo11972id = 1) List<LocationRequest> list, @SafeParcelable.Param(mo11972id = 2) boolean z, @SafeParcelable.Param(mo11972id = 3) boolean z2, @SafeParcelable.Param(mo11972id = 5) zzae zzae) {
        this.zzbg = list;
        this.zzbh = z;
        this.zzbi = z2;
        this.zzbj = zzae;
