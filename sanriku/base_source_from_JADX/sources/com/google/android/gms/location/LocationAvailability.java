...
public final class LocationAvailability extends AbstractSafeParcelable implements ReflectedParcelable {
    ...
    @Deprecated
    private int zzas;
    @SafeParcelable.Field(defaultValueUnchecked = "0", mo11969id = 3)
    private long zzat;
    @SafeParcelable.Field(defaultValueUnchecked = "LocationAvailability.STATUS_UNSUCCESSFUL", mo11969id = 4)
    private int zzau;
    @SafeParcelable.Field(mo11969id = 5)
    private zzaj[] zzav;

    @SafeParcelable.Constructor
    LocationAvailability(@SafeParcelable.Param(mo11972id = 4) int i, @SafeParcelable.Param(mo11972id = 1) int i2, @SafeParcelable.Param(mo11972id = 2) int i3, @SafeParcelable.Param(mo11972id = 3) long j, @SafeParcelable.Param(mo11972id = 5) zzaj[] zzajArr) {
        this.zzau = i;
        this.zzar = i2;
        this.zzas = i3;
        this.zzat = j;
