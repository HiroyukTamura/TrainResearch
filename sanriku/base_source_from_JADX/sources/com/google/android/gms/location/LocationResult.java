...
public final class LocationResult extends AbstractSafeParcelable implements ReflectedParcelable {
    ...
    @SafeParcelable.Field(defaultValueUnchecked = "LocationResult.DEFAULT_LOCATIONS", getter = "getLocations", mo11969id = 1)
    private final List<Location> zzbc;

    @SafeParcelable.Constructor
    LocationResult(@SafeParcelable.Param(mo11972id = 1) List<Location> list) {
        this.zzbc = list;
    }
    ...
    public final String toString() {
        ...
        return C0681a.m313a(valueOf.length() + 27, "LocationResult[locations: ", valueOf, "]");
    }
