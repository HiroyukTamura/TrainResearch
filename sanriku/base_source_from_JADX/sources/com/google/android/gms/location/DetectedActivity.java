...
public class DetectedActivity extends AbstractSafeParcelable {
    ...
    public DetectedActivity(@SafeParcelable.Param(mo11972id = 1) int i, @SafeParcelable.Param(mo11972id = 2) int i2) {
        this.zzi = i;
        this.zzs = i2;
    }
    ...
    public String toString() {
        ...
        int i = this.zzs;
        StringBuilder sb = new StringBuilder(C0681a.m336b(str, 48));
