...
abstract class zzv {
    ...
    static Boolean zza(String str, zzbu.zzf zzf2, zzez zzez) {
        ...
        String zzd2 = (zzf3 || zzb2 == zzbu.zzf.zza.REGEXP || zzb2 == zzbu.zzf.zza.IN_LIST) ? zzf2.zzd() : zzf2.zzd().toUpperCase(Locale.ENGLISH);
        if (zzf2.zzh() == 0) {
            list = null;
        } else {
        ...
        return zza(str, zzb2, zzf3, zzd2, list, zzb2 == zzbu.zzf.zza.REGEXP ? zzd2 : null, zzez);
    }
