...
public final class zzkr extends AbstractSafeParcelable {
    ...
    zzkr(@SafeParcelable.Param(mo11972id = 1) int i, @SafeParcelable.Param(mo11972id = 2) String str, @SafeParcelable.Param(mo11972id = 3) long j, @SafeParcelable.Param(mo11972id = 4) Long l, @SafeParcelable.Param(mo11972id = 5) Float f, @SafeParcelable.Param(mo11972id = 6) String str2, @SafeParcelable.Param(mo11972id = 7) String str3, @SafeParcelable.Param(mo11972id = 8) Double d) {
        this.zzg = i;
        this.zza = str;
        this.zzb = j;
        this.zzc = l;
    ...
    zzkr(zzkt zzkt) {
        this(zzkt.zzc, zzkt.zzd, zzkt.zze, zzkt.zzb);
    }
