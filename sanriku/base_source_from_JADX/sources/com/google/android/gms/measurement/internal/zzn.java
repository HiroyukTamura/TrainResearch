...
public final class zzn extends AbstractSafeParcelable {
    ...
    @SafeParcelable.Field(defaultValue = "true", mo11969id = 9)
    public final boolean zzh;
    @SafeParcelable.Field(mo11969id = 10)
    public final boolean zzi;
    @SafeParcelable.Field(defaultValueUnchecked = "Integer.MIN_VALUE", mo11969id = 11)
    ...
    @SafeParcelable.Field(defaultValue = "true", mo11969id = 16)
    public final boolean zzo;
    @SafeParcelable.Field(defaultValue = "true", mo11969id = 17)
    ...
    zzn(@SafeParcelable.Param(mo11972id = 2) String str, @SafeParcelable.Param(mo11972id = 3) String str2, @SafeParcelable.Param(mo11972id = 4) String str3, @SafeParcelable.Param(mo11972id = 5) String str4, @SafeParcelable.Param(mo11972id = 6) long j, @SafeParcelable.Param(mo11972id = 7) long j2, @SafeParcelable.Param(mo11972id = 8) String str5, @SafeParcelable.Param(mo11972id = 9) boolean z, @SafeParcelable.Param(mo11972id = 10) boolean z2, @SafeParcelable.Param(mo11972id = 11) long j3, @SafeParcelable.Param(mo11972id = 12) String str6, @SafeParcelable.Param(mo11972id = 13) long j4, @SafeParcelable.Param(mo11972id = 14) long j5, @SafeParcelable.Param(mo11972id = 15) int i, @SafeParcelable.Param(mo11972id = 16) boolean z3, @SafeParcelable.Param(mo11972id = 17) boolean z4, @SafeParcelable.Param(mo11972id = 18) boolean z5, @SafeParcelable.Param(mo11972id = 19) String str7, @SafeParcelable.Param(mo11972id = 21) Boolean bool, @SafeParcelable.Param(mo11972id = 22) long j6, @SafeParcelable.Param(mo11972id = 23) List<String> list, @SafeParcelable.Param(mo11972id = 24) String str8) {
        this.zza = str;
        this.zzb = str2;
        this.zzc = str3;
        this.zzj = j3;
