...
public final class CredentialRequest extends AbstractSafeParcelable {
    ...
    @SafeParcelable.Field(getter = "isPasswordLoginSupported", mo11969id = 1)
    private final boolean zzaa;
    @SafeParcelable.Field(getter = "getAccountTypes", mo11969id = 2)
    private final String[] zzab;
    @SafeParcelable.Field(getter = "getCredentialPickerConfig", mo11969id = 3)
    private final CredentialPickerConfig zzac;
    @SafeParcelable.Field(getter = "getCredentialHintPickerConfig", mo11969id = 4)
    ...
    @SafeParcelable.Field(getter = "getRequireUserMediation", mo11969id = 8)
    ...
    CredentialRequest(@SafeParcelable.Param(mo11972id = 1000) int i, @SafeParcelable.Param(mo11972id = 1) boolean z, @SafeParcelable.Param(mo11972id = 2) String[] strArr, @SafeParcelable.Param(mo11972id = 3) @Nullable CredentialPickerConfig credentialPickerConfig, @SafeParcelable.Param(mo11972id = 4) @Nullable CredentialPickerConfig credentialPickerConfig2, @SafeParcelable.Param(mo11972id = 5) boolean z2, @SafeParcelable.Param(mo11972id = 6) @Nullable String str, @SafeParcelable.Param(mo11972id = 7) @Nullable String str2, @SafeParcelable.Param(mo11972id = 8) boolean z3) {
        this.zzv = i;
        this.zzaa = z;
