...
public class ProxyRequest extends AbstractSafeParcelable {
    ...
    public static class Builder {
        ...
        public Builder(String str) {
            ...
            throw new IllegalArgumentException(C0681a.m313a(C0681a.m336b(str, 51), "The supplied url [ ", str, "] is not match Patterns.WEB_URL!"));
        }
    ...
    ProxyRequest(@SafeParcelable.Param(mo11972id = 1000) int i, @SafeParcelable.Param(mo11972id = 1) String str, @SafeParcelable.Param(mo11972id = 2) int i2, @SafeParcelable.Param(mo11972id = 3) long j, @SafeParcelable.Param(mo11972id = 4) byte[] bArr, @SafeParcelable.Param(mo11972id = 5) Bundle bundle) {
        this.versionCode = i;
        this.url = str;
        this.httpMethod = i2;
    ...
    public String toString() {
        ...
        StringBuilder sb = new StringBuilder(C0681a.m336b(str, 42));
