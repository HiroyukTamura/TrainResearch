...
public class TokenData extends AbstractSafeParcelable implements ReflectedParcelable {
    ...
    @SafeParcelable.Field(getter = "getGrantedScopes", mo11969id = 6)
    private final List<String> zzaa;
    @SafeParcelable.Field(getter = "getScopeData", mo11969id = 7)
    private final String zzab;
    @SafeParcelable.VersionField(mo11975id = 1)
    private final int zzv;
    @SafeParcelable.Field(getter = "getToken", mo11969id = 2)
    private final String zzw;
    @SafeParcelable.Field(getter = "getExpirationTimeSecs", mo11969id = 3)
    private final Long zzx;
    @SafeParcelable.Field(getter = "isCached", mo11969id = 4)
    private final boolean zzy;
    @SafeParcelable.Field(getter = "isSnowballed", mo11969id = 5)
    private final boolean zzz;

    @SafeParcelable.Constructor
    TokenData(@SafeParcelable.Param(mo11972id = 1) int i, @SafeParcelable.Param(mo11972id = 2) String str, @SafeParcelable.Param(mo11972id = 3) Long l, @SafeParcelable.Param(mo11972id = 4) boolean z, @SafeParcelable.Param(mo11972id = 5) boolean z2, @SafeParcelable.Param(mo11972id = 6) List<String> list, @SafeParcelable.Param(mo11972id = 7) String str2) {
        this.zzv = i;
