...
public final class IdToken extends AbstractSafeParcelable implements ReflectedParcelable {
    ...
    @SafeParcelable.Field(getter = "getIdToken", mo11969id = 2)
    @NonNull
    private final String zzal;
    @SafeParcelable.Field(getter = "getAccountType", mo11969id = 1)
    @NonNull
    private final String zzr;

    @SafeParcelable.Constructor
    public IdToken(@SafeParcelable.Param(mo11972id = 1) @NonNull String str, @SafeParcelable.Param(mo11972id = 2) @NonNull String str2) {
