...
public class Credential extends AbstractSafeParcelable implements ReflectedParcelable {
    ...
    /* access modifiers changed from: private */
    @SafeParcelable.Field(getter = "getProfilePictureUri", mo11969id = 3)
    @Nullable
    public final Uri zzo;
    /* access modifiers changed from: private */
    @SafeParcelable.Field(getter = "getIdTokens", mo11969id = 4)
    public final List<IdToken> zzp;
    /* access modifiers changed from: private */
    @SafeParcelable.Field(getter = "getPassword", mo11969id = 5)
    @Nullable
    public final String zzq;
    /* access modifiers changed from: private */
    @SafeParcelable.Field(getter = "getAccountType", mo11969id = 6)
    @Nullable
    public final String zzr;
    /* access modifiers changed from: private */
    @SafeParcelable.Field(getter = "getGivenName", mo11969id = 9)
    @Nullable
    public final String zzs;
    /* access modifiers changed from: private */
    @SafeParcelable.Field(getter = "getFamilyName", mo11969id = 10)
    @Nullable
    ...
    Credential(@SafeParcelable.Param(mo11972id = 1) String str, @SafeParcelable.Param(mo11972id = 2) @Nullable String str2, @SafeParcelable.Param(mo11972id = 3) @Nullable Uri uri, @SafeParcelable.Param(mo11972id = 4) List<IdToken> list, @SafeParcelable.Param(mo11972id = 5) @Nullable String str3, @SafeParcelable.Param(mo11972id = 6) @Nullable String str4, @SafeParcelable.Param(mo11972id = 9) @Nullable String str5, @SafeParcelable.Param(mo11972id = 10) @Nullable String str6) {
