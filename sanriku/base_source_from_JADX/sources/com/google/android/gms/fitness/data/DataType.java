...
public final class DataType extends AbstractSafeParcelable implements ReflectedParcelable {
    ...
    @SafeParcelable.Field(getter = "getReadScope", mo11969id = 3)
    private final String zzjw;
    @SafeParcelable.Field(getter = "getWriteScope", mo11969id = 4)
    ...
    DataType(@SafeParcelable.Param(mo11972id = 1) String str, @SafeParcelable.Param(mo11972id = 2) List<Field> list, @SafeParcelable.Param(mo11972id = 3) String str2, @SafeParcelable.Param(mo11972id = 4) String str3) {
        this.name = str;
    ...
    public final String toString() {
        return String.format("DataType{%s%s}", new Object[]{this.name, this.zzjv});
    }
