...
public final class GroundOverlayOptions extends AbstractSafeParcelable {
    ...
    @SafeParcelable.Field(getter = "getBearing", mo11969id = 7)
    private float bearing;
    @SafeParcelable.Field(getter = "getHeight", mo11969id = 5)
    private float height;
    @SafeParcelable.Field(getter = "getWidth", mo11969id = 4)
    private float width;
    @SafeParcelable.Field(getter = "getZIndex", mo11969id = 8)
    private float zzcs;
    @SafeParcelable.Field(getter = "isVisible", mo11969id = 9)
    private boolean zzct = true;
    @SafeParcelable.Field(getter = "isClickable", mo11969id = 13)
    private boolean zzcu = false;
    @SafeParcelable.Field(getter = "getWrappedImageDescriptorImplBinder", mo11969id = 2, type = "android.os.IBinder")
    @NonNull
    private BitmapDescriptor zzcx;
    @SafeParcelable.Field(getter = "getLocation", mo11969id = 3)
    private LatLng zzcy;
    @SafeParcelable.Field(getter = "getBounds", mo11969id = 6)
    private LatLngBounds zzcz;
    @SafeParcelable.Field(getter = "getTransparency", mo11969id = 10)
    private float zzda = 0.0f;
    @SafeParcelable.Field(getter = "getAnchorU", mo11969id = 11)
    private float zzdb = 0.5f;
    @SafeParcelable.Field(getter = "getAnchorV", mo11969id = 12)
    ...
    GroundOverlayOptions(@SafeParcelable.Param(mo11972id = 2) IBinder iBinder, @SafeParcelable.Param(mo11972id = 3) LatLng latLng, @SafeParcelable.Param(mo11972id = 4) float f, @SafeParcelable.Param(mo11972id = 5) float f2, @SafeParcelable.Param(mo11972id = 6) LatLngBounds latLngBounds, @SafeParcelable.Param(mo11972id = 7) float f3, @SafeParcelable.Param(mo11972id = 8) float f4, @SafeParcelable.Param(mo11972id = 9) boolean z, @SafeParcelable.Param(mo11972id = 10) float f5, @SafeParcelable.Param(mo11972id = 11) float f6, @SafeParcelable.Param(mo11972id = 12) float f7, @SafeParcelable.Param(mo11972id = 13) boolean z2) {
