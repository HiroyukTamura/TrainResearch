...
public class PatternItem extends AbstractSafeParcelable {
    ...
    @SafeParcelable.Field(getter = "getLength", mo11969id = 3)
    @Nullable
    private final Float zzdv;

    @SafeParcelable.Constructor
    public PatternItem(@SafeParcelable.Param(mo11972id = 2) int i, @SafeParcelable.Param(mo11972id = 3) @Nullable Float f) {
        boolean z = true;
