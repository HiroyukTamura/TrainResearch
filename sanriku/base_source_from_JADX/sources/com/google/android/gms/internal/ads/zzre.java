...
public final class zzre {
    ...
    public static void zza(String[] strArr, int i, int i2, PriorityQueue<zzrd> priorityQueue) {
        ...
        for (int i4 = 1; i4 < (strArr2.length - i3) + 1; i4++) {
            int zzbt = zzqz.zzbt(strArr2[i4 - 1]);
            long zzbt2 = (((long) zzqz.zzbt(strArr2[(i4 + i3) - 1])) + 2147483647L) % 1073807359;
            zzb = (zzbt2 + (((((zzb + 1073807359) - ((((((long) zzbt) + 2147483647L) % 1073807359) * zza) % 1073807359)) % 1073807359) * 16785407) % 1073807359)) % 1073807359;
    ...
    private static long zzb(String[] strArr, int i, int i2) {
        ...
        for (int i3 = 1; i3 < i2; i3++) {
            zzbt = (((((long) zzqz.zzbt(strArr[i3])) + 2147483647L) % 1073807359) + ((zzbt * 16785407) % 1073807359)) % 1073807359;
        }
        return zzbt;
    }
}
