...
abstract class zzia<T extends zzho> {
    ...
    static <T extends zzho> T zza(Class<T> cls) {
        ...
        try {
            return (zzho) cls.cast(((zzia) Class.forName(str, true, classLoader).getConstructor(new Class[0]).newInstance(new Object[0])).zza());
            ...
            while (it.hasNext()) {
                try {
                    arrayList.add(cls.cast(((zzia) it.next()).zza()));
