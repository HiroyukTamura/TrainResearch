...
interface zzjz {
    ...
    <T> T zza(zzkc<T> zzkc, zzho zzho) throws IOException;

    void zza(List<Double> list) throws IOException;

    <T> void zza(List<T> list, zzkc<T> zzkc, zzho zzho) throws IOException;
    ...
    @Deprecated
    <T> T zzb(zzkc<T> zzkc, zzho zzho) throws IOException;

    void zzb(List<Float> list) throws IOException;

    @Deprecated
    <T> void zzb(List<T> list, zzkc<T> zzkc, zzho zzho) throws IOException;
