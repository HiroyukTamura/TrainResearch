...
public final class zzcz {
    ...
    public static void zzb(Map<String, String> map, String str, boolean z) {
        if (!map.containsKey(str)) {
            map.put(str, z ? "1" : RFGDef.DEFAULT_GYM_ID);
        }
    }

    public static boolean zzb(String str, boolean z) {
        return str == null || str.equalsIgnoreCase("true") || str.equalsIgnoreCase("yes") || str.equalsIgnoreCase("1") || (!str.equalsIgnoreCase("false") && !str.equalsIgnoreCase("no") && !str.equalsIgnoreCase(RFGDef.DEFAULT_GYM_ID));
    }

    public static String zzc(boolean z) {
        return z ? "1" : RFGDef.DEFAULT_GYM_ID;
    }
