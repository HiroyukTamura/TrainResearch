...
class zzkd<K extends Comparable<K>, V> extends AbstractMap<K, V> {
    ...
    public final V zzc(int i) {
        ...
        if (!this.zzc.isEmpty()) {
            ...
            this.zzb.add(new zzkm(this, (Map.Entry) it.next()));
            it.remove();
        }
        return value;
    }
    ...
    public Set<Map.Entry<K, V>> entrySet() {
        if (this.zze == null) {
            this.zze = new zzko(this, (zzkg) null);
        }
        return this.zze;
    }
    ...
    public final Iterable<Map.Entry<K, V>> zzd() {
        return this.zzc.isEmpty() ? zzkh.zza() : this.zzc.entrySet();
    }

    /* access modifiers changed from: package-private */
    public final Set<Map.Entry<K, V>> zze() {
        if (this.zzg == null) {
            this.zzg = new zzki(this, (zzkg) null);
        }
        return this.zzg;
    }
}
