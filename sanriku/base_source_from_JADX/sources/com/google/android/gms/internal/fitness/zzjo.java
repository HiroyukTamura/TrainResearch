...
interface zzjo {
    ...
    void zza(int i, zzff zzff) throws IOException;

    <K, V> void zza(int i, zzhf<K, V> zzhf, Map<K, V> map) throws IOException;

    void zza(int i, Object obj) throws IOException;

    void zza(int i, Object obj, zzic zzic) throws IOException;

    void zza(int i, String str) throws IOException;

    void zza(int i, List<String> list) throws IOException;

    void zza(int i, List<?> list, zzic zzic) throws IOException;
    ...
    @Deprecated
    void zzb(int i, Object obj, zzic zzic) throws IOException;

    void zzb(int i, List<zzff> list) throws IOException;

    @Deprecated
    void zzb(int i, List<?> list, zzic zzic) throws IOException;
