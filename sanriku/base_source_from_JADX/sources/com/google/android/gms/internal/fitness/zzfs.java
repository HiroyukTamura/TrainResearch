...
public abstract class zzfs extends zzfc {
    ...
    static class zza extends zzfs {
        ...
        public final void zzm(String str) throws IOException {
            int i = this.position;
            try {
                int zzr = zzfs.zzr(str.length() * 3);
                int zzr2 = zzfs.zzr(str.length());
                if (zzr2 == zzr) {
                    int i2 = i + zzr2;
                    this.position = i2;
    ...
    public static int zzb(int i, zzgt zzgt) {
        int zzh = zzh(2, i);
        return zza(3, zzgt) + zzh + (zzp(1) << 1);
    }

    public static int zzb(int i, zzho zzho) {
        return zzc(zzho) + zzp(3) + zzh(2, i) + (zzp(1) << 1);
    }
    ...
    public final void zza(String str, zzjd zzjd) throws IOException {
        logger.logp(Level.WARNING, "com.google.protobuf.CodedOutputStream", "inefficientWriteStringNoTag", "Converting ill-formed UTF-16. Your Protocol Buffer will not round trip correctly!", zzjd);
