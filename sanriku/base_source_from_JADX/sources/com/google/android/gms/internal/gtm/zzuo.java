...
public final class zzuo {
                    ...
                    if (charAt2 < 2048) {
                        ...
                        if (55296 <= charAt2 && charAt2 <= 57343) {
                            if (Character.codePointAt(charSequence, i2) >= 65536) {
                                ...
                                throw new IllegalArgumentException(C0681a.m309a(39, "Unpaired surrogate at index ", i2));
                            }
                        }
                    }
                    i2++;
                ...
                while (i4 < length2) {
                    ...
                    if (charAt4 >= 128) {
                        if (charAt4 < 2048) {
                            ...
                            throw new IllegalArgumentException(C0681a.m309a(39, "Unpaired surrogate at index ", i4 - 1));
                        }
    ...
    private final zzqj zzrw() throws IOException {
        if (this.zzbgz == null) {
            ...
            if (this.zzbha != this.zzawy.position()) {
