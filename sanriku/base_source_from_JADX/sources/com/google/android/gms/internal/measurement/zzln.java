...
interface zzln {
    ...
    void zza(int i, zzgt zzgt) throws IOException;

    <K, V> void zza(int i, zzje<K, V> zzje, Map<K, V> map) throws IOException;

    void zza(int i, Object obj) throws IOException;

    void zza(int i, Object obj, zzkc zzkc) throws IOException;

    void zza(int i, String str) throws IOException;

    void zza(int i, List<String> list) throws IOException;

    void zza(int i, List<?> list, zzkc zzkc) throws IOException;
    ...
    @Deprecated
    void zzb(int i, Object obj, zzkc zzkc) throws IOException;

    void zzb(int i, List<zzgt> list) throws IOException;

    @Deprecated
    void zzb(int i, List<?> list, zzkc zzkc) throws IOException;
