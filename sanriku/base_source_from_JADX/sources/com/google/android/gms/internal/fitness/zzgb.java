...
final class zzgb<T extends zzgd<T>> {
    ...
    public static int zzb(zzgd<?> zzgd, Object obj) {
        ...
        if (zzgd.zzbj()) {
            ...
            return zzfs.zzx(i) + zzfs.zzp(zzc) + i;
        }
        for (Object zza : list) {
            i += zza(zzbg, zzc, zza);
        }
    ...
    private static int zzb(zzji zzji, Object obj) {
        switch (zzga.zzsi[zzji.ordinal()]) {
            ...
            case 10:
                return obj instanceof zzgp ? zzfs.zza((zzgt) (zzgp) obj) : zzfs.zzc((zzho) obj);
            case 11:
                return obj instanceof zzff ? zzfs.zzb((zzff) obj) : zzfs.zzn((String) obj);
            case 12:
                return obj instanceof zzff ? zzfs.zzb((zzff) obj) : zzfs.zzb((byte[]) obj);
            case 13:
            ...
            case 18:
                return obj instanceof zzgj ? zzfs.zzv(((zzgj) obj).zzc()) : zzfs.zzv(((Integer) obj).intValue());
            default:
    ...
    private static <T extends zzgd<T>> boolean zzb(Map.Entry<T, Object> entry) {
        ...
        if (zzgd.zzbh() == zzjl.MESSAGE) {
            boolean zzbi = zzgd.zzbi();
            Object value = entry.getValue();
            if (zzbi) {
                for (zzho isInitialized : (List) value) {
                    if (!isInitialized.isInitialized()) {
                        return false;
                    }
                }
            } else if (value instanceof zzho) {
    ...
    private final void zzc(Map.Entry<T, Object> entry) {
        ...
        if (zzgd.zzbi()) {
            ...
            if (zza2 == null) {
                ...
                this.zzsj.put(zzgd, zza2 instanceof zzhu ? zzgd.zza((zzhu) zza2, (zzhu) value) : zzgd.zza(((zzho) zza2).zzbl(), (zzho) value).zzbr());
            }
        } else {
            this.zzsj.put(zzgd, zzd(value));
        }
    ...
    private static int zzd(Map.Entry<T, Object> entry) {
        ...
        if (zzgd.zzbh() != zzjl.MESSAGE || zzgd.zzbi() || zzgd.zzbj()) {
            return zzb((zzgd<?>) zzgd, value);
        }
        boolean z = value instanceof zzgp;
        int zzc = ((zzgd) entry.getKey()).zzc();
        return z ? zzfs.zzb(zzc, (zzgt) (zzgp) value) : zzfs.zzb(zzc, (zzho) value);
    }
    ...
    public final Iterator<Map.Entry<T, Object>> descendingIterator() {
        return this.zzsl ? new zzgu(this.zzsj.zzcs().iterator()) : this.zzsj.zzcs().iterator();
    }
    ...
    public final Iterator<Map.Entry<T, Object>> iterator() {
        return this.zzsl ? new zzgu(this.zzsj.entrySet().iterator()) : this.zzsj.entrySet().iterator();
    }
    ...
    public final int zzbf() {
        ...
        for (int i2 = 0; i2 < this.zzsj.zzcq(); i2++) {
            i += zzd(this.zzsj.zzaj(i2));
        }
        for (Map.Entry<T, Object> zzd : this.zzsj.zzcr()) {
            i += zzd(zzd);
        }
        return i;
    }
