...
public final class zzdh implements HistoryApi {
    ...
    public final PendingResult<Status> updateData(GoogleApiClient googleApiClient, DataUpdateRequest dataUpdateRequest) {
        ...
        Preconditions.checkNotZero(dataUpdateRequest.zzy(), (Object) "Must set a non-zero value for startTimeMillis/startTime");
        Preconditions.checkNotZero(dataUpdateRequest.zzz(), (Object) "Must set a non-zero value for endTimeMillis/endTime");
