...
interface zzefv {
    ...
    void zza(int i, zzeaq zzeaq) throws IOException;

    <K, V> void zza(int i, zzedf<K, V> zzedf, Map<K, V> map) throws IOException;

    void zza(int i, Object obj, zzeek zzeek) throws IOException;

    void zza(int i, List<String> list) throws IOException;

    void zza(int i, List<?> list, zzeek zzeek) throws IOException;
    ...
    @Deprecated
    void zzb(int i, Object obj, zzeek zzeek) throws IOException;

    void zzb(int i, List<zzeaq> list) throws IOException;

    @Deprecated
    void zzb(int i, List<?> list, zzeek zzeek) throws IOException;
