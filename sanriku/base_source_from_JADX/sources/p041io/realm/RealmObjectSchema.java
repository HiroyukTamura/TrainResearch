...
public abstract class RealmObjectSchema {
    ...
    /* renamed from: io.realm.RealmObjectSchema$DynamicColumnIndices */
    ...
    public void checkFieldExists(String str) {
        if (this.table.getColumnIndex(str) == -1) {
            StringBuilder a = C0681a.m330a("Field name doesn't exist on object '");
    ...
    public long getAndCheckFieldIndex(String str) {
        ...
        throw new IllegalArgumentException(C0681a.m320a("Field does not exist: ", str));
    }
    ...
    public boolean hasIndex(String str) {
        ...
        return table2.hasSearchIndex(table2.getColumnIndex(str));
    }
