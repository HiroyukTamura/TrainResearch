...
public class Intrinsics {
    ...
    public static void checkExpressionValueIsNotNull(Object obj, String str) {
        if (obj == null) {
            throw ((IllegalStateException) sanitizeStackTrace(new IllegalStateException(C0681a.m320a(str, " must not be null"))));
        }
    }
    ...
    public static void checkHasClass(String str) throws ClassNotFoundException {
        ...
        try {
            ...
            throw ((ClassNotFoundException) sanitizeStackTrace(new ClassNotFoundException(C0681a.m321a("Class ", replace, " is not found. Please update the Kotlin runtime to the latest version"), e)));
        }
    }
    ...
    public static void checkNotNullExpressionValue(Object obj, String str) {
        if (obj == null) {
            throw ((NullPointerException) sanitizeStackTrace(new NullPointerException(C0681a.m320a(str, " must not be null"))));
        }
    }
