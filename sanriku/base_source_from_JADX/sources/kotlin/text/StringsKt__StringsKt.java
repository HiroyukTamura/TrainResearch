...
class StringsKt__StringsKt extends StringsKt__StringsJVMKt {
    ...
    public static final Pair<Integer, String> findAnyOf$StringsKt__StringsKt(CharSequence charSequence, Collection<String> collection, int i, boolean z, boolean z2) {
        ...
        if (z || collection.size() != 1) {
                ...
                if (step < 0 ? i2 >= last : i2 <= last) {
                    while (true) {
                        ...
                        while (true) {
                            ...
                            if (StringsKt__StringsJVMKt.regionMatches(str2, 0, (String) charSequence, i2, str2.length(), z)) {
                                break;
                            }
                        }
                        str = (String) t2;
            ...
            if (step2 < 0 ? first >= last2 : first <= last2) {
                while (true) {
                    ...
                    while (true) {
                        ...
                        if (regionMatchesImpl(str3, 0, charSequence, i2, str3.length(), z)) {
                            break;
                        }
                    }
                    str = (String) t;
            ...
            return null;
            return TuplesKt.m4300to(Integer.valueOf(i2), str);
        }
        String str4 = (String) CollectionsKt___CollectionsKt.single(collection);
        if (!z2) {
            i3 = indexOf$default(charSequence, str4, i, false, 4, (Object) null);
        } else {
            i3 = lastIndexOf$default(charSequence, str4, i, false, 4, (Object) null);
        }
        if (i3 < 0) {
            return null;
        }
        return TuplesKt.m4300to(Integer.valueOf(i3), str4);
    }
    ...
    public static final CharSequence padEnd(CharSequence charSequence, int i, char c) {
        ...
        if (i < 0) {
            throw new IllegalArgumentException(C0681a.m317a("Desired length ", i, " is less than zero."));
    ...
    public static final CharSequence removeRange(CharSequence charSequence, IntRange intRange) {
        ...
        return removeRange(charSequence, intRange.getStart().intValue(), C0681a.m303a(intRange, 1));
    }
    ...
    public static final CharSequence replaceRange(CharSequence charSequence, IntRange intRange, CharSequence charSequence2) {
        ...
        Intrinsics.checkParameterIsNotNull(intRange, "range");
        Intrinsics.checkParameterIsNotNull(charSequence2, "replacement");
        return replaceRange(charSequence, intRange.getStart().intValue(), C0681a.m303a(intRange, 1), charSequence2);
    }
    ...
    public static final CharSequence trim(CharSequence charSequence, Function1<? super Character, Boolean> function1) {
        ...
        boolean z = false;
        while (i <= length) {
            boolean booleanValue = ((Boolean) C0681a.m308a(charSequence, !z ? i : length, (Function1) function1)).booleanValue();
            if (!z) {
                if (!booleanValue) {
                    z = true;
                } else {
    ...
    public static final CharSequence trimEnd(CharSequence charSequence, Function1<? super Character, Boolean> function1) {
        ...
        } while (((Boolean) C0681a.m308a(charSequence, length, (Function1) function1)).booleanValue());
        return charSequence.subSequence(0, length + 1);
    }
