...
public final class DurationKt {
    ...
    private static final double m5619timeskIfJnKk(double d, double d2) {
        return Duration.m5601timesimpl(d2, d);
    }
    ...
    private static final double m5620timesmvk6XK0(int i, double d) {
        return Duration.m5602timesimpl(d, i);
    }
    ...
    public static final double toDuration(double d, TimeUnit timeUnit) {
        ...
        return Duration.m5575constructorimpl(DurationUnitKt__DurationUnitJvmKt.convertDurationUnit(d, timeUnit, TimeUnit.NANOSECONDS));
    }
