...
class LoaderManagerImpl extends LoaderManager {
    ...
    public static class LoaderInfo<D> extends MutableLiveData<D> implements Loader.OnLoadCompleteListener<D> {
        ...
        public void dump(String str, FileDescriptor fileDescriptor, PrintWriter printWriter, String[] strArr) {
            ...
            this.mLoader.dump(C0681a.m320a(str, "  "), fileDescriptor, printWriter, strArr);
            if (this.mObserver != null) {
                printWriter.print(str);
                printWriter.print("mCallbacks=");
                printWriter.println(this.mObserver);
                this.mObserver.dump(C0681a.m320a(str, "  "), printWriter);
            }
            printWriter.print(str);
    ...
    static class LoaderObserver<D> implements Observer<D> {
        ...
        public void onChanged(@Nullable D d) {
            if (LoaderManagerImpl.DEBUG) {
                StringBuilder a = C0681a.m330a("  onLoadFinished in ");
                a.append(this.mLoader);
                a.append(": ");
                a.append(this.mLoader.dataToString(d));
                Log.v(LoaderManagerImpl.TAG, a.toString());
            }
        ...
        public void reset() {
            if (this.mDeliveredData) {
                if (LoaderManagerImpl.DEBUG) {
                    StringBuilder a = C0681a.m330a("  Resetting: ");
                    a.append(this.mLoader);
                    Log.v(LoaderManagerImpl.TAG, a.toString());
                }
