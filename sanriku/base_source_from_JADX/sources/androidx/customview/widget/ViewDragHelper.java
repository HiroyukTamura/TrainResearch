...
public class ViewDragHelper {
    ...
    public static abstract class Callback {
        ...
        public void onViewPositionChanged(@NonNull View view, int i, int i2, @C0042Px int i3, @C0042Px int i4) {
        }
    ...
    public void captureChildView(@NonNull View view, int i) {
        ...
        StringBuilder a = C0681a.m330a("captureChildView: parameter must be a descendant of the ViewDragHelper's tracked parent view (");
        a.append(this.mParentView);
        a.append(")");
