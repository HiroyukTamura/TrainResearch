...
public class ChangeImageTransform extends Transition {
    ...
    static /* synthetic */ class C04803 {
        ...
        static {
            ...
            L_0x001d:
                return
            */
            throw new UnsupportedOperationException("Method not decompiled: androidx.transition.ChangeImageTransform.C04803.<clinit>():void");
        }
    }
    ...
    private static Matrix copyImageMatrix(ImageView imageView) {
        int i = C04803.$SwitchMap$android$widget$ImageView$ScaleType[imageView.getScaleType().ordinal()];
