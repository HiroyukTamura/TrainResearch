...
public class TransitionSet extends Transition {
    ...
    public TransitionSet setOrdering(int i) {
        if (i == 0) {
            ...
            throw new AndroidRuntimeException(C0681a.m316a("Invalid parameter for TransitionSet ordering: ", i));
        }
        return this;
    }
    ...
    public String toString(String str) {
        ...
        for (int i = 0; i < this.mTransitions.size(); i++) {
            StringBuilder c = C0681a.m340c(transition, "\n");
            c.append(this.mTransitions.get(i).toString(C0681a.m320a(str, "  ")));
            transition = c.toString();
        }
        return transition;
    }
}
