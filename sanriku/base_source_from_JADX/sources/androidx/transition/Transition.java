...
public abstract class Transition implements Cloneable {
    ...
    private static int[] parseMatchOrder(String str) {
        ...
        while (stringTokenizer.hasMoreTokens()) {
            ...
            if (MATCH_ID_STR.equalsIgnoreCase(trim)) {
                ...
                throw new InflateException(C0681a.m321a("Unknown match type in matchOrder: '", trim, "'"));
            }
            i++;
        }
        return iArr;
    ...
    public String toString(String str) {
        ...
        if (this.mDuration != -1) {
            StringBuilder c = C0681a.m340c(sb, "dur(");
            c.append(this.mDuration);
            c.append(") ");
            sb = c.toString();
        }
        if (this.mStartDelay != -1) {
            StringBuilder c2 = C0681a.m340c(sb, "dly(");
            c2.append(this.mStartDelay);
            c2.append(") ");
            sb = c2.toString();
        }
        if (this.mInterpolator != null) {
            StringBuilder c3 = C0681a.m340c(sb, "interp(");
            c3.append(this.mInterpolator);
            c3.append(") ");
            sb = c3.toString();
        }
        ...
        String a2 = C0681a.m320a(sb, "tgts(");
        if (this.mTargetIds.size() > 0) {
            for (int i = 0; i < this.mTargetIds.size(); i++) {
                if (i > 0) {
                    a2 = C0681a.m320a(a2, ", ");
                }
                StringBuilder a3 = C0681a.m330a(a2);
                a3.append(this.mTargetIds.get(i));
                a2 = a3.toString();
            }
        }
        if (this.mTargets.size() > 0) {
            for (int i2 = 0; i2 < this.mTargets.size(); i2++) {
                ...
                StringBuilder a4 = C0681a.m330a(a2);
                a4.append(this.mTargets.get(i2));
                a2 = a4.toString();
            }
        }
        return C0681a.m320a(a2, ")");
    }
}
