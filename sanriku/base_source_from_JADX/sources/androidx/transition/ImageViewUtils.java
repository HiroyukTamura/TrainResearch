...
class ImageViewUtils {
        ...
        if (Build.VERSION.SDK_INT < 21) {
            animator.addListener(new AnimatorListenerAdapter() {
                public void onAnimationEnd(Animator animator) {
                    ImageView.ScaleType scaleType = (ImageView.ScaleType) imageView.getTag(C0492R.C0494id.save_scale_type);
                    imageView.setScaleType(scaleType);
                    imageView.setTag(C0492R.C0494id.save_scale_type, (Object) null);
                    if (scaleType == ImageView.ScaleType.MATRIX) {
                        ImageView imageView = imageView;
                        imageView.setImageMatrix((Matrix) imageView.getTag(C0492R.C0494id.save_image_matrix));
                        imageView.setTag(C0492R.C0494id.save_image_matrix, (Object) null);
                    }
    ...
    static void startAnimateTransform(ImageView imageView) {
        if (Build.VERSION.SDK_INT < 21) {
            ...
            imageView.setTag(C0492R.C0494id.save_scale_type, scaleType);
            ImageView.ScaleType scaleType2 = ImageView.ScaleType.MATRIX;
            if (scaleType == scaleType2) {
                imageView.setTag(C0492R.C0494id.save_image_matrix, imageView.getImageMatrix());
            } else {
