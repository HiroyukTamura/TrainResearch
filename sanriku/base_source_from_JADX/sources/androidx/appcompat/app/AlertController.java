...
class AlertController {
    ...
    private final View.OnClickListener mButtonHandler = new View.OnClickListener() {
        ...
        public void onClick(android.view.View r3) {
            ...
            L_0x002f:
                ...
                return
            */
            throw new UnsupportedOperationException("Method not decompiled: androidx.appcompat.app.AlertController.C00481.onClick(android.view.View):void");
        }
    };
    ...
    public static class RecycleListView extends ListView {
        ...
        public RecycleListView(Context context, AttributeSet attributeSet) {
            ...
            TypedArray obtainStyledAttributes = context.obtainStyledAttributes(attributeSet, C0043R.styleable.RecycleListView);
            this.mPaddingBottomNoButtons = obtainStyledAttributes.getDimensionPixelOffset(C0043R.styleable.RecycleListView_paddingBottomNoButtons, -1);
            this.mPaddingTopNoTitle = obtainStyledAttributes.getDimensionPixelOffset(C0043R.styleable.RecycleListView_paddingTopNoTitle, -1);
        }
    ...
    public AlertController(Context context, AppCompatDialog appCompatDialog, Window window) {
        ...
        TypedArray obtainStyledAttributes = context.obtainStyledAttributes((AttributeSet) null, C0043R.styleable.AlertDialog, C0043R.attr.alertDialogStyle, 0);
        this.mAlertDialogLayout = obtainStyledAttributes.getResourceId(C0043R.styleable.AlertDialog_android_layout, 0);
        this.mButtonPanelSideLayout = obtainStyledAttributes.getResourceId(C0043R.styleable.AlertDialog_buttonPanelSideLayout, 0);
        this.mListLayout = obtainStyledAttributes.getResourceId(C0043R.styleable.AlertDialog_listLayout, 0);
        this.mMultiChoiceItemLayout = obtainStyledAttributes.getResourceId(C0043R.styleable.AlertDialog_multiChoiceItemLayout, 0);
        this.mSingleChoiceItemLayout = obtainStyledAttributes.getResourceId(C0043R.styleable.AlertDialog_singleChoiceItemLayout, 0);
        this.mListItemLayout = obtainStyledAttributes.getResourceId(C0043R.styleable.AlertDialog_listItemLayout, 0);
        this.mShowTitle = obtainStyledAttributes.getBoolean(C0043R.styleable.AlertDialog_showTitle, true);
        this.mButtonIconDimen = obtainStyledAttributes.getDimensionPixelSize(C0043R.styleable.AlertDialog_buttonIconDimen, 0);
    ...
    private void setScrollIndicators(ViewGroup viewGroup, View view, int i, int i2) {
        final View findViewById = this.mWindow.findViewById(C0043R.C0045id.scrollIndicatorUp);
        final View findViewById2 = this.mWindow.findViewById(C0043R.C0045id.scrollIndicatorDown);
    ...
    private void setupContent(ViewGroup viewGroup) {
        NestedScrollView nestedScrollView = (NestedScrollView) this.mWindow.findViewById(C0043R.C0045id.scrollView);
    ...
    private void setupCustomContent(ViewGroup viewGroup) {
        ...
        if (z) {
            FrameLayout frameLayout = (FrameLayout) this.mWindow.findViewById(C0043R.C0045id.custom);
    ...
    private void setupTitle(ViewGroup viewGroup) {
        if (this.mCustomTitleView != null) {
            ...
            this.mWindow.findViewById(C0043R.C0045id.title_template).setVisibility(8);
            return;
        }
        ...
        TextView textView = (TextView) this.mWindow.findViewById(C0043R.C0045id.alertTitle);
    ...
    private void setupView() {
        ...
        View findViewById;
        View findViewById2 = this.mWindow.findViewById(C0043R.C0045id.parentPanel);
        View findViewById3 = findViewById2.findViewById(C0043R.C0045id.topPanel);
        View findViewById4 = findViewById2.findViewById(C0043R.C0045id.contentPanel);
        View findViewById5 = findViewById2.findViewById(C0043R.C0045id.buttonPanel);
        ViewGroup viewGroup = (ViewGroup) findViewById2.findViewById(C0043R.C0045id.customPanel);
        setupCustomContent(viewGroup);
        View findViewById6 = viewGroup.findViewById(C0043R.C0045id.topPanel);
        View findViewById7 = viewGroup.findViewById(C0043R.C0045id.contentPanel);
        View findViewById8 = viewGroup.findViewById(C0043R.C0045id.buttonPanel);
        ...
        if (!z3 && (findViewById = resolvePanel2.findViewById(C0043R.C0045id.textSpacerNoButtons)) != null) {
        ...
        if (z2) {
            ...
            if (!(this.mMessage == null && this.mListView == null)) {
                view = resolvePanel.findViewById(C0043R.C0045id.titleDividerNoCustom);
            }
            if (view != null) {
                view.setVisibility(0);
            }
        } else {
            View findViewById9 = resolvePanel2.findViewById(C0043R.C0045id.textSpacerNoTitle);
    ...
    private static boolean shouldCenterSingleButton(Context context) {
        ...
        context.getTheme().resolveAttribute(C0043R.attr.alertDialogCenterButtons, typedValue, true);
