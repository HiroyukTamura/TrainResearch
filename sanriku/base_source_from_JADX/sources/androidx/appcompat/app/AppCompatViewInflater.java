...
public class AppCompatViewInflater {
    ...
    private static class DeclaredOnClickListener implements View.OnClickListener {
        ...
        private void resolveMethod(@Nullable Context context, @NonNull String str) {
            ...
            if (id == -1) {
                ...
                StringBuilder a = C0681a.m330a(" with id '");
                a.append(this.mHostView.getContext().getResources().getResourceEntryName(id));
                a.append("'");
                str2 = a.toString();
            }
            StringBuilder a2 = C0681a.m330a("Could not find method ");
            a2.append(this.mMethodName);
            a2.append("(View) in a parent or ancestor Context for android:onClick attribute defined on view ");
            a2.append(this.mHostView.getClass());
            a2.append(str2);
    ...
    private static Context themifyContext(Context context, AttributeSet attributeSet, boolean z, boolean z2) {
        TypedArray obtainStyledAttributes = context.obtainStyledAttributes(attributeSet, C0043R.styleable.View, 0, 0);
        int resourceId = z ? obtainStyledAttributes.getResourceId(C0043R.styleable.View_android_theme, 0) : 0;
        if (z2 && resourceId == 0 && (resourceId = obtainStyledAttributes.getResourceId(C0043R.styleable.View_theme, 0)) != 0) {
