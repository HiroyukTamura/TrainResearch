...
public class WindowDecorActionBar extends ActionBar implements ActionBarOverlayLayout.ActionBarVisibilityCallback {
    ...
    private DecorToolbar getDecorToolbar(View view) {
        ...
        StringBuilder a = C0681a.m330a("Can't make a decor toolbar out of ");
        a.append(view != null ? view.getClass().getSimpleName() : "null");
    ...
    private void init(View view) {
        ActionBarOverlayLayout actionBarOverlayLayout = (ActionBarOverlayLayout) view.findViewById(C0043R.C0045id.decor_content_parent);
        this.mOverlayLayout = actionBarOverlayLayout;
        if (actionBarOverlayLayout != null) {
            actionBarOverlayLayout.setActionBarVisibilityCallback(this);
        }
        this.mDecorToolbar = getDecorToolbar(view.findViewById(C0043R.C0045id.action_bar));
        this.mContextView = (ActionBarContextView) view.findViewById(C0043R.C0045id.action_context_bar);
        ActionBarContainer actionBarContainer = (ActionBarContainer) view.findViewById(C0043R.C0045id.action_bar_container);
        ...
        TypedArray obtainStyledAttributes = this.mContext.obtainStyledAttributes((AttributeSet) null, C0043R.styleable.ActionBar, C0043R.attr.actionBarStyle, 0);
        if (obtainStyledAttributes.getBoolean(C0043R.styleable.ActionBar_hideOnContentScroll, false)) {
            setHideOnContentScrollEnabled(true);
        }
        int dimensionPixelSize = obtainStyledAttributes.getDimensionPixelSize(C0043R.styleable.ActionBar_elevation, 0);
    ...
    public Context getThemedContext() {
        if (this.mThemedContext == null) {
            ...
            this.mContext.getTheme().resolveAttribute(C0043R.attr.actionBarWidgetTheme, typedValue, true);
