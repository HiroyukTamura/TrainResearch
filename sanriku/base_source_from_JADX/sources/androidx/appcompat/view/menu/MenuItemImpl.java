...
public final class MenuItemImpl implements SupportMenuItem {
    ...
    public String getShortcutLabel() {
        ...
        if (ViewConfiguration.get(this.mMenu.getContext()).hasPermanentMenuKey()) {
            sb.append(resources.getString(C0043R.string.abc_prepend_shortcut_label));
        }
        int i2 = this.mMenu.isQwertyMode() ? this.mShortcutAlphabeticModifiers : this.mShortcutNumericModifiers;
        appendModifier(sb, i2, 65536, resources.getString(C0043R.string.abc_menu_meta_shortcut_label));
        appendModifier(sb, i2, 4096, resources.getString(C0043R.string.abc_menu_ctrl_shortcut_label));
        appendModifier(sb, i2, 2, resources.getString(C0043R.string.abc_menu_alt_shortcut_label));
        appendModifier(sb, i2, 1, resources.getString(C0043R.string.abc_menu_shift_shortcut_label));
        appendModifier(sb, i2, 4, resources.getString(C0043R.string.abc_menu_sym_shortcut_label));
        appendModifier(sb, i2, 8, resources.getString(C0043R.string.abc_menu_function_shortcut_label));
        if (shortcut == 8) {
            i = C0043R.string.abc_menu_delete_shortcut_label;
        } else if (shortcut == 10) {
            i = C0043R.string.abc_menu_enter_shortcut_label;
        } else if (shortcut != ' ') {
            sb.append(shortcut);
            return sb.toString();
        } else {
            i = C0043R.string.abc_menu_space_shortcut_label;
        }
