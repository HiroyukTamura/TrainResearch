...
abstract class AbsActionBarView extends ViewGroup {
    ...
    AbsActionBarView(Context context, AttributeSet attributeSet, int i) {
        ...
        if (!context.getTheme().resolveAttribute(C0043R.attr.actionBarPopupTheme, typedValue, true) || typedValue.resourceId == 0) {
    ...
    public void onConfigurationChanged(Configuration configuration) {
        ...
        TypedArray obtainStyledAttributes = getContext().obtainStyledAttributes((AttributeSet) null, C0043R.styleable.ActionBar, C0043R.attr.actionBarStyle, 0);
        setContentHeight(obtainStyledAttributes.getLayoutDimension(C0043R.styleable.ActionBar_height, 0));
