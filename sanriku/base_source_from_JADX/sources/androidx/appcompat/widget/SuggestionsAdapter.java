...
class SuggestionsAdapter extends ResourceCursorAdapter implements View.OnClickListener {
    ...
    private static final class ChildViewCache {
        ...
        public ChildViewCache(View view) {
            ...
            this.mIconRefine = (ImageView) view.findViewById(C0043R.C0045id.edit_query);
        }
    }
    ...
    private CharSequence formatUrl(CharSequence charSequence) {
        if (this.mUrlColor == null) {
            ...
            this.mContext.getTheme().resolveAttribute(C0043R.attr.textColorSearchUrl, typedValue, true);
    ...
    private Drawable getActivityIcon(ComponentName componentName) {
        ...
        try {
            ...
            StringBuilder b = C0681a.m338b("Invalid icon resource ", iconResource, " for ");
            b.append(componentName.flattenToShortString());
            str = b.toString();
            Log.w(LOG_TAG, str);
            return null;
    ...
    private Drawable getDrawableFromResourceValue(String str) {
        if (str == null || str.isEmpty() || RFGDef.DEFAULT_GYM_ID.equals(str)) {
            return null;
        }
        try {
    ...
    public View newView(Context context, Cursor cursor, ViewGroup viewGroup) {
        ...
        ((ImageView) newView.findViewById(C0043R.C0045id.edit_query)).setImageResource(this.mCommitIconResId);
        return newView;
    }
