...
public abstract class AbstractResolvableFuture<V> implements C1567a<V> {
    ...
    private static final class SetFuture<V> implements Runnable {
        final C1567a<? extends V> future;
        final AbstractResolvableFuture<V> owner;

        SetFuture(AbstractResolvableFuture<V> abstractResolvableFuture, C1567a<? extends V> aVar) {
    ...
    static Object getFutureValue(C1567a<?> aVar) {
    ...
    /* JADX WARNING: type inference failed for: r0v5, types: [java.util.concurrent.Future, e.d.d.a.a.a<? extends V>] */
    /* JADX WARNING: Multi-variable type inference failed */
    ...
    public final boolean cancel(boolean r8) {
        ...
        L_0x0035:
            ...
            e.d.d.a.a.a<? extends V> r0 = r0.future
    ...
    public final V get(long j, TimeUnit timeUnit) throws InterruptedException, TimeoutException, ExecutionException {
        ...
        if (!Thread.interrupted()) {
            ...
            if (nanos + SPIN_THRESHOLD_NANOS < 0) {
                String a = C0681a.m320a(str, " (plus ");
                long j2 = -nanos;
                ...
                str = C0681a.m320a(a, "delay)");
            }
            if (isDone()) {
                throw new TimeoutException(C0681a.m320a(str, " but future completed as timeout expired"));
            }
            throw new TimeoutException(C0681a.m321a(str, " for ", abstractResolvableFuture));
        }
        throw new InterruptedException();
    }
    ...
    public String pendingToString() {
        ...
        if (obj instanceof SetFuture) {
            return C0681a.m324a(C0681a.m330a("setFuture=["), userObjectToString(((SetFuture) obj).future), "]");
        }
        if (!(this instanceof ScheduledFuture)) {
            return null;
        }
        StringBuilder a = C0681a.m330a("remaining delay=[");
    ...
    public String toString() {
        ...
        if (isCancelled()) {
            ...
            if (!isDone()) {
                try {
                    str2 = pendingToString();
                } catch (RuntimeException e) {
                    StringBuilder a = C0681a.m330a("Exception thrown from implementation: ");
                    a.append(e.getClass());
                    str2 = a.toString();
                }
