...
public class ShortcutInfoCompat {
    ...
    private PersistableBundle buildLegacyExtrasBundle() {
        ...
        if (personArr != null && personArr.length > 0) {
            ...
            while (i < this.mPersons.length) {
                StringBuilder a = C0681a.m330a(EXTRA_PERSON_);
                int i2 = i + 1;
                a.append(i2);
                persistableBundle.putPersistableBundle(a.toString(), this.mPersons[i].toPersistableBundle());
                i = i2;
            }
        }
    ...
    static Person[] getPersonsFromExtra(@NonNull PersistableBundle persistableBundle) {
        ...
        while (i2 < i) {
            ...
            int i3 = i2 + 1;
            a.append(i3);
            personArr[i2] = Person.fromPersistableBundle(persistableBundle.getPersistableBundle(a.toString()));
            i2 = i3;
        }
        return personArr;
    }
