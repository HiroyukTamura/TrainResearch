...
public final class TextViewCompat {
    ...
    private static int retrieveIntFromField(Field field, TextView textView) {
        try {
            ...
            StringBuilder a = C0681a.m330a("Could not retrieve value of ");
    ...
    public static void setFirstBaselineToTopHeight(@NonNull TextView textView, @C0042Px @IntRange(from = 0) int i) {
    ...
    public static void setLastBaselineToBottomHeight(@NonNull TextView textView, @C0042Px @IntRange(from = 0) int i) {
        Preconditions.checkArgumentNonnegative(i);
        Paint.FontMetricsInt fontMetricsInt = textView.getPaint().getFontMetricsInt();
    ...
    public static void setLineHeight(@NonNull TextView textView, @C0042Px @IntRange(from = 0) int i) {
        Preconditions.checkArgumentNonnegative(i);
