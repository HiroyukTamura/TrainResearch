...
public final class ColorUtils {
    ...
    @ColorInt
    public static int LABToColor(@FloatRange(from = 0.0d, mo667to = 100.0d) double d, @FloatRange(from = -128.0d, mo667to = 127.0d) double d2, @FloatRange(from = -128.0d, mo667to = 127.0d) double d3) {
        double[] tempDouble3Array = getTempDouble3Array();
        LABToXYZ(d, d2, d3, tempDouble3Array);
        return XYZToColor(tempDouble3Array[0], tempDouble3Array[1], tempDouble3Array[2]);
    }

    public static void LABToXYZ(@FloatRange(from = 0.0d, mo667to = 100.0d) double d, @FloatRange(from = -128.0d, mo667to = 127.0d) double d2, @FloatRange(from = -128.0d, mo667to = 127.0d) double d3, @NonNull double[] dArr) {
    ...
    public static void RGBToHSL(@IntRange(from = 0, mo685to = 255) int i, @IntRange(from = 0, mo685to = 255) int i2, @IntRange(from = 0, mo685to = 255) int i3, @NonNull float[] fArr) {
        float f;
        float f2;
    ...
    public static void RGBToLAB(@IntRange(from = 0, mo685to = 255) int i, @IntRange(from = 0, mo685to = 255) int i2, @IntRange(from = 0, mo685to = 255) int i3, @NonNull double[] dArr) {
        RGBToXYZ(i, i2, i3, dArr);
        XYZToLAB(dArr[0], dArr[1], dArr[2], dArr);
    }

    public static void RGBToXYZ(@IntRange(from = 0, mo685to = 255) int i, @IntRange(from = 0, mo685to = 255) int i2, @IntRange(from = 0, mo685to = 255) int i3, @NonNull double[] dArr) {
        double[] dArr2 = dArr;
        if (dArr2.length == 3) {
            double d = (double) i;
            Double.isNaN(d);
    ...
    @ColorInt
    public static int XYZToColor(@FloatRange(from = 0.0d, mo667to = 95.047d) double d, @FloatRange(from = 0.0d, mo667to = 100.0d) double d2, @FloatRange(from = 0.0d, mo667to = 108.883d) double d3) {
    ...
    public static void XYZToLAB(@FloatRange(from = 0.0d, mo667to = 95.047d) double d, @FloatRange(from = 0.0d, mo667to = 100.0d) double d2, @FloatRange(from = 0.0d, mo667to = 108.883d) double d3, @NonNull double[] dArr) {
        if (dArr.length == 3) {
    ...
    @ColorInt
    public static int blendARGB(@ColorInt int i, @ColorInt int i2, @FloatRange(from = 0.0d, mo667to = 1.0d) float f) {
        float f2 = 1.0f - f;
    ...
    public static void blendHSL(@NonNull float[] fArr, @NonNull float[] fArr2, @FloatRange(from = 0.0d, mo667to = 1.0d) float f, @NonNull float[] fArr3) {
        if (fArr3.length == 3) {
            float f2 = 1.0f - f;
    ...
    public static void blendLAB(@NonNull double[] dArr, @NonNull double[] dArr2, @FloatRange(from = 0.0d, mo667to = 1.0d) double d, @NonNull double[] dArr3) {
        if (dArr3.length == 3) {
            double d2 = 1.0d - d;
    ...
    public static double calculateContrast(@ColorInt int i, @ColorInt int i2) {
        ...
        StringBuilder a = C0681a.m330a("background can not be translucent: #");
    ...
    public static Color compositeColors(@NonNull Color color, @NonNull Color color2) {
        ...
        StringBuilder a = C0681a.m330a("Color models must match (");
        a.append(color.getModel());
        a.append(" vs. ");
        a.append(color2.getModel());
        a.append(")");
        throw new IllegalArgumentException(a.toString());
    }
    ...
    @ColorInt
    public static int setAlphaComponent(@ColorInt int i, @IntRange(from = 0, mo685to = 255) int i2) {
        if (i2 >= 0 && i2 <= 255) {
