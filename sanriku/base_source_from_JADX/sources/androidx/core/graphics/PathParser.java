...
public class PathParser {
    ...
    public static class PathDataNode {
        ...
        private static void arcToBezier(Path path, double d, double d2, double d3, double d4, double d5, double d6, double d7, double d8, double d9) {
            ...
            while (i < ceil) {
                ...
                double d26 = (((d10 * cos) * cos3) + d) - (d13 * sin3);
                double d27 = (d16 * sin3) + (d10 * sin * cos3) + d2;
                double d28 = (d12 * sin3) - (d13 * cos3);
                double d29 = (cos3 * d16) + (sin3 * d15);
                double d30 = d25 - d20;
                ...
                float f = (float) (d26 - (sqrt * d28));
                path.cubicTo((float) ((d22 * sqrt) + d23), (float) ((d21 * sqrt) + d24), f, (float) (d27 - (sqrt * d29)), (float) d26, (float) d27);
                i++;
                d19 = d19;
                sin = d32;
                d23 = d26;
        ...
        private static void drawArc(Path path, float f, float f2, float f3, float f4, float f5, float f6, float f7, boolean z, boolean z2) {
            ...
            Double.isNaN(d11);
            double d29 = d * d11;
            arcToBezier(path, (d28 * cos) - (d29 * d23), (d29 * cos) + (d28 * d23), d7, d11, d5, d13, radians, atan2, atan22);
        }
    ...
    public static Path createPathFromPathData(String str) {
        ...
        try {
            ...
            throw new RuntimeException(C0681a.m320a("Error in parsing ", str), e);
        }
    }
    ...
    private static float[] getFloats(String str) {
        ...
        try {
            ...
            throw new RuntimeException(C0681a.m321a("error in parsing \"", str, "\""), e);
        }
    }
