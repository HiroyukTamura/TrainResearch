...
public class PrecomputedTextCompat implements Spannable {
    ...
    public static final class Params {
        ...
        public String toString() {
            ...
            StringBuilder a = C0681a.m330a("textSize=");
            a.append(this.mPaint.getTextSize());
            sb2.append(a.toString());
            sb2.append(", textScaleX=" + this.mPaint.getTextScaleX());
            sb2.append(", textSkewX=" + this.mPaint.getTextSkewX());
            if (Build.VERSION.SDK_INT >= 21) {
                StringBuilder a2 = C0681a.m330a(", letterSpacing=");
                a2.append(this.mPaint.getLetterSpacing());
                sb2.append(a2.toString());
                sb2.append(", elegantTextHeight=" + this.mPaint.isElegantTextHeight());
            }
            if (Build.VERSION.SDK_INT >= 24) {
                sb = C0681a.m330a(", textLocale=");
                obj = this.mPaint.getTextLocales();
            } else {
                sb = C0681a.m330a(", textLocale=");
                obj = this.mPaint.getTextLocale();
            }
            sb.append(obj);
            sb2.append(sb.toString());
            StringBuilder a3 = C0681a.m330a(", typeface=");
            a3.append(this.mPaint.getTypeface());
            sb2.append(a3.toString());
            if (Build.VERSION.SDK_INT >= 26) {
                StringBuilder a4 = C0681a.m330a(", variationSettings=");
                a4.append(this.mPaint.getFontVariationSettings());
                sb2.append(a4.toString());
            }
            StringBuilder a5 = C0681a.m330a(", textDir=");
            a5.append(this.mTextDir);
