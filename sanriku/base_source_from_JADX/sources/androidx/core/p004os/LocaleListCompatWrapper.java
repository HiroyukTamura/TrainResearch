...
final class LocaleListCompatWrapper implements LocaleListInterface {
    ...
    private static final Locale LOCALE_EN_XA = new Locale(LocaleEx.ENGLISH_LANGUAGE, "XA");
    ...
    LocaleListCompatWrapper(@NonNull Locale... localeArr) {
        ...
        if (localeArr.length == 0) {
            ...
            while (i < localeArr.length) {
                ...
                if (locale == null) {
                    throw new NullPointerException(C0681a.m317a("list[", i, "] is null"));
                    ...
                    throw new IllegalArgumentException(C0681a.m317a("list[", i, "] is a repetition"));
                }
            }
