...
public final class SparseArrayKt {
    ...
    public static final <T> SparseArray<T> plus(SparseArray<T> sparseArray, SparseArray<T> sparseArray2) {
        ...
        Intrinsics.checkParameterIsNotNull(sparseArray2, FitnessActivities.OTHER);
