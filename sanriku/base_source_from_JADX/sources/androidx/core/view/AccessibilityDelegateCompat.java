...
public class AccessibilityDelegateCompat {
    ...
    static List<AccessibilityNodeInfoCompat.AccessibilityActionCompat> getActionList(View view) {
        List<AccessibilityNodeInfoCompat.AccessibilityActionCompat> list = (List) view.getTag(C0192R.C0194id.tag_accessibility_actions);
    ...
    private boolean performClickableSpanAction(int i, View view) {
        ...
        SparseArray sparseArray = (SparseArray) view.getTag(C0192R.C0194id.tag_accessibility_clickable_spans);
    ...
    public boolean performAccessibilityAction(View view, int i, Bundle bundle) {
        ...
        return (z || i != C0192R.C0194id.accessibility_action_clickable_span) ? z : performClickableSpanAction(bundle.getInt(AccessibilityClickableSpanCompat.SPAN_ID, -1), view);
    }
