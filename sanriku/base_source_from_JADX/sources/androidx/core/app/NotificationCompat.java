...
public class NotificationCompat {
    ...
    public static class Builder {
        ...
        private Bitmap reduceLargeIconSize(Bitmap bitmap) {
            ...
            int dimensionPixelSize = resources.getDimensionPixelSize(C0192R.dimen.compat_notification_large_icon_max_width);
            int dimensionPixelSize2 = resources.getDimensionPixelSize(C0192R.dimen.compat_notification_large_icon_max_height);
    ...
    public static class DecoratedCustomViewStyle extends Style {
        ...
        private RemoteViews createRemoteViews(RemoteViews remoteViews, boolean z) {
            ...
            boolean z2 = true;
            int i = 0;
            RemoteViews applyStandardTemplate = applyStandardTemplate(true, C0192R.layout.notification_template_custom_big, false);
            applyStandardTemplate.removeAllViews(C0192R.C0194id.actions);
            ...
            if (!z || nonContextualActions == null || (min = Math.min(nonContextualActions.size(), 3)) <= 0) {
                ...
                for (int i2 = 0; i2 < min; i2++) {
                    applyStandardTemplate.addView(C0192R.C0194id.actions, generateActionButton(nonContextualActions.get(i2)));
                }
            }
            if (!z2) {
                i = 8;
            }
            applyStandardTemplate.setViewVisibility(C0192R.C0194id.actions, i);
            applyStandardTemplate.setViewVisibility(C0192R.C0194id.action_divider, i);
        ...
        private RemoteViews generateActionButton(Action action) {
            ...
            RemoteViews remoteViews = new RemoteViews(this.mBuilder.mContext.getPackageName(), z ? C0192R.layout.notification_action_tombstone : C0192R.layout.notification_action);
            remoteViews.setImageViewBitmap(C0192R.C0194id.action_image, createColoredBitmap(action.getIconCompat(), this.mBuilder.mContext.getResources().getColor(C0192R.color.notification_action_color_filter)));
            remoteViews.setTextViewText(C0192R.C0194id.action_text, action.title);
            if (!z) {
                remoteViews.setOnClickPendingIntent(C0192R.C0194id.action_container, action.actionIntent);
            }
            remoteViews.setContentDescription(C0192R.C0194id.action_container, action.title);
            return remoteViews;
        }
    ...
    public static abstract class Style {
        ...
        private int calculateTopPadding() {
            ...
            int dimensionPixelSize = resources.getDimensionPixelSize(C0192R.dimen.notification_top_pad);
            int dimensionPixelSize2 = resources.getDimensionPixelSize(C0192R.dimen.notification_top_pad_large_text);
        ...
        private Bitmap createIconWithBackground(int i, int i2, int i3, int i4) {
            int i5 = C0192R.C0193drawable.notification_icon_background;
            if (i4 == 0) {
                i4 = 0;
            }
        ...
        private void hideNormalContent(RemoteViews remoteViews) {
            remoteViews.setViewVisibility(C0192R.C0194id.title, 8);
            remoteViews.setViewVisibility(C0192R.C0194id.text2, 8);
            remoteViews.setViewVisibility(C0192R.C0194id.text, 8);
        }
        ...
        public android.widget.RemoteViews applyStandardTemplate(boolean r12, int r13, boolean r14) {
            ...
            L_0x0023:
                ...
                int r13 = androidx.core.C0192R.C0194id.notification_background
                int r4 = androidx.core.C0192R.C0193drawable.notification_bg_low
                r7.setInt(r13, r2, r4)
                int r13 = androidx.core.C0192R.C0194id.icon
                int r4 = androidx.core.C0192R.C0193drawable.notification_template_icon_low_bg
                goto L_0x0044
            L_0x0039:
                int r13 = androidx.core.C0192R.C0194id.notification_background
                int r4 = androidx.core.C0192R.C0193drawable.notification_bg
                r7.setInt(r13, r2, r4)
                int r13 = androidx.core.C0192R.C0194id.icon
                int r4 = androidx.core.C0192R.C0193drawable.notification_template_icon_bg
            L_0x0044:
                r7.setInt(r13, r2, r4)
            L_0x0047:
                androidx.core.app.NotificationCompat$Builder r13 = r11.mBuilder
                ...
                int r12 = r12.icon
                if (r12 == 0) goto L_0x00e9
                int r12 = androidx.core.C0192R.dimen.notification_right_icon_size
                int r12 = r0.getDimensionPixelSize(r12)
                int r13 = androidx.core.C0192R.dimen.notification_small_icon_background_padding
                ...
                int r13 = androidx.core.C0192R.C0194id.right_icon
                r7.setImageViewBitmap(r13, r12)
                goto L_0x009c
            L_0x008d:
                int r12 = androidx.core.C0192R.C0194id.right_icon
                androidx.core.app.NotificationCompat$Builder r13 = r11.mBuilder
            ...
            L_0x00a2:
                ...
                int r12 = r12.icon
                if (r12 == 0) goto L_0x00e9
                int r12 = androidx.core.C0192R.C0194id.icon
                r7.setViewVisibility(r12, r9)
                int r12 = android.os.Build.VERSION.SDK_INT
                if (r12 < r3) goto L_0x00da
                int r12 = androidx.core.C0192R.dimen.notification_large_icon_width
                int r12 = r0.getDimensionPixelSize(r12)
                int r13 = androidx.core.C0192R.dimen.notification_big_circle_margin
                int r13 = r0.getDimensionPixelSize(r13)
                int r12 = r12 - r13
                int r13 = androidx.core.C0192R.dimen.notification_small_icon_size_as_large
                int r13 = r0.getDimensionPixelSize(r13)
                androidx.core.app.NotificationCompat$Builder r1 = r11.mBuilder
                android.app.Notification r2 = r1.mNotification
                int r2 = r2.icon
            ...
            L_0x00e9:
                ...
                int r13 = androidx.core.C0192R.C0194id.title
                r7.setTextViewText(r13, r12)
            L_0x00f4:
                androidx.core.app.NotificationCompat$Builder r12 = r11.mBuilder
                java.lang.CharSequence r12 = r12.mContentText
                if (r12 == 0) goto L_0x0101
                int r13 = androidx.core.C0192R.C0194id.text
                r7.setTextViewText(r13, r12)
                r12 = 1
                goto L_0x0102
            L_0x0101:
            ...
            L_0x010f:
                ...
                int r12 = androidx.core.C0192R.C0194id.info
            ...
            L_0x0124:
                ...
                int r12 = androidx.core.C0192R.integer.status_bar_notification_info_maxnum
                int r12 = r0.getInteger(r12)
                androidx.core.app.NotificationCompat$Builder r13 = r11.mBuilder
                int r13 = r13.mNumber
                if (r13 <= r12) goto L_0x0140
                int r12 = androidx.core.C0192R.C0194id.info
                int r13 = androidx.core.C0192R.string.status_bar_notification_info_overflow
                java.lang.String r13 = r0.getString(r13)
                r7.setTextViewText(r12, r13)
                goto L_0x011c
            L_0x0140:
                java.text.NumberFormat r12 = java.text.NumberFormat.getIntegerInstance()
                int r13 = androidx.core.C0192R.C0194id.info
                androidx.core.app.NotificationCompat$Builder r1 = r11.mBuilder
                int r1 = r1.mNumber
                long r1 = (long) r1
                ...
                goto L_0x011c
            L_0x0153:
                int r1 = androidx.core.C0192R.C0194id.info
                r7.setViewVisibility(r1, r10)
            L_0x0158:
                androidx.core.app.NotificationCompat$Builder r1 = r11.mBuilder
                java.lang.CharSequence r1 = r1.mSubText
                if (r1 == 0) goto L_0x017a
                int r2 = androidx.core.C0192R.C0194id.text
                r7.setTextViewText(r2, r1)
                androidx.core.app.NotificationCompat$Builder r1 = r11.mBuilder
                java.lang.CharSequence r1 = r1.mContentText
                if (r1 == 0) goto L_0x0175
                int r2 = androidx.core.C0192R.C0194id.text2
                r7.setTextViewText(r2, r1)
                int r1 = androidx.core.C0192R.C0194id.text2
            ...
            L_0x017b:
                ...
                int r14 = androidx.core.C0192R.dimen.notification_subtext_size
                int r14 = r0.getDimensionPixelSize(r14)
                float r14 = (float) r14
                int r0 = androidx.core.C0192R.C0194id.text
                r7.setTextViewTextSize(r0, r9, r14)
            L_0x018b:
                int r2 = androidx.core.C0192R.C0194id.line1
                r3 = 0
                r4 = 0
                r5 = 0
                r6 = 0
            ...
            L_0x0195:
                ...
                int r13 = androidx.core.C0192R.C0194id.chronometer
                r7.setViewVisibility(r13, r9)
                int r13 = androidx.core.C0192R.C0194id.chronometer
                androidx.core.app.NotificationCompat$Builder r14 = r11.mBuilder
                long r0 = r14.getWhenIfShowing()
                ...
                int r14 = androidx.core.C0192R.C0194id.chronometer
                r7.setChronometerCountDown(r14, r13)
                goto L_0x01f0
            L_0x01dc:
                int r13 = androidx.core.C0192R.C0194id.time
                r7.setViewVisibility(r13, r9)
                int r13 = androidx.core.C0192R.C0194id.time
                androidx.core.app.NotificationCompat$Builder r14 = r11.mBuilder
                long r0 = r14.getWhenIfShowing()
            ...
            L_0x01ef:
                r8 = r13
            L_0x01f0:
                int r13 = androidx.core.C0192R.C0194id.right_side
            ...
            L_0x01f8:
                ...
                int r13 = androidx.core.C0192R.C0194id.line3
        ...
        public void buildIntoRemoteViews(RemoteViews remoteViews, RemoteViews remoteViews2) {
            ...
            remoteViews.removeAllViews(C0192R.C0194id.notification_main_column);
            remoteViews.addView(C0192R.C0194id.notification_main_column, remoteViews2.clone());
            remoteViews.setViewVisibility(C0192R.C0194id.notification_main_column, 0);
            if (Build.VERSION.SDK_INT >= 21) {
                remoteViews.setViewPadding(C0192R.C0194id.notification_main_column_container, 0, calculateTopPadding(), 0, 0);
            }
        }
