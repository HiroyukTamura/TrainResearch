...
public final class NotificationManagerCompat {
    ...
    private static class CancelTask implements Task {
        ...
        public String toString() {
            StringBuilder b = C0681a.m339b("CancelTask[", "packageName:");
    ...
    private static class NotifyTask implements Task {
        ...
        @NonNull
        public String toString() {
            StringBuilder b = C0681a.m339b("NotifyTask[", "packageName:");
            b.append(this.packageName);
            b.append(", id:");
            b.append(this.f26id);
            b.append(", tag:");
            return C0681a.m324a(b, this.tag, "]");
        }
    }
    ...
    private static class SideChannelManager implements Handler.Callback, ServiceConnection {
        ...
        private boolean ensureServiceBound(ListenerRecord listenerRecord) {
            ...
            if (bindService) {
                ...
                StringBuilder a = C0681a.m330a("Unable to bind to listener ");
        ...
        private void processListenerQueue(ListenerRecord listenerRecord) {
            if (Log.isLoggable(NotificationManagerCompat.TAG, 3)) {
                StringBuilder a = C0681a.m330a("Processing component ");
                a.append(listenerRecord.componentName);
                a.append(", ");
            ...
            if (!listenerRecord.taskQueue.isEmpty()) {
                ...
                while (true) {
                    ...
                    try {
                        ...
                        if (Log.isLoggable(NotificationManagerCompat.TAG, 3)) {
                            StringBuilder a2 = C0681a.m330a("Remote service has died: ");
                            a2.append(listenerRecord.componentName);
                            Log.d(NotificationManagerCompat.TAG, a2.toString());
                        }
                    } catch (RemoteException e) {
                        StringBuilder a3 = C0681a.m330a("RemoteException communicating with ");
                        a3.append(listenerRecord.componentName);
                        Log.w(NotificationManagerCompat.TAG, a3.toString(), e);
                    }
                }
                if (!listenerRecord.taskQueue.isEmpty()) {
                    scheduleListenerRetry(listenerRecord);
        ...
        private void scheduleListenerRetry(ListenerRecord listenerRecord) {
            if (!this.mHandler.hasMessages(3, listenerRecord.componentName)) {
                ...
                if (i > 6) {
                    StringBuilder a = C0681a.m330a("Giving up on delivering ");
                    a.append(listenerRecord.taskQueue.size());
                    a.append(" tasks to ");
                    a.append(listenerRecord.componentName);
                    a.append(" after ");
            ...
            if (!enabledListenerPackages.equals(this.mCachedEnabledPackages)) {
                ...
                while (it2.hasNext()) {
                    ...
                    if (!hashSet.contains(next2.getKey())) {
                        if (Log.isLoggable(NotificationManagerCompat.TAG, 3)) {
                            StringBuilder a = C0681a.m330a("Removing listener record for ");
