...
public class AsyncListUtil<T> {
    ...
    private final ThreadUtil.BackgroundCallback<T> mBackgroundCallback = new ThreadUtil.BackgroundCallback<T>() {
        ...
        private void log(String str, Object... objArr) {
            StringBuilder a = C0681a.m330a("[BKGR] ");
            a.append(String.format(str, objArr));
            Log.d(AsyncListUtil.TAG, a.toString());
        }
    ...
    private final ThreadUtil.MainThreadCallback<T> mMainThreadCallback = new ThreadUtil.MainThreadCallback<T>() {
        ...
        public void addTile(int i, TileList.Tile<T> tile) {
            ...
            if (addOrReplace != null) {
                StringBuilder a = C0681a.m330a("duplicate tile @");
                a.append(addOrReplace.mStartPosition);
                Log.e(AsyncListUtil.TAG, a.toString());
    ...
    public void log(String str, Object... objArr) {
        StringBuilder a = C0681a.m330a("[MAIN] ");
        a.append(String.format(str, objArr));
