...
public class DiffUtil {
    private static final Comparator<Snake> SNAKE_COMPARATOR = new Comparator<Snake>() {
        public int compare(Snake snake, Snake snake2) {
            int i = snake.f37x - snake2.f37x;
            return i == 0 ? snake.f38y - snake2.f38y : i;
        }
    };
    ...
    public static class DiffResult {
        ...
        private void addRootSnake() {
            ...
            if (snake == null || snake.f37x != 0 || snake.f38y != 0) {
        ...
        private void dispatchAdditions(List<PostponedUpdate> list, ListUpdateCallback listUpdateCallback, int i, int i2, int i3) {
            ...
            for (int i4 = i2 - 1; i4 >= 0; i4--) {
                ...
                if (i6 == 0) {
                    ...
                    StringBuilder b = C0681a.m338b("unknown flag for pos ", i5, " ");
                    b.append(Long.toBinaryString((long) i6));
        ...
        public int convertNewPositionToOld(@IntRange(from = 0) int i) {
            ...
            StringBuilder b = C0681a.m338b("Index out of bounds - passed position = ", i, ", new list size = ");
            b.append(this.mNewItemStatuses.length);
        ...
        public int convertOldPositionToNew(@IntRange(from = 0) int i) {
            ...
            StringBuilder b = C0681a.m338b("Index out of bounds - passed position = ", i, ", old list size = ");
            b.append(this.mOldItemStatuses.length);
            throw new IndexOutOfBoundsException(b.toString());
        }
        ...
        public void dispatchUpdatesTo(@NonNull ListUpdateCallback listUpdateCallback) {
            ...
            for (int size = this.mSnakes.size() - 1; size >= 0; size--) {
                Snake snake = this.mSnakes.get(size);
                int i3 = snake.size;
                int i4 = snake.f37x + i3;
                int i5 = snake.f38y + i3;
                if (i4 < i) {
                ...
                for (int i6 = i3 - 1; i6 >= 0; i6--) {
                    ...
                    int i7 = snake.f37x;
                    if ((iArr[i7 + i6] & 31) == 2) {
                        batchingListUpdateCallback.onChanged(i7 + i6, 1, this.mCallback.getChangePayload(i7 + i6, snake.f38y + i6));
                    }
                }
                i = snake.f37x;
                i2 = snake.f38y;
