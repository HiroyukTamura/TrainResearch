...
public class StaggeredGridLayoutManager extends RecyclerView.LayoutManager implements RecyclerView.SmoothScroller.ScrollVectorProvider {
    ...
    static class LazySpanLookup {
        ...
        static class FullSpanItem implements Parcelable {
            ...
            public String toString() {
                StringBuilder a = C0681a.m330a("FullSpanItem{mPosition=");
                a.append(this.mPosition);
                a.append(", mGapDir=");
                a.append(this.mGapDir);
                a.append(", mHasUnwantedGapAfter=");
                a.append(this.mHasUnwantedGapAfter);
                a.append(", mGapPerSpan=");
                a.append(Arrays.toString(this.mGapPerSpan));
                a.append('}');
                return a.toString();
            }
    ...
    public int[] findFirstCompletelyVisibleItemPositions(int[] iArr) {
        if (iArr == null) {
            ...
            StringBuilder a = C0681a.m330a("Provided int[]'s size must be more than or equal to span count. Expected:");
            a.append(this.mSpanCount);
            a.append(", array size:");
