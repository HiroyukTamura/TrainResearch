...
final class BackStackRecord extends FragmentTransaction implements FragmentManager.BackStackEntry, FragmentManager.OpGenerator {
    ...
    public void bumpBackStackNesting(int i) {
        if (this.mAddToBackStack) {
            ...
            for (int i2 = 0; i2 < size; i2++) {
                FragmentTransaction.C0290Op op = this.mOps.get(i2);
                Fragment fragment = op.mFragment;
                if (fragment != null) {
                    fragment.mBackStackNesting += i;
                    if (FragmentManager.isLoggingEnabled(2)) {
                        StringBuilder a = C0681a.m330a("Bump nesting of ");
                        a.append(op.mFragment);
                        a.append(" to ");
                        a.append(op.mFragment.mBackStackNesting);
    ...
    public FragmentTransaction detach(@NonNull Fragment fragment) {
        ...
        StringBuilder a = C0681a.m330a("Cannot detach Fragment attached to a different FragmentManager. Fragment ");
    ...
    public void dump(String str, PrintWriter printWriter, boolean z) {
        ...
        if (!this.mOps.isEmpty()) {
            ...
            for (int i = 0; i < size; i++) {
                FragmentTransaction.C0290Op op = this.mOps.get(i);
                switch (op.mCmd) {
                    case 0:
                        str2 = "NULL";
                        break;
                    ...
                    case 10:
                        ...
                        break;
                    default:
                        StringBuilder a = C0681a.m330a("cmd=");
                        a.append(op.mCmd);
                        str2 = a.toString();
                        break;
                }
        ...
        for (int i = 0; i < size; i++) {
            ...
            switch (op.mCmd) {
                ...
                case 10:
                    ...
                    break;
                default:
                    StringBuilder a = C0681a.m330a("Unknown cmd: ");
                    a.append(op.mCmd);
    ...
    public void executePopOps(boolean z) {
        for (int size = this.mOps.size() - 1; size >= 0; size--) {
            FragmentTransaction.C0290Op op = this.mOps.get(size);
            Fragment fragment = op.mFragment;
            if (fragment != null) {
            ...
            if (i2 != 1) {
                if (i2 == 2) {
                    ...
                    if (fragment5 == fragment2) {
                        this.mOps.add(i, new FragmentTransaction.C0290Op(9, fragment5));
                        i++;
                        fragment2 = null;
                    }
                } else if (i2 != 7) {
    ...
    public FragmentTransaction hide(@NonNull Fragment fragment) {
        ...
        StringBuilder a = C0681a.m330a("Cannot hide Fragment attached to a different FragmentManager. Fragment ");
        a.append(fragment.toString());
        a.append(" is already attached to a FragmentManager.");
        throw new IllegalStateException(a.toString());
    }
    ...
    public FragmentTransaction remove(@NonNull Fragment fragment) {
        ...
        StringBuilder a = C0681a.m330a("Cannot remove Fragment attached to a different FragmentManager. Fragment ");
        a.append(fragment.toString());
        a.append(" is already attached to a FragmentManager.");
        throw new IllegalStateException(a.toString());
    }
    ...
    public FragmentTransaction setMaxLifecycle(@NonNull Fragment fragment, @NonNull Lifecycle.State state) {
        if (fragment.mFragmentManager != this.mManager) {
            StringBuilder a = C0681a.m330a("Cannot setMaxLifecycle for Fragment not attached to FragmentManager ");
            a.append(this.mManager);
            throw new IllegalArgumentException(a.toString());
        } else if (state.isAtLeast(Lifecycle.State.CREATED)) {
            return super.setMaxLifecycle(fragment, state);
        } else {
            StringBuilder a2 = C0681a.m330a("Cannot set maximum Lifecycle below ");
            a2.append(Lifecycle.State.CREATED);
    ...
    public FragmentTransaction setPrimaryNavigationFragment(@Nullable Fragment fragment) {
        ...
        StringBuilder a = C0681a.m330a("Cannot setPrimaryNavigation for Fragment attached to a different FragmentManager. Fragment ");
        a.append(fragment.toString());
        a.append(" is already attached to a FragmentManager.");
        throw new IllegalStateException(a.toString());
    }
    ...
    public FragmentTransaction show(@NonNull Fragment fragment) {
        ...
        StringBuilder a = C0681a.m330a("Cannot show Fragment attached to a different FragmentManager. Fragment ");
        a.append(fragment.toString());
        a.append(" is already attached to a FragmentManager.");
        throw new IllegalStateException(a.toString());
    }
