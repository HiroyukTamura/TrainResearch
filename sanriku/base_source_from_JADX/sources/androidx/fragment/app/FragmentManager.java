...
public abstract class FragmentManager {
    ...
    static Fragment getViewFragment(@NonNull View view) {
        Object tag = view.getTag(C0264R.C0266id.fragment_container_view_tag);
    ...
    private void setVisibleRemovingFragment(@NonNull Fragment fragment) {
        ...
        if (fragmentContainer != null) {
            if (fragmentContainer.getTag(C0264R.C0266id.visible_removing_fragment_view_tag) == null) {
                fragmentContainer.setTag(C0264R.C0266id.visible_removing_fragment_view_tag, fragment);
            }
            ((Fragment) fragmentContainer.getTag(C0264R.C0266id.visible_removing_fragment_view_tag)).setNextAnim(fragment.getNextAnim());
        }
    }
    ...
    public void dump(@NonNull String str, @Nullable FileDescriptor fileDescriptor, @NonNull PrintWriter printWriter, @Nullable String[] strArr) {
        ...
        if (arrayList2 != null && (size = arrayList2.size()) > 0) {
            ...
            for (int i2 = 0; i2 < size; i2++) {
                ...
                backStackRecord.dump(a, printWriter);
            }
        }
        printWriter.print(str);
    ...
    public void moveToState(@androidx.annotation.NonNull androidx.fragment.app.Fragment r13, int r14) {
        ...
        L_0x00b8:
            ...
            java.lang.String r13 = p009e.p010a.p011a.p012a.C0681a.m324a((java.lang.StringBuilder) r0, (java.lang.String) r13, (java.lang.String) r8)
            r14.<init>(r13)
            throw r14
        L_0x00d2:
    ...
    public void popBackStack(int i, int i2) {
        ...
        throw new IllegalArgumentException(C0681a.m316a("Bad id: ", i));
    }
    ...
    public void putFragment(@NonNull Bundle bundle, @NonNull String str, @NonNull Fragment fragment) {
        if (fragment.mFragmentManager != this) {
            throwException(new IllegalStateException(C0681a.m319a("Fragment ", fragment, " is not currently in the FragmentManager")));
        }
            ...
            if (fragmentManagerState.mActive != null) {
                ...
                while (it.hasNext()) {
                    ...
                    if (next != null) {
                        ...
                        if (isLoggingEnabled(2)) {
                            StringBuilder a = C0681a.m330a("restoreSaveState: active (");
                            a.append(fragment.mWho);
                            a.append("): ");
                            a.append(fragment);
                ...
                if (fragmentManagerState.mBackStack != null) {
                    ...
                    while (true) {
                        ...
                        if (isLoggingEnabled(2)) {
                            StringBuilder b = C0681a.m338b("restoreAllState: back stack #", i, " (index ");
                            b.append(instantiate.mIndex);
                            b.append("): ");
                            b.append(instantiate);
    ...
    public Parcelable saveAllState() {
        ...
        if (arrayList != null && (size = arrayList.size()) > 0) {
            ...
            for (int i = 0; i < size; i++) {
                ...
                if (isLoggingEnabled(2)) {
                    StringBuilder b = C0681a.m338b("saveAllState: adding back stack #", i, ": ");
                    b.append(this.mBackStack.get(i));
                    Log.v(TAG, b.toString());
                }
            }
        }
