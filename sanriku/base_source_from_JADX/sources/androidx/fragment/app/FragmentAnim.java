...
class FragmentAnim {
    ...
    static AnimationOrAnimator loadAnimation(@NonNull Context context, @NonNull FragmentContainer fragmentContainer, @NonNull Fragment fragment, boolean z) {
        ...
        if (!(onFindViewById == null || onFindViewById.getTag(C0264R.C0266id.visible_removing_fragment_view_tag) == null)) {
            onFindViewById.setTag(C0264R.C0266id.visible_removing_fragment_view_tag, (Object) null);
        }
    ...
    private static int transitToAnimResourceId(int i, boolean z) {
        if (i == 4097) {
            return z ? C0264R.anim.fragment_open_enter : C0264R.anim.fragment_open_exit;
        }
        if (i == 4099) {
            return z ? C0264R.anim.fragment_fade_enter : C0264R.anim.fragment_fade_exit;
        }
        if (i != 8194) {
            return -1;
        }
        return z ? C0264R.anim.fragment_close_enter : C0264R.anim.fragment_close_exit;
    }
}
