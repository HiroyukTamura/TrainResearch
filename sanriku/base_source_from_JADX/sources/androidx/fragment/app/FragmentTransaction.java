...
public abstract class FragmentTransaction {
    ...
    static final class C0290Op {
        ...
        C0290Op(int i, @NonNull Fragment fragment, Lifecycle.State state) {
            this.mCmd = i;
            this.mFragment = fragment;
        ...
        if (FragmentTransition.supportsTransition()) {
            ...
            if (transitionName != null) {
                if (this.mSharedElementSourceNames == null) {
                    ...
                    throw new IllegalArgumentException(C0681a.m321a("A shared element with the target name '", str, "' has already been added to the transaction."));
                } else if (this.mSharedElementSourceNames.contains(transitionName)) {
                    throw new IllegalArgumentException(C0681a.m321a("A shared element with the source name '", transitionName, "' has already been added to the transaction."));
                }
    ...
    public void doAddOp(int i, Fragment fragment, @Nullable String str, int i2) {
        ...
        if (cls.isAnonymousClass() || !Modifier.isPublic(modifiers) || (cls.isMemberClass() && !Modifier.isStatic(modifiers))) {
            StringBuilder a = C0681a.m330a("Fragment ");
