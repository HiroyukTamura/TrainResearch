...
class FragmentTransition {
    ...
    private static void addToFirstInLastOut(androidx.fragment.app.BackStackRecord r8, androidx.fragment.app.FragmentTransaction.C0290Op r9, android.util.SparseArray<androidx.fragment.app.FragmentTransition.FragmentContainerTransition> r10, boolean r11, boolean r12) {
        /*
        ...
        if (fragmentManager2.mCurState >= 1) {
            ...
            if (sparseArray.size() != 0) {
                ...
                for (int i5 = 0; i5 < size; i5++) {
                    ...
                    if (z2) {
                        configureTransitionsReordered(fragmentManager3, keyAt, fragmentContainerTransition, view2, calculateNameOverrides, callback2);
                    } else {
                        configureTransitionsOrdered(fragmentManager3, keyAt, fragmentContainerTransition, view2, calculateNameOverrides, callback2);
                    }
                }
            }
        }
