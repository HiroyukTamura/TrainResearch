...
class RoundRectDrawableWithShadow extends Drawable {
    ...
    RoundRectDrawableWithShadow(Resources resources, ColorStateList colorStateList, float f, float f2, float f3) {
        this.mShadowStartColor = resources.getColor(C0171R.color.cardview_shadow_start_color);
        this.mShadowEndColor = resources.getColor(C0171R.color.cardview_shadow_end_color);
        this.mInsetShadow = resources.getDimensionPixelSize(C0171R.dimen.cardview_compat_inset_shadow);
    ...
    public float getMinHeight() {
        float f = this.mRawMaxShadowSize;
        float f2 = (f * SHADOW_MULTIPLIER) / 2.0f;
        return (((this.mRawMaxShadowSize * SHADOW_MULTIPLIER) + ((float) this.mInsetShadow)) * 2.0f) + (Math.max(f, f2 + this.mCornerRadius + ((float) this.mInsetShadow)) * 2.0f);
    }
