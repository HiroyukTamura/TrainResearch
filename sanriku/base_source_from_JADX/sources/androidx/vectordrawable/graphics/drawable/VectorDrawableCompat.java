...
public class VectorDrawableCompat extends VectorDrawableCommon {
    ...
    private static abstract class VPath extends VObject {
        ...
        public String nodesToString(PathParser.PathDataNode[] pathDataNodeArr) {
            ...
            for (int i = 0; i < pathDataNodeArr.length; i++) {
                ...
                a.append(pathDataNodeArr[i].mType);
                a.append(":");
                str = a.toString();
        ...
        public void printVPath(int i) {
            ...
            StringBuilder c = C0681a.m340c(str, "current path is :");
            c.append(this.mPathName);
            c.append(" pathData is ");
            c.append(nodesToString(this.mNodes));
            Log.v(VectorDrawableCompat.LOGTAG, c.toString());
        }
    ...
    private void printGroupTree(VGroup vGroup, int i) {
        ...
        StringBuilder c = C0681a.m340c(str, "current group is :");
        c.append(vGroup.getGroupName());
        c.append(" rotation is ");
        c.append(vGroup.mRotate);
