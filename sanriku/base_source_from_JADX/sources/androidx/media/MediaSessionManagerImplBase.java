...
class MediaSessionManagerImplBase implements MediaSessionManager.MediaSessionManagerImpl {
    ...
    public boolean isTrustedForMediaControl(@NonNull MediaSessionManager.RemoteUserInfoImpl remoteUserInfoImpl) {
        try {
            ...
            if (DEBUG) {
                StringBuilder a = C0681a.m330a("Package name ");
                a.append(remoteUserInfoImpl.getPackageName());
                a.append(" doesn't match with the uid ");
                a.append(remoteUserInfoImpl.getUid());
                Log.d(TAG, a.toString());
            }
            return false;
        } catch (PackageManager.NameNotFoundException unused) {
            if (DEBUG) {
                StringBuilder a2 = C0681a.m330a("Package ");
                a2.append(remoteUserInfoImpl.getPackageName());
