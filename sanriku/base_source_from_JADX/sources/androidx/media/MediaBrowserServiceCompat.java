...
public abstract class MediaBrowserServiceCompat extends Service {
                ...
                public void run() {
                    ...
                    while (it.hasNext()) {
                        ...
                        try {
                            ...
                            StringBuilder a = C0681a.m330a("Connection for ");
                            a.append(next.pkg);
    ...
    public static class Result<T> {
        ...
        public void detach() {
            if (this.mDetachCalled) {
                StringBuilder a = C0681a.m330a("detach() called when detach() had already been called for: ");
                a.append(this.mDebug);
                throw new IllegalStateException(a.toString());
            } else if (this.mSendResultCalled) {
                StringBuilder a2 = C0681a.m330a("detach() called when sendResult() had already been called for: ");
                a2.append(this.mDebug);
                throw new IllegalStateException(a2.toString());
            } else if (!this.mSendErrorCalled) {
                this.mDetachCalled = true;
            } else {
                StringBuilder a3 = C0681a.m330a("detach() called when sendError() had already been called for: ");
                a3.append(this.mDebug);
        ...
        public void onErrorSent(Bundle bundle) {
            StringBuilder a = C0681a.m330a("It is not supported to send an error for ");
            a.append(this.mDebug);
        ...
        public void onProgressUpdateSent(Bundle bundle) {
            StringBuilder a = C0681a.m330a("It is not supported to send an interim update for ");
            a.append(this.mDebug);
            throw new UnsupportedOperationException(a.toString());
        }
        ...
        public void sendError(Bundle bundle) {
            if (this.mSendResultCalled || this.mSendErrorCalled) {
                StringBuilder a = C0681a.m330a("sendError() called when either sendResult() or sendError() had already been called for: ");
                a.append(this.mDebug);
                throw new IllegalStateException(a.toString());
            }
        ...
        public void sendProgressUpdate(Bundle bundle) {
            if (this.mSendResultCalled || this.mSendErrorCalled) {
                StringBuilder a = C0681a.m330a("sendProgressUpdate() called when either sendResult() or sendError() had already been called for: ");
                a.append(this.mDebug);
                throw new IllegalStateException(a.toString());
            }
        ...
        public void sendResult(T t) {
            if (this.mSendResultCalled || this.mSendErrorCalled) {
                StringBuilder a = C0681a.m330a("sendResult() called when either sendResult() or sendError() had already been called for: ");
                a.append(this.mDebug);
                throw new IllegalStateException(a.toString());
            }
        ...
        public void addSubscription(String str, IBinder iBinder, Bundle bundle, ServiceCallbacks serviceCallbacks) {
            ...
            MediaBrowserServiceCompat.this.mHandler.postOrRun(new Runnable() {
                public void run() {
                    ...
                    if (connectionRecord == null) {
                        StringBuilder a = C0681a.m330a("addSubscription for callback that isn't registered id=");
                        a.append(str2);
                        Log.w(MediaBrowserServiceCompat.TAG, a.toString());
                        return;
                    }
            ...
            if (MediaBrowserServiceCompat.this.isValidPackage(str, i2)) {
                ...
                MediaBrowserServiceCompat.this.mHandler.postOrRun(new Runnable() {
                    public void run() {
                        ...
                        if (onGetRoot == null) {
                            StringBuilder a = C0681a.m330a("No root for client ");
                            a.append(str2);
                            a.append(" from service ");
                            a.append(C03771.class.getName());
                            Log.i(MediaBrowserServiceCompat.TAG, a.toString());
                            try {
                                serviceCallbacks2.onConnectFailed();
                            } catch (RemoteException unused) {
                                StringBuilder a2 = C0681a.m330a("Calling onConnectFailed() failed. Ignoring. pkg=");
                                a2.append(str2);
                            ...
                            try {
                                ...
                                StringBuilder a3 = C0681a.m330a("Calling onConnect() failed. Dropping client. pkg=");
                                a3.append(str2);
                                Log.w(MediaBrowserServiceCompat.TAG, a3.toString());
                                MediaBrowserServiceCompat.this.mConnections.remove(asBinder);
                            }
                        }
                    }
            ...
            if (!TextUtils.isEmpty(str) && resultReceiver != null) {
                MediaBrowserServiceCompat.this.mHandler.postOrRun(new Runnable() {
                    public void run() {
                        ...
                        if (connectionRecord == null) {
                            StringBuilder a = C0681a.m330a("getMediaItem for callback that isn't registered id=");
                            a.append(str);
                            Log.w(MediaBrowserServiceCompat.TAG, a.toString());
                            return;
                        }
        ...
        public void removeSubscription(final String str, final IBinder iBinder, final ServiceCallbacks serviceCallbacks) {
            MediaBrowserServiceCompat.this.mHandler.postOrRun(new Runnable() {
                public void run() {
                    ConnectionRecord connectionRecord = MediaBrowserServiceCompat.this.mConnections.get(serviceCallbacks.asBinder());
                    if (connectionRecord == null) {
                        StringBuilder a = C0681a.m330a("removeSubscription for callback that isn't registered id=");
                        a.append(str);
                        Log.w(MediaBrowserServiceCompat.TAG, a.toString());
                    } else if (!MediaBrowserServiceCompat.this.removeSubscription(str, connectionRecord, iBinder)) {
                        StringBuilder a2 = C0681a.m330a("removeSubscription called for ");
                        a2.append(str);
            ...
            if (!TextUtils.isEmpty(str) && resultReceiver != null) {
                ...
                MediaBrowserServiceCompat.this.mHandler.postOrRun(new Runnable() {
                    public void run() {
                        ConnectionRecord connectionRecord = MediaBrowserServiceCompat.this.mConnections.get(serviceCallbacks2.asBinder());
                        if (connectionRecord == null) {
                            StringBuilder a = C0681a.m330a("search for callback that isn't registered query=");
                            a.append(str2);
                            Log.w(MediaBrowserServiceCompat.TAG, a.toString());
                            return;
                        }
            ...
            if (!TextUtils.isEmpty(str) && resultReceiver != null) {
                ...
                MediaBrowserServiceCompat.this.mHandler.postOrRun(new Runnable() {
                    public void run() {
                        ConnectionRecord connectionRecord = MediaBrowserServiceCompat.this.mConnections.get(serviceCallbacks2.asBinder());
                        if (connectionRecord == null) {
                            StringBuilder a = C0681a.m330a("sendCustomAction for callback that isn't registered action=");
                            a.append(str2);
                            a.append(", extras=");
                            a.append(bundle2);
                            Log.w(MediaBrowserServiceCompat.TAG, a.toString());
    ...
    public void performCustomAction(String str, Bundle bundle, ConnectionRecord connectionRecord, final ResultReceiver resultReceiver) {
        C03664 r0 = new Result<Bundle>(str) {
            /* access modifiers changed from: package-private */
            public void onErrorSent(Bundle bundle) {
    ...
    public void performLoadChildren(String str, ConnectionRecord connectionRecord, Bundle bundle, Bundle bundle2) {
        ...
        C03631 r0 = new Result<List<MediaBrowserCompat.MediaItem>>(str) {
            /* access modifiers changed from: package-private */
            public void onResultSent(List<MediaBrowserCompat.MediaItem> list) {
                if (MediaBrowserServiceCompat.this.mConnections.get(connectionRecord2.callbacks.asBinder()) == connectionRecord2) {
                    ...
                    try {
                        ...
                        StringBuilder a = C0681a.m330a("Calling onLoadChildren() failed for id=");
                        a.append(str2);
                        a.append(" package=");
                        a.append(connectionRecord2.pkg);
                        Log.w(MediaBrowserServiceCompat.TAG, a.toString());
                    }
                } else if (MediaBrowserServiceCompat.DEBUG) {
                    StringBuilder a2 = C0681a.m330a("Not sending onLoadChildren result for connection that has been disconnected. pkg=");
                    a2.append(connectionRecord2.pkg);
                    a2.append(" id=");
                    a2.append(str2);
                    Log.d(MediaBrowserServiceCompat.TAG, a2.toString());
                }
            }
        };
        this.mCurConnection = connectionRecord;
        ...
        this.mCurConnection = null;
        if (!r0.isDone()) {
            StringBuilder a = C0681a.m330a("onLoadChildren must call detach() or sendResult() before returning for package=");
            a.append(connectionRecord.pkg);
            a.append(" id=");
            a.append(str);
            throw new IllegalStateException(a.toString());
        }
    ...
    public void performLoadItem(String str, ConnectionRecord connectionRecord, final ResultReceiver resultReceiver) {
        C03642 r0 = new Result<MediaBrowserCompat.MediaItem>(str) {
            /* access modifiers changed from: package-private */
            public void onResultSent(MediaBrowserCompat.MediaItem mediaItem) {
                if ((getFlags() & 2) != 0) {
        ...
        this.mCurConnection = null;
        if (!r0.isDone()) {
            throw new IllegalStateException(C0681a.m320a("onLoadItem must call detach() or sendResult() before returning for id=", str));
        }
    }

    /* access modifiers changed from: package-private */
    public void performSearch(String str, Bundle bundle, ConnectionRecord connectionRecord, final ResultReceiver resultReceiver) {
        C03653 r0 = new Result<List<MediaBrowserCompat.MediaItem>>(str) {
            /* access modifiers changed from: package-private */
            public void onResultSent(List<MediaBrowserCompat.MediaItem> list) {
        ...
        this.mCurConnection = null;
        if (!r0.isDone()) {
            throw new IllegalStateException(C0681a.m320a("onSearch must call detach() or sendResult() before returning for query=", str));
        }
    }
