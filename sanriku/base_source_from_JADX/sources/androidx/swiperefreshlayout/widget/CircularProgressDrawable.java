...
public class CircularProgressDrawable extends Drawable implements Animatable {
    ...
    private void applyFinishTranslation(float f, Ring ring) {
        ...
        ring.setStartTrim(C0681a.m301a(ring.getStartingEndTrim() - MIN_PROGRESS_ARC, ring.getStartingStartTrim(), f, ring.getStartingStartTrim()));
        ring.setEndTrim(ring.getStartingEndTrim());
        ring.setRotation(C0681a.m301a((float) (Math.floor((double) (ring.getStartingRotation() / MAX_PROGRESS_ARC)) + 1.0d), ring.getStartingRotation(), f, ring.getStartingRotation()));
    }
