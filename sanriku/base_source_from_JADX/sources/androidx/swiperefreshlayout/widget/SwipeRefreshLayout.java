...
public class SwipeRefreshLayout extends ViewGroup implements NestedScrollingParent, NestedScrollingChild {
    ...
    private void moveSpinner(float f) {
        ...
        this.mProgress.setProgressRotation(((f3 * DECELERATE_INTERPOLATION_FACTOR) + ((max * 0.4f) - 16.0f)) * DRAG_RATE);
    ...
    public void setSlingshotDistance(@C0042Px int i) {
