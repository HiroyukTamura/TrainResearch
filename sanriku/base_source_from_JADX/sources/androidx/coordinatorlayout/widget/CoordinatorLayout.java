...
import androidx.coordinatorlayout.C0187R;
...
public class CoordinatorLayout extends ViewGroup implements NestedScrollingParent2 {
    ...
    public static abstract class Behavior<V extends View> {
        ...
        @FloatRange(from = 0.0d, mo667to = 1.0d)
    ...
    public static class LayoutParams extends ViewGroup.MarginLayoutParams {
        ...
        LayoutParams(@NonNull Context context, @Nullable AttributeSet attributeSet) {
            ...
            TypedArray obtainStyledAttributes = context.obtainStyledAttributes(attributeSet, C0187R.styleable.CoordinatorLayout_Layout);
            this.gravity = obtainStyledAttributes.getInteger(C0187R.styleable.CoordinatorLayout_Layout_android_layout_gravity, 0);
            this.mAnchorId = obtainStyledAttributes.getResourceId(C0187R.styleable.CoordinatorLayout_Layout_layout_anchor, -1);
            this.anchorGravity = obtainStyledAttributes.getInteger(C0187R.styleable.CoordinatorLayout_Layout_layout_anchorGravity, 0);
            this.keyline = obtainStyledAttributes.getInteger(C0187R.styleable.CoordinatorLayout_Layout_layout_keyline, -1);
            this.insetEdge = obtainStyledAttributes.getInt(C0187R.styleable.CoordinatorLayout_Layout_layout_insetEdge, 0);
            this.dodgeInsetEdges = obtainStyledAttributes.getInt(C0187R.styleable.CoordinatorLayout_Layout_layout_dodgeInsetEdges, 0);
            boolean hasValue = obtainStyledAttributes.hasValue(C0187R.styleable.CoordinatorLayout_Layout_layout_behavior);
            this.mBehaviorResolved = hasValue;
            if (hasValue) {
                this.mBehavior = CoordinatorLayout.parseBehavior(context, attributeSet, obtainStyledAttributes.getString(C0187R.styleable.CoordinatorLayout_Layout_layout_behavior));
            }
        ...
        private void resolveAnchorView(View view, CoordinatorLayout coordinatorLayout) {
            ...
            if (findViewById != null) {
                ...
                StringBuilder a = C0681a.m330a("Could not find CoordinatorLayout descendant view with id ");
                a.append(coordinatorLayout.getResources().getResourceName(this.mAnchorId));
                a.append(" to anchor view ");
                a.append(view);
    ...
    public CoordinatorLayout(@NonNull Context context, @Nullable AttributeSet attributeSet) {
        this(context, attributeSet, C0187R.attr.coordinatorLayoutStyle);
    }
    ...
    public CoordinatorLayout(@NonNull Context context, @Nullable AttributeSet attributeSet, @AttrRes int i) {
        ...
        TypedArray obtainStyledAttributes = i == 0 ? context.obtainStyledAttributes(attributeSet, C0187R.styleable.CoordinatorLayout, 0, C0187R.style.Widget_Support_CoordinatorLayout) : context.obtainStyledAttributes(attributeSet, C0187R.styleable.CoordinatorLayout, i, 0);
        int resourceId = obtainStyledAttributes.getResourceId(C0187R.styleable.CoordinatorLayout_keylines, 0);
        if (resourceId != 0) {
        ...
        this.mStatusBarBackground = obtainStyledAttributes.getDrawable(C0187R.styleable.CoordinatorLayout_statusBarBackground);
        obtainStyledAttributes.recycle();
        setupForInsets();
    ...
    private void offsetChildByInset(View view, Rect rect, int i) {
        ...
        if (ViewCompat.isLaidOut(view) && view.getWidth() > 0 && view.getHeight() > 0) {
            ...
            if (behavior == null || !behavior.getInsetDodgeRect(this, view, acquireTempRect)) {
                ...
                StringBuilder a = C0681a.m330a("Rect should be within the child's bounds. Rect:");
                a.append(acquireTempRect.toShortString());
                a.append(" | Bounds:");
                a.append(acquireTempRect2.toShortString());
    ...
    static Behavior parseBehavior(Context context, AttributeSet attributeSet, String str) {
        ...
        try {
            ...
            throw new RuntimeException(C0681a.m320a("Could not inflate Behavior subclass ", str), e);
        }
    }
            ...
            if (view instanceof AttachedBehavior) {
                ...
                if (defaultBehavior != null) {
                    try {
                        ...
                        StringBuilder a = C0681a.m330a("Default behavior class ");
                        a.append(defaultBehavior.value().getName());
                        a.append(" could not be instantiated. Did you forget");
                        a.append(" a default constructor?");
