...
public final class MultiDex {
    ...
    private static final class C0391V4 {
        private C0391V4() {
        }
    ...
    private static void clearOldDexDir(Context context) throws Exception {
        ...
        if (file.isDirectory()) {
            StringBuilder a = C0681a.m330a("Clearing old secondary dex dir (");
            a.append(file.getPath());
            a.append(").");
            Log.i(TAG, a.toString());
            File[] listFiles = file.listFiles();
            if (listFiles == null) {
                StringBuilder a2 = C0681a.m330a("Failed to list secondary dex dir content (");
            ...
            for (File file2 : listFiles) {
                StringBuilder a3 = C0681a.m330a("Trying to delete old file ");
                a3.append(file2.getPath());
                a3.append(" of size ");
                a3.append(file2.length());
                Log.i(TAG, a3.toString());
                if (!file2.delete()) {
                    StringBuilder a4 = C0681a.m330a("Failed to delete old file ");
                    a4.append(file2.getPath());
                    Log.w(TAG, a4.toString());
                } else {
                    StringBuilder a5 = C0681a.m330a("Deleted old file ");
                    a5.append(file2.getPath());
                    Log.i(TAG, a5.toString());
                }
            }
            if (!file.delete()) {
                StringBuilder a6 = C0681a.m330a("Failed to delete secondary dex dir ");
                a6.append(file.getPath());
                Log.w(TAG, a6.toString());
                return;
            }
            StringBuilder a7 = C0681a.m330a("Deleted old secondary dex dir ");
    ...
    public static void install(Context context) {
        ...
        if (IS_VM_MULTIDEX_CAPABLE) {
            ...
            try {
                ...
                StringBuilder a = C0681a.m330a("MultiDex installation failed (");
    ...
    static boolean isVMMultidexCapable(String str) {
        ...
        StringBuilder c = C0681a.m340c("VM with version ", str);
        c.append(z ? " has multidex support" : " does not have multidex support");
    ...
    private static void mkdirChecked(File file) throws IOException {
        ...
        if (!file.isDirectory()) {
            File parentFile = file.getParentFile();
            if (parentFile == null) {
                StringBuilder a = C0681a.m330a("Failed to create dir ");
                a.append(file.getPath());
                a.append(". Parent file is null.");
                str = a.toString();
            } else {
                StringBuilder a2 = C0681a.m330a("Failed to create dir ");
                a2.append(file.getPath());
            ...
            Log.e(TAG, str);
            StringBuilder a3 = C0681a.m330a("Failed to create directory ");
