...
public class LinearSystem {
    ...
    private void displayRows() {
        ...
        while (true) {
            ...
            if (i < i2) {
                a.append(this.mRows[i]);
                str = C0681a.m320a(a.toString(), "\n");
                i++;
            } else {
                a.append(this.mGoal);
                a.append("\n");
    ...
    private void displaySolverVariables() {
        StringBuilder a = C0681a.m330a("Display Rows (");
        a.append(this.mNumRows);
        a.append("x");
        System.out.println(C0681a.m322a(a, this.mNumColumns, ")\n"));
    }
    ...
    private String getDisplaySize(int i) {
        ...
        int i3 = i2 / 1024;
        int i4 = i3 / 1024;
        return i4 > 0 ? C0681a.m317a("", i4, " Mb") : i3 > 0 ? C0681a.m317a("", i3, " Kb") : C0681a.m317a("", i2, " bytes");
    }
    ...
    public void displayReadableRows() {
        ...
        for (int i = 0; i < this.mNumRows; i++) {
            StringBuilder a = C0681a.m330a(str);
            a.append(this.mRows[i].toReadableString());
            str = C0681a.m320a(a.toString(), "\n #  ");
        }
        if (this.mGoal != null) {
    ...
    public void displaySystemInformations() {
        ...
        StringBuilder a = C0681a.m330a("Linear System -> Table size: ");
        a.append(this.TABLE_SIZE);
        a.append(" (");
        int i5 = this.TABLE_SIZE;
        a.append(getDisplaySize(i5 * i5));
        a.append(") -- row sizes: ");
        a.append(getDisplaySize(i));
        a.append(", actual size: ");
        a.append(getDisplaySize(i3));
        a.append(" rows: ");
        a.append(this.mNumRows);
        a.append("/");
        a.append(this.mMaxRows);
        a.append(" cols: ");
        a.append(this.mNumColumns);
        a.append("/");
        a.append(this.mMaxColumns);
        a.append(" ");
        a.append(0);
        a.append(" occupied cells, ");
        a.append(getDisplaySize(0));
