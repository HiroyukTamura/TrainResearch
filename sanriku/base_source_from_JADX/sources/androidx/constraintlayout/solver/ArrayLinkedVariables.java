...
public class ArrayLinkedVariables {
    ...
    public String toString() {
        ...
        int i2 = 0;
        while (i != -1 && i2 < this.currentSize) {
            StringBuilder a = C0681a.m330a(C0681a.m320a(str, " -> "));
            a.append(this.mArrayValues[i]);
            a.append(" : ");
            StringBuilder a2 = C0681a.m330a(a.toString());
            a2.append(this.mCache.mIndexedVariables[this.mArrayIndices[i]]);
            str = a2.toString();
            i = this.mArrayNextIndices[i];
            i2++;
        }
