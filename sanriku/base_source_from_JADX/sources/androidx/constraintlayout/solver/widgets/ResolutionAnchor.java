        ...
        if (this.state != 1 && this.type != 4) {
            ...
            if (this.type == 2 && (resolutionAnchor4 = this.target) != null && resolutionAnchor4.state == 1 && (resolutionAnchor5 = this.opposite) != null && (resolutionAnchor6 = resolutionAnchor5.target) != null && resolutionAnchor6.state == 1) {
                ...
                if (z) {
                    ...
                    resolutionAnchor11.resolvedOffset = (f8 * f2) + resolutionAnchor11.target.resolvedOffset + f7;
                    this.resolvedOffset = (this.target.resolvedOffset - f6) - ((1.0f - f2) * f8);
                } else {
                    this.resolvedOffset = (f8 * f2) + this.target.resolvedOffset + f6;
                    ResolutionAnchor resolutionAnchor12 = this.opposite;
                    resolutionAnchor12.resolvedOffset = (resolutionAnchor12.target.resolvedOffset - f7) - ((1.0f - f2) * f8);
                }
