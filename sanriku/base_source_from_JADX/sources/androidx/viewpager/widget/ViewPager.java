...
public class ViewPager extends ViewGroup {
    ...
    public interface OnPageChangeListener {
        ...
        void onPageScrolled(int i, float f, @C0042Px int i2);
    ...
    public static class SavedState extends AbsSavedState {
        ...
        public String toString() {
            StringBuilder a = C0681a.m330a("FragmentPager.SavedState{");
            a.append(Integer.toHexString(System.identityHashCode(this)));
            a.append(" position=");
            return C0681a.m322a(a, this.position, "}");
        }
    ...
    public void smoothScrollTo(int i, int i2, int i3) {
        ...
        int abs = Math.abs(i3);
        int min = Math.min(abs > 0 ? Math.round(Math.abs(distanceInfluenceForSnapDuration / ((float) abs)) * 1000.0f) * 4 : (int) (((((float) Math.abs(i6)) / ((this.mAdapter.getPageWidth(this.mCurItem) * f) + ((float) this.mPageMargin))) + 1.0f) * 100.0f), MAX_SETTLE_DURATION);
