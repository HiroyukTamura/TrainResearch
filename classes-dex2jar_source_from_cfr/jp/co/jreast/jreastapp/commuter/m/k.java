...
implements o {
    ...
    public e<List<Route>> a(a object, String string2) {
        ...
        object = this.a.a(string2).a(Executors.newSingleThreadExecutor()).a(h.a()).a(f.b.a.a.a(s2)).a().a(NorikaeApi.class).searchRoutes(object.a()).b(this.b.b()).a(this.b.a());
        j.a(object, "service.searchRoutes(req\u2026n(schedulerProvider.ui())");
        return object;
    }
}
