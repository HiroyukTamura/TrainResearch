...
implements Serializable {
    ...
    public k(String object) {
        j.b(object, "pattern");
        object = Pattern.compile((String)object);
        j.a(object, "Pattern.compile(pattern)");
        this((Pattern)object);
    }
    ...
    public final String a(CharSequence charSequence, String string2) {
        j.b(charSequence, "input");
        j.b(string2, "replacement");
        charSequence = this.b.matcher(charSequence).replaceAll(string2);
        j.a((Object)charSequence, "nativePattern.matcher(in\u2026).replaceAll(replacement)");
        return charSequence;
    }
    ...
    public String toString() {
        ...
        j.a((Object)string2, "nativePattern.toString()");
        return string2;
    }
