...
extends r {
     ...
     */
    public static final <T> void a(Appendable appendable, T object, b<? super T, ? extends CharSequence> b2) {
        void var1_3;
        void var2_5;
        j.b(appendable, "$receiver");
        if (var2_5 != null) {
            Object r2 = var2_5.a(object);
        } else {
        ...
        appendable.append((CharSequence)var1_3);
    }
}
