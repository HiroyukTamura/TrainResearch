...
public final class c {
    public static final <T> f<T> a(kotlin.reflect.c<T> c22) {
        block3 : {
            j.b(c22, "$receiver");
            for (kotlin.reflect.c<T> c22 : (Iterable)((kotlin.reflect.jvm.internal.j)c22).j()) {
                Object object = (f)((Object)c22);
                if (object != null) {
                    if ((object = ((m)object).b()) != null) {
                        if (!((l)object).r()) continue;
                        break block3;
                    }
                    throw new t("null cannot be cast to non-null type org.jetbrains.kotlin.descriptors.ConstructorDescriptor");
                }
                throw new t("null cannot be cast to non-null type kotlin.reflect.jvm.internal.KFunctionImpl");
            }
            c22 = null;
        }
        return (f)((Object)c22);
    ...
    private static final boolean a(h<?> h2) {
        return h2.c().d() != null;
    }

    public static final <T> Collection<n<T, ?>> b(kotlin.reflect.c<T> object) {
        j.b(object, "$receiver");
        Object object2 = ((j.a)((Object)((kotlin.reflect.jvm.internal.j)object).f().a())).g();
        object = new ArrayList();
        object2 = object2.iterator();
        while (object2.hasNext()) {
            Object e2 = object2.next();
            h h2 = (h)e2;
            boolean bl2 = c.b(h2) && h2 instanceof n;
            if (!bl2) continue;
            object.add(e2);
        }
        return (List)object;
    ...
    private static final boolean b(h<?> h2) {
        return c.a(h2) ^ true;
    }
}
