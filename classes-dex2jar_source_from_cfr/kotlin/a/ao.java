...
extends an {
    public static final <T> Set<T> a(Set<? extends T> set, Iterable<? extends T> iterable) {
        ...
        Serializable serializable = m.a(iterable);
        if (serializable != null) {
            n2 = ((Number)serializable).intValue();
            n2 = set.size() + n2;
        } else {
            n2 = set.size() * 2;
        }
        serializable = new LinkedHashSet(af.a(n2));
        ((AbstractCollection)((Object)serializable)).addAll((Collection)set);
        m.a((Collection)((Object)serializable), iterable);
        return (Set)((Object)serializable);
    }

    public static final <T> Set<T> a(Set<? extends T> set, T t2) {
        j.b(set, "$receiver");
        LinkedHashSet<T> linkedHashSet = new LinkedHashSet<T>(af.a(set.size() + 1));
