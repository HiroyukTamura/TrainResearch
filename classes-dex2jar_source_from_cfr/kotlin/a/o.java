...
extends n {
    ...
    public static final <T> Collection<T> a(T[] arrT) {
        j.b(arrT, "$receiver");
        return new f<T>(arrT, false);
    }
    ...
    public static final /* varargs */ <T> List<T> b(T ... arrT) {
        j.b(arrT, "elements");
        if (arrT.length > 0) {
            return g.a(arrT);
        }
    ...
    public static final /* varargs */ <T> List<T> c(T ... arrT) {
        j.b(arrT, "elements");
        if (arrT.length == 0) {
            return new ArrayList();
        }
        return new ArrayList((Collection)new f<T>(arrT, true));
    }
}
