...
final class RealBufferedSource implements BufferedSource
{
    ...
    @Override
    public long indexOf(final byte b, long n, final long l) throws IOException {
        if (this.closed) {
            throw new IllegalStateException("closed");
        }
        if (n >= 0L) {
            ...
            if (l >= n) {
                while (max < l) {
                    n = this.buffer.indexOf(b, max, l);
                    if (n != -1L) {
                        return n;
                    }
                    n = this.buffer.size;
                    if (n >= l || this.source.read(this.buffer, 8192L) == -1L) {
                        return -1L;
                    }
                    max = Math.max(max, n);
                }
        ...
        throw new IllegalArgumentException(String.format("fromIndex=%s toIndex=%s", n, l));
    }
    ...
    public InputStream inputStream() {
        return (InputStream)new RealBufferedSource$1(this);
    }
    ...
    public int read(final byte[] array, final int n, int n2) throws IOException {
        Util.checkOffsetAndCount((long)array.length, (long)n, (long)n2);
    ...
    public void readFully(final Buffer buffer, final long n) throws IOException {
        try {
            ...
            buffer.writeAll((Source)this.buffer);
            throw ex;
        }
    }
