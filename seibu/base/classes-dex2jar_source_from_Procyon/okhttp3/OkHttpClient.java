...
public class OkHttpClient implements Cloneable, Call$Factory, WebSocket$Factory
{
    ...
    static {
        ...
        Internal.instance = (Internal)new OkHttpClient$1();
    }
    ...
    public WebSocket newWebSocket(final Request request, final WebSocketListener webSocketListener) {
        final RealWebSocket realWebSocket = new RealWebSocket(request, webSocketListener, new Random());
    ...
    public static final class Builder
    {
        ...
        public Builder protocols(final List<Protocol> c) {
            final ArrayList list = new ArrayList<Protocol>(c);
            ...
            this.protocols = Collections.unmodifiableList((List<? extends Protocol>)list);
            return this;
        }
