...
public final class ConnectionPool
{
    ...
    public ConnectionPool(final int maxIdleConnections, final long n, final TimeUnit timeUnit) {
        this.cleanupRunnable = (Runnable)new ConnectionPool$1(this);
    ...
    Socket deduplicate(final Address address, final StreamAllocation streamAllocation) {
        ...
        } while (!realConnection.isEligible(address, (Route)null) || !realConnection.isMultiplexed() || realConnection == streamAllocation.connection());
