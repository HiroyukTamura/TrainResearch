...
public final class HttpUrl
{
    ...
    static String canonicalize(final String s, final int beginIndex, final int endIndex, final String s2, final boolean b, final boolean b2, final boolean b3, final boolean b4, final Charset charset) {
        int codePoint;
        for (int i = beginIndex; i < endIndex; i += Character.charCount(codePoint)) {
            ...
            if (codePoint < 32 || codePoint == 127 || (codePoint >= 128 && b4) || s2.indexOf(codePoint) != -1 || (codePoint == 37 && (!b || (b2 && !percentEncoded(s, i, endIndex)))) || (codePoint == 43 && b3)) {
                ...
                canonicalize(buffer, s, i, endIndex, s2, b, b2, b3, b4, charset);
        ...
        Label_0064:
            while (true) {
                ...
                while (true) {
                    ...
                    buffer.writeByte(37);
                    buffer.writeByte(HttpUrl.HEX_DIGITS[n2 >> 4 & 0xF]);
                    buffer.writeByte(HttpUrl.HEX_DIGITS[n2 & 0xF]);
                }
                break;
            }
        }
    ...
    static HttpUrl getChecked(final String s) throws MalformedURLException, UnknownHostException {
        ...
        final Builder.HttpUrl$Builder$ParseResult parse = builder.parse(null, s);
    ...
    public static HttpUrl parse(final String s) {
        HttpUrl build = null;
        final Builder builder = new Builder();
        if (builder.parse(null, s) == Builder.HttpUrl$Builder$ParseResult.SUCCESS) {
            build = builder.build();
        }
        return build;
    }
    ...
    static boolean percentEncoded(final String s, final int index, final int n) {
        return index + 2 < n && s.charAt(index) == '%' && Util.decodeHexDigit(s.charAt(index + 1)) != -1 && Util.decodeHexDigit(s.charAt(index + 2)) != -1;
    }
    ...
    public Builder newBuilder(final String s) {
        final Builder builder = new Builder();
        if (builder.parse(this, s) == Builder.HttpUrl$Builder$ParseResult.SUCCESS) {
            return builder;
        }
        return null;
    }
    ...
    public static final class Builder
    {
        ...
        Builder.HttpUrl$Builder$ParseResult parse(@Nullable final HttpUrl httpUrl, final String s) {
            ...
            if (schemeDelimiterOffset(s, skipLeadingAsciiWhitespace, skipTrailingAsciiWhitespace) != -1) {
                if (s.regionMatches(true, skipLeadingAsciiWhitespace, "https:", 0, 6)) {
                    ...
                    if (!s.regionMatches(true, skipLeadingAsciiWhitespace, "http:", 0, 5)) {
                        return Builder.HttpUrl$Builder$ParseResult.UNSUPPORTED_SCHEME;
                    }
                    this.scheme = "http";
                ...
                if (httpUrl == null) {
                    return Builder.HttpUrl$Builder$ParseResult.MISSING_SCHEME;
                }
            ...
            Label_0524: {
                ...
                Label_0207:
                        ...
                        switch (char1) {
                            ...
                            case 64: {
                                if (n4 == 0) {
                                    ...
                                    String s2 = HttpUrl.canonicalize(s, n5, delimiterOffset2, " \"':;<=>@[]^`{}|/\\?#", true, false, false, true, null);
                                    if (n != 0) {
                                    ...
                                    this.encodedPassword = this.encodedPassword + "%40" + HttpUrl.canonicalize(s, n5, delimiterOffset, " \"':;<=>@[]^`{}|/\\?#", true, false, false, true, null);
                                }
                    ...
                    if (portColonOffset + 1 < delimiterOffset) {
                        ...
                        if (this.port == -1) {
                            return Builder.HttpUrl$Builder$ParseResult.INVALID_PORT;
                        }
                    }
                    else {
                        this.host = canonicalizeHost(s, n5, portColonOffset);
                    ...
                    if (this.host == null) {
                        return Builder.HttpUrl$Builder$ParseResult.INVALID_HOST;
                    }
                    n6 = delimiterOffset;
                }
                else {
            ...
            return Builder.HttpUrl$Builder$ParseResult.SUCCESS;
        }
        ...
        public Builder setEncodedPathSegment(final int n, final String str) {
            ...
            final String canonicalize = HttpUrl.canonicalize(str, 0, str.length(), " \"<>^`{}|/\\?#", true, false, false, true, null);
        ...
        public Builder setPathSegment(final int n, final String str) {
            ...
            final String canonicalize = HttpUrl.canonicalize(str, 0, str.length(), " \"<>^`{}|/\\?#", false, false, false, true, null);
            if (this.isDot(canonicalize) || this.isDotDot(canonicalize)) {
                throw new IllegalArgumentException("unexpected path segment: " + str);
            }
            this.encodedPathSegments.set(n, canonicalize);
