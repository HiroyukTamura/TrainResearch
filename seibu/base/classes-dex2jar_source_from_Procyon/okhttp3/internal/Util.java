...
public final class Util
{
    ...
    static {
        ...
        NATURAL_ORDER = (Comparator)new Util$1();
    ...
    public static AssertionError assertionError(final String detailMessage, final Exception cause) {
        return (AssertionError)new AssertionError((Object)detailMessage).initCause(cause);
    }
    ...
    public static int checkDuration(final String str, final long duration, final TimeUnit timeUnit) {
        if (duration < 0L) {
            ...
            Label_0202: {
                ...
                while (true) {
                    ...
                    if (toffset + 2 <= n && s.regionMatches(toffset, "::", 0, 2)) {
                        ...
                        final int n5 = toffset + 2;
                        final int n8;
                        final int n6 = n7 = (n8 = n2 + 2);
                        n9 = n8;
                        if ((i = n5) == n) {
                            fromIndex = n8;
                            i = n6;
                    ...
                    final int n13 = n7 + 1;
                    array[n7] = (byte)(n10 >>> 8 & 0xFF);
                    final int n14 = n13 + 1;
                    array[n13] = (byte)(n10 & 0xFF);
                    n2 = n14;
                    n3 = n9;
                    n4 = n11;
                    toffset = i;
    ...
    private static String inet6AddressToAscii(final byte[] array) {
        ...
        while (j < array.length) {
            if (j == n) {
                ...
                buffer.writeHexadecimalUnsignedLong((array[j] & 0xFF) << 8 | (array[j + 1] & 0xFF));
                j += 2;
            }
        }
            ...
            while (true) {
                ...
                Label_0113: {
                    try {
                        ...
                        return false;
                        // iftrue(Label_0133:, a != 9223372036854775807L)
                        Block_7: {
                            break Block_7;
                            a = Long.MAX_VALUE;
                            continue;
    ...
    public static int skipTrailingAsciiWhitespace(final String s, final int n, int index) {
        --index;
        int n2 = 0;
    Label_0072:
        while (true) {
    ...
    public static ThreadFactory threadFactory(final String s, final boolean b) {
        return (ThreadFactory)new Util$2(s, b);
    }
