...
public class ConstraintWidgetContainer extends WidgetContainer
{
    ...
    public static ConstraintWidgetContainer createContainer(final ConstraintWidgetContainer constraintWidgetContainer, final String debugName, final ArrayList<ConstraintWidget> list, int index) {
        ...
        if (bounds.width == 0 || bounds.height == 0) {
            ...
            while (true) {
                ...
                final ConstraintWidget constraintWidget = list.get(index);
    ...
    private boolean optimize(final LinearSystem linearSystem) {
        ...
        while (true) {
            ...
            final ConstraintWidget constraintWidget = this.mChildren.get(index);
        ...
        while (true) {
            ...
            int n14;
            int n15;
            for (int i = 0; i < size; ++i, n12 = n15, n11 = n14) {
        ...
        int n18 = 0;
        int n19;
        for (int j = 0; j < size; ++j, n16 = n18, n17 = n19) {
    ...
    public void findWrapSize(final ArrayList<ConstraintWidget> list, final boolean[] array) {
        ...
        for (int i = 0; i < size; ++i) {
            ...
            if (!constraintWidget.isRoot()) {
                ...
                int b = constraintWidget.mDistToLeft + constraintWidget.mDistToRight - constraintWidget.getWidth();
                int b2 = constraintWidget.mDistToTop + constraintWidget.mDistToBottom - constraintWidget.getHeight();
                ...
                max5 = Math.max(max5, b);
                max6 = Math.max(max6, b2);
            }
        }
    ...
    public void layout() {
        ...
        Label_0322: {
            if (this.mOptimizationLevel == 2) {
                ...
                int n4;
                final int n3 = n4 = (this.flags[0] ? 1 : 0);
                Label_0221: {
                    if (max > 0) {
                        n4 = n3;
                        if (max2 > 0) {
        ...
        Label_0519_Outer:
                ...
                while (true) {
                    while (true) {
                        try {
                            this.mSystem.reset();
                            addChildrenToSolver = j;
                            final boolean b = (addChildrenToSolver = (this.addChildrenToSolver(this.mSystem, Integer.MAX_VALUE) ? 1 : 0)) != 0;
                            if (b) {
            ...
            if ((n2 = n12) == 0) {
                int n13 = addChildrenToSolver;
                int n14 = n12;
                if (this.mHorizontalDimensionBehaviour == DimensionBehaviour.WRAP_CONTENT) {
                    n13 = addChildrenToSolver;
                    n14 = n12;
                    if (max > 0) {
                        n13 = addChildrenToSolver;
                        n14 = n12;
    ...
    public int layoutFindGroups() {
        ...
        while (j != 0) {
            ...
            while (true) {
                ...
                final ConstraintWidget constraintWidget2 = this.mChildren.get(index);
                        ...
                        if (mTarget.mOwner.getParent() != null) {
                            ...
                            if (mTarget.mGroup != constraintAnchor.mGroup) {
                                ...
                                if (constraintAnchor.mGroup > mTarget.mGroup) {
                                    ...
                                    n14 = constraintAnchor.mGroup;
                                }
                                constraintAnchor.mGroup = n14;
                                mTarget.mGroup = n14;
                                n12 = n11 + 1;
                                n13 = 1;
                            }
