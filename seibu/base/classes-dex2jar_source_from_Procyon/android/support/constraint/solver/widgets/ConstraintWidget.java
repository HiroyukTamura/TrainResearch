...
public class ConstraintWidget
{
    ...
    public void addToSolver(final LinearSystem linearSystem, final int n) {
        ...
        if (this.mParent != null) {
            ...
            if (this.mParent.getHorizontalDimensionBehaviour() == DimensionBehaviour.WRAP_CONTENT && n3 == 0) {
        ...
        int n4;
        if ((n4 = this.mWidth) < this.mMinWidth) {
            n4 = this.mMinWidth;
        }
        int n5;
        if ((n5 = this.mHeight) < this.mMinHeight) {
            n5 = this.mMinHeight;
        }
        final boolean b5 = this.mHorizontalDimensionBehaviour != DimensionBehaviour.MATCH_CONSTRAINT;
        final boolean b6 = this.mVerticalDimensionBehaviour != DimensionBehaviour.MATCH_CONSTRAINT;
        int n6 = b5 ? 1 : 0;
        Label_0790: {
            if (!b5) {
                n6 = (b5 ? 1 : 0);
        ...
        int n10 = n7;
        int n11 = n5;
        float n12 = mDimensionRatio;
        int n13 = mDimensionRatioSide;
        int n14 = n8;
        if (this.mDimensionRatio > 0.0f) {
            ...
            if (this.mVisibility != 8) {
                if (this.mHorizontalDimensionBehaviour == DimensionBehaviour.MATCH_CONSTRAINT && this.mVerticalDimensionBehaviour == DimensionBehaviour.MATCH_CONSTRAINT) {
                    ...
                    n13 = 0;
                    n9 = (int)(this.mHeight * mDimensionRatio);
                    b7 = true;
                    n10 = n7;
                    n11 = n5;
                    n12 = mDimensionRatio;
        ...
        final boolean b8 = n14 != 0 && (n13 == 0 || n13 == -1);
        ...
        if (this.mHorizontalResolution != 2 && (n == Integer.MAX_VALUE || (this.mLeft.mGroup == n && this.mRight.mGroup == n))) {
            if (b8 && this.mLeft.mTarget != null && this.mRight.mTarget != null) {
                ...
                this.applyConstraints(linearSystem, b9, b7, this.mLeft, this.mRight, this.mX, this.mX + n9, n9, this.mMinWidth, this.mHorizontalBiasPercent, b8, (boolean)(n2 != 0), this.mMatchConstraintDefaultWidth, this.mMatchConstraintMinWidth, this.mMatchConstraintMaxWidth);
            }
        }
        if (this.mVerticalResolution != 2) {
            final boolean b10 = this.mVerticalDimensionBehaviour == DimensionBehaviour.WRAP_CONTENT && this instanceof ConstraintWidgetContainer;
            final boolean b11 = n14 != 0 && (n13 == 1 || n13 == -1);
            if (this.mBaselineDistance > 0) {
                ...
                if (n == Integer.MAX_VALUE || (this.mTop.mGroup == n && mBaseline.mGroup == n)) {
                    if (b11 && this.mTop.mTarget != null && this.mBottom.mTarget != null) {
                        ...
                        this.applyConstraints(linearSystem, b10, (boolean)(n10 != 0), this.mTop, mBaseline, this.mY, this.mY + mBaselineDistance, mBaselineDistance, this.mMinHeight, this.mVerticalBiasPercent, b11, b2, this.mMatchConstraintDefaultHeight, this.mMatchConstraintMinHeight, this.mMatchConstraintMaxHeight);
                        linearSystem.addEquality(objectVariable4, objectVariable3, n11, 5);
                    }
                }
            }
                ...
                if (b11 && this.mTop.mTarget != null && this.mBottom.mTarget != null) {
                    ...
                    this.applyConstraints(linearSystem, b10, (boolean)(n10 != 0), this.mTop, this.mBottom, this.mY, this.mY + n11, n11, this.mMinHeight, this.mVerticalBiasPercent, b11, b2, this.mMatchConstraintDefaultHeight, this.mMatchConstraintMinHeight, this.mMatchConstraintMaxHeight);
                }
            }
            if (n14 != 0) {
                ...
                if (n == Integer.MAX_VALUE || (this.mLeft.mGroup == n && this.mRight.mGroup == n)) {
                    if (n13 == 0) {
                        linearSystem.addConstraint(row5.createRowDimensionRatio(objectVariable2, objectVariable, objectVariable4, objectVariable3, n12));
                        return;
                    }
                    if (n13 == 1) {
                        linearSystem.addConstraint(row5.createRowDimensionRatio(objectVariable4, objectVariable3, objectVariable2, objectVariable, n12));
                        return;
                    }
                    ...
                    row5.createRowDimensionRatio(objectVariable2, objectVariable, objectVariable4, objectVariable3, n12);
    ...
    public void connect(final ConstraintAnchor.Type type, final ConstraintWidget constraintWidget, final ConstraintAnchor.Type type2, int n, final ConstraintAnchor.Strength strength, final int n2) {
        if (type == ConstraintAnchor.Type.CENTER) {
            ...
            if (anchor9.isValidConnection(anchor10)) {
                ...
                anchor9.connect(anchor10, n6, strength, n2);
