...
public class ConstraintSet
{
    ...
    public void center(final int i, final int n, final int n2, final int n3, final int n4, final int n5, final int n6, final float verticalBias) {
        if (n3 < 0) {
        ...
        if (n2 == 1 || n2 == 2) {
            ...
            this.mConstraints.get(i).horizontalBias = verticalBias;
            return;
        }
        if (n2 == 6 || n2 == 7) {
    ...
    public void connect(final int i, final int n, final int endToStart, final int n2) {
        if (!this.mConstraints.containsKey(i)) {
            this.mConstraints.put(i, new Constraint());
        }
    ...
    public void connect(final int i, final int n, final int endToStart, final int n2, final int n3) {
        if (!this.mConstraints.containsKey(i)) {
            this.mConstraints.put(i, new Constraint());
        }
        final Constraint constraint = this.mConstraints.get(i);
                    ...
                    while (true) {
                        Label_0111: {
                            try {
                                ...
                                final Constraint fillFromAttributeList = this.fillFromAttributeList(context, Xml.asAttributeSet((XmlPullParser)xml));
