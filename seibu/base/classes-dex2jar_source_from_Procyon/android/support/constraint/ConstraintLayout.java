...
public class ConstraintLayout extends ViewGroup
{
                ...
                if (!layoutParams.isGuideline) {
                    ...
                    if (n5 != 0) {
                        ...
                        if (width == 0 || width == -1) {
                            ...
                            n10 = getChildMeasureSpec(n, n4, width);
                            n11 = n7;
                        }
                        int n12;
                        if (height == 0 || height == -1) {
                            n12 = getChildMeasureSpec(n2, n3, -2);
                            n8 = 1;
                        }
                        else {
                            n12 = getChildMeasureSpec(n2, n3, height);
                            n8 = n9;
                        }
    ...
    protected void onMeasure(int b, int resolveSizeAndState) {
                    ...
                    if (view != null) {
                        ...
                        if (view.getVisibility() != 8) {
                            ...
                            if (layoutParams.width == -2) {
                                n7 = getChildMeasureSpec(b, n4, layoutParams.width);
                            }
                            else {
                                n7 = View$MeasureSpec.makeMeasureSpec(constraintWidget.getWidth(), 1073741824);
                            }
                            int n8;
                            if (layoutParams.height == -2) {
                                n8 = getChildMeasureSpec(resolveSizeAndState, n3, layoutParams.height);
                            }
                            else {
                                n8 = View$MeasureSpec.makeMeasureSpec(constraintWidget.getHeight(), 1073741824);
                            }
                            view.measure(n7, n8);
                            ...
                            if (Build$VERSION.SDK_INT >= 11) {
                                combineMeasuredStates = combineMeasuredStates(n2, view.getMeasuredState());
                                n6 = n10;
                            }
                        }
                    }
        ...
        final int n11 = this.mLayoutWidget.getWidth() + n4;
        final int n12 = this.mLayoutWidget.getHeight() + n3;
        if (Build$VERSION.SDK_INT >= 11) {
            b = resolveSizeAndState(n11, b, n);
            resolveSizeAndState = resolveSizeAndState(n12, resolveSizeAndState, n << 16);
