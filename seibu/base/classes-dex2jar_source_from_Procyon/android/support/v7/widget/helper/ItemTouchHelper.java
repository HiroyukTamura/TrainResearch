...
public class ItemTouchHelper extends ItemDecoration implements OnChildAttachStateChangeListener
{
    ...
    public abstract static class Callback
    {
        ...
        public int interpolateOutOfBoundsScroll(final RecyclerView recyclerView, int n, final int a, int maxDragScroll, final long n2) {
            ...
            n = (int)((int)Math.signum((float)a) * maxDragScroll * Callback.sDragViewScrollCapInterpolator.getInterpolation(Math.min(1.0f, 1.0f * Math.abs(a) / n)));
            float n3;
            if (n2 > 2000L) {
                n3 = 1.0f;
            }
            ...
            n *= (int)Callback.sDragScrollInterpolator.getInterpolation(n3);
            if (n != 0) {
                return n;
            }
            if (a > 0) {
