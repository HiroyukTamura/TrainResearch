...
public class StaggeredGridLayoutManager extends LayoutManager implements ScrollVectorProvider
{
    ...
    private int fill(final Recycler recycler, final LayoutState layoutState, final State state) {
        ...
        while (layoutState.hasMore(state) && (this.mLayoutState.mInfinite || !this.mRemainingSpans.isEmpty())) {
            ...
            if (this.isLayoutRTL() && this.mOrientation == 1) {
                ...
                final int n10 = endAfterPadding - this.mSecondaryOrientation.getDecoratedMeasurement(next);
                n11 = endAfterPadding;
                startAfterPadding = n10;
            }
            else {
                if (layoutParams.mFullSpan) {
                ...
                n11 = startAfterPadding + this.mSecondaryOrientation.getDecoratedMeasurement(next);
            }
            if (this.mOrientation == 1) {
                ((RecyclerView.LayoutManager)this).layoutDecoratedWithMargins(next, startAfterPadding, n5, n11, n6);
            }
            else {
                ((RecyclerView.LayoutManager)this).layoutDecoratedWithMargins(next, n5, startAfterPadding, n6, n11);
            }
            if (layoutParams.mFullSpan) {
        ...
        if (b3 > 0) {
            return Math.min(layoutState.mAvailable, b3);
        }
        return 0;
    }
            ...
            if (((RecyclerView.LayoutManager)this).getChildCount() > 0 && (this.mPendingSavedState == null || this.mPendingSavedState.mSpanOffsetsSize < 1)) {
                if (mAnchorInfo.mInvalidateOffsets) {
                    ...
                    for (int k = 0; k < this.mSpanCount; ++k) {
                        final Span span = this.mSpans[k];
                        span.clear();
                        span.setLine(this.mAnchorInfo.mSpanReferenceLines[k]);
                    }
                }
            }
    ...
    private void updateLayoutState(final int mCurrentPosition, final State state) {
        ...
        this.mLayoutState.mInfinite = (this.mPrimaryOrientation.getMode() == 0 && this.mPrimaryOrientation.getEnd() == 0 && b);
    }
    ...
    public void collectAdjacentPrefetchPositions(int toIndex, int i, final State state, final LayoutPrefetchRegistry layoutPrefetchRegistry) {
        ...
        if (((RecyclerView.LayoutManager)this).getChildCount() != 0 && toIndex != 0) {
            ...
            int n;
            int n2;
            for (i = 0; i < this.mSpanCount; ++i, toIndex = n2) {
                ...
                n2 = toIndex;
                if (n >= 0) {
                    this.mPrefetchDistances[toIndex] = n;
                    n2 = toIndex + 1;
                }
            }
            Arrays.sort(this.mPrefetchDistances, 0, toIndex);
            LayoutState mLayoutState;
            for (i = 0; i < toIndex && this.mLayoutState.hasMore(state); ++i) {
    ...
    public View onFocusSearchFailed(View view, int n, final Recycler recycler, final State state) {
        if (((RecyclerView.LayoutManager)this).getChildCount() == 0) {
            ...
            if (!mFullSpan) {
                ...
                view = ((RecyclerView.LayoutManager)this).findViewByPosition(n3);
                if (view != null && view != containingItemView) {
                    return view;
                }
            }
            if (this.preferLastSpan(convertFocusDirectionToLayoutDirection)) {
                for (int k = this.mSpanCount - 1; k >= 0; --k) {
                    if (k != mSpan.mIndex) {
                        ...
                        view = ((RecyclerView.LayoutManager)this).findViewByPosition(n4);
                        if (view != null && view != containingItemView) {
                            return view;
                        }
                    }
                ...
                for (int l = 0; l < this.mSpanCount; ++l) {
                    ...
                    view = ((RecyclerView.LayoutManager)this).findViewByPosition(n5);
                    if (view != null && view != containingItemView) {
                        return view;
                    }
                }
    ...
    public void setMeasuredDimension(final Rect rect, int chooseSize, int chooseSize2) {
        ...
        if (this.mOrientation == 1) {
            ...
            chooseSize2 = RecyclerView.LayoutManager.chooseSize(chooseSize, this.mSizePerSpan * this.mSpanCount + n, ((RecyclerView.LayoutManager)this).getMinimumWidth());
            ...
            chooseSize = RecyclerView.LayoutManager.chooseSize(chooseSize2, this.mSizePerSpan * this.mSpanCount + n2, ((RecyclerView.LayoutManager)this).getMinimumHeight());
    ...
    class Span
    {
        ...
        int findOnePartiallyOrCompletelyVisibleChild(int n, final int n2, final boolean b, final boolean b2, final boolean b3) {
