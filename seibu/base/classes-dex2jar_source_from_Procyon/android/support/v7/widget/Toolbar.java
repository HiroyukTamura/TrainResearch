...
public class Toolbar extends ViewGroup
{
        ...
        Label_0852: {
            ...
            if (b2) {
                ...
                if (shouldLayout) {
                    ...
                    final int n7 = n5 - this.mTitleTextView.getMeasuredWidth();
                    final int n8 = i + this.mTitleTextView.getMeasuredHeight();
                    this.mTitleTextView.layout(n7, i, n5, n8);
                    a = n7 - this.mTitleMarginEnd;
                ...
                if (shouldLayout) {
                    ...
                    final int n11 = n9 + this.mTitleTextView.getMeasuredWidth();
                    final int n12 = i + this.mTitleTextView.getMeasuredHeight();
                    this.mTitleTextView.layout(n9, i, n11, n12);
                ...
                if (shouldLayout2) {
                    ...
                    i = n10 + layoutParams8.topMargin;
                    final int n13 = k + this.mSubtitleTextView.getMeasuredWidth();
                    this.mSubtitleTextView.layout(k, i, n13, i + this.mSubtitleTextView.getMeasuredHeight());
                    b6 = n13 + this.mTitleMarginEnd;
    ...
    protected void onMeasure(int resolveSizeAndState, final int n) {
        ...
        final int n4 = 0 + Math.max(currentContentInsetStart, b);
        ...
        final int n5 = n4 + Math.max(currentContentInsetEnd, b2);
