                        ...
                        Label_0160: {
                            synchronized (TintContextWrapper.CACHE_LOCK) {
                                if (TintContextWrapper.sCache == null) {
                                    ...
                                    if (index >= 0) {
                                        final WeakReference<TintContextWrapper> weakReference = TintContextWrapper.sCache.get(index);
                                        ...
                                        index = TintContextWrapper.sCache.size() - 1;
                                        if (index >= 0) {
                                            final WeakReference<TintContextWrapper> weakReference2 = TintContextWrapper.sCache.get(index);
