...
public class ActionBarOverlayLayout extends ViewGroup implements DecorContentParent, NestedScrollingParent
{
    ...
    public ActionBarOverlayLayout(final Context context, final AttributeSet set) {
        ...
        this.mAddActionBarHideOffset = new Runnable() {
            ...
            public void run() {
                ActionBarOverlayLayout.this.haltActionBarHideOffsetAnimations();
                ActionBarOverlayLayout.this.mCurrentActionBarTopAnimator = ViewCompat.animate((View)ActionBarOverlayLayout.this.mActionBarTop).translationY((float)(-ActionBarOverlayLayout.this.mActionBarTop.getHeight())).setListener(ActionBarOverlayLayout.this.mTopAnimatorListener);
            }
        };
        this.init(context);
    ...
    public void setActionBarHideOffset(int max) {
        ...
        ViewCompat.setTranslationY((View)this.mActionBarTop, (float)(-max));
    }
