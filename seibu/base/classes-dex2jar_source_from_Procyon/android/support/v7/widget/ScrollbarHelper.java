            ...
            if (state.getItemCount() != 0) {
                ...
                if (view != null) {
                    if (view2 == null) {
                        ...
                        n2 = n3;
                        if (b) {
                            return Math.round(n3 * (Math.abs(orientationHelper.getDecoratedEnd(view2) - orientationHelper.getDecoratedStart(view)) / (float)(Math.abs(layoutManager.getPosition(view) - layoutManager.getPosition(view2)) + 1)) + (orientationHelper.getStartAfterPadding() - orientationHelper.getDecoratedStart(view)));
                        }
                    }
                }
            }
