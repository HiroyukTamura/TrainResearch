...
public class GridLayoutManager extends LinearLayoutManager
{
    ...
    public View onFocusSearchFailed(View view, int n, final Recycler recycler, final State state) {
        ...
        if (containingItemView == null) {
            ...
            int n8;
            View view5;
            for (int i = n; i != childCount; i += n2, view3 = view5, n4 = n8, n3 = mSpanIndex3, view = view4, n6 = n7, n5 = mSpanIndex2) {
                ...
                if (child.hasFocusable() && n != spanGroupIndex) {
                    ...
                    if ((child.hasFocusable() && view3 == null) || (!child.hasFocusable() && view == null)) {
                        ...
                        if (child.hasFocusable()) {
                            if (n10 > n4) {
                                ...
                                n = n9;
                                if (n10 == n4) {
                                    final boolean b3 = mSpanIndex4 > n3;
                                    n = n9;
                                    if (b2 == b3) {
                                        n = 1;
                                    }
                            ...
                            if (view3 == null) {
                                ...
                                if (((RecyclerView.LayoutManager)this).isViewPartiallyVisible(child, false, true)) {
                                    if (n10 > n6) {
                                        ...
                                        n = n9;
                                        if (n10 == n6) {
                                            final boolean b4 = mSpanIndex4 > n5;
                                            n = n9;
                                            if (b2 == b4) {
                                                n = 1;
                                            }
                    ...
                    if (n != 0) {
                        if (child.hasFocusable()) {
                            ...
                            n8 = Math.min(a, b) - Math.max(mSpanIndex4, mSpanIndex);
                            view5 = child;
                            view4 = view;
                            n7 = n6;
                            mSpanIndex2 = n5;
                            ...
                            n7 = Math.min(a, b) - Math.max(mSpanIndex4, mSpanIndex);
                            view5 = view3;
                            n8 = n4;
                            mSpanIndex3 = n3;
                            view4 = child;
