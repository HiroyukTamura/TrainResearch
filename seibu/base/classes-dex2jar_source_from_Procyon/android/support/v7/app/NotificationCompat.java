...
public class NotificationCompat extends android.support.v4.app.NotificationCompat
{
    ...
    private static void addBigStyleToBuilderJellybean(final Notification notification, final android.support.v4.app.NotificationCompat.Builder builder) {
        if (builder.mStyle instanceof MediaStyle) {
            ...
            android.support.v7.app.NotificationCompatImplBase.overrideMediaBigContentView(notification, builder.mContext, builder.mContentTitle, builder.mContentText, builder.mContentInfo, builder.mNumber, builder.mLargeIcon, builder.mSubText, builder.mUseChronometer, builder.getWhenIfShowing(), builder.getPriority(), 0, builder.mActions, mediaStyle.mShowCancelButton, mediaStyle.mCancelButtonIntent, b);
            if (b) {
                android.support.v7.app.NotificationCompatImplBase.buildIntoRemoteViews(builder.mContext, notification.bigContentView, remoteViews);
            }
        }
    ...
    private static void addBigStyleToBuilderLollipop(final Notification notification, final android.support.v4.app.NotificationCompat.Builder builder) {
        ...
        if (builder.mStyle instanceof DecoratedMediaCustomViewStyle && remoteViews != null) {
            android.support.v7.app.NotificationCompatImplBase.overrideMediaBigContentView(notification, builder.mContext, builder.mContentTitle, builder.mContentText, builder.mContentInfo, builder.mNumber, builder.mLargeIcon, builder.mSubText, builder.mUseChronometer, builder.getWhenIfShowing(), builder.getPriority(), 0, builder.mActions, false, null, true);
            android.support.v7.app.NotificationCompatImplBase.buildIntoRemoteViews(builder.mContext, notification.bigContentView, remoteViews);
    ...
    private static void addDecoratedHeadsUpToBuilderLollipop(final Notification notification, final android.support.v4.app.NotificationCompat.Builder builder) {
        ...
        final RemoteViews applyStandardTemplateWithActions = android.support.v7.app.NotificationCompatImplBase.applyStandardTemplateWithActions(builder.mContext, builder.mContentTitle, builder.mContentText, builder.mContentInfo, builder.mNumber, notification.icon, builder.mLargeIcon, builder.mSubText, builder.mUseChronometer, builder.getWhenIfShowing(), builder.getPriority(), builder.getColor(), R.layout.notification_template_custom_big, false, builder.mActions);
        android.support.v7.app.NotificationCompatImplBase.buildIntoRemoteViews(builder.mContext, applyStandardTemplateWithActions, contentView);
    ...
    private static void addHeadsUpToBuilderLollipop(final Notification notification, final android.support.v4.app.NotificationCompat.Builder builder) {
        ...
        if (builder.mStyle instanceof DecoratedMediaCustomViewStyle && remoteViews != null) {
            notification.headsUpContentView = android.support.v7.app.NotificationCompatImplBase.generateMediaBigView(builder.mContext, builder.mContentTitle, builder.mContentText, builder.mContentInfo, builder.mNumber, builder.mLargeIcon, builder.mSubText, builder.mUseChronometer, builder.getWhenIfShowing(), builder.getPriority(), 0, builder.mActions, false, null, true);
            android.support.v7.app.NotificationCompatImplBase.buildIntoRemoteViews(builder.mContext, notification.headsUpContentView, remoteViews);
    ...
    private static void addMessagingFallBackStyle(final MessagingStyle messagingStyle, final NotificationBuilderWithBuilderAccessor notificationBuilderWithBuilderAccessor, final android.support.v4.app.NotificationCompat.Builder builder) {
        ...
        android.support.v7.app.NotificationCompatImplJellybean.addBigTextStyle(notificationBuilderWithBuilderAccessor, (CharSequence)spannableStringBuilder);
    }
    ...
    private static RemoteViews getDecoratedContentView(final android.support.v4.app.NotificationCompat.Builder builder) {
        ...
        android.support.v7.app.NotificationCompatImplBase.buildIntoRemoteViews(builder.mContext, applyStandardTemplateWithActions, builder.getContentView());
