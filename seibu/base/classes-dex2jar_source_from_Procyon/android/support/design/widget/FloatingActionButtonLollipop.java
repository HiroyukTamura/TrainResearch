...
class FloatingActionButtonLollipop extends FloatingActionButtonIcs
{
    ...
    FloatingActionButtonLollipop(final VisibilityAwareImageButton visibilityAwareImageButton, final ShadowViewDelegate shadowViewDelegate, final ValueAnimatorCompat.Creator creator) {
    ...
    void onElevationsChanged(final float elevation, final float translationZ) {
        if (Build$VERSION.SDK_INT == 21) {
            ...
            set3.playSequentially(new Animator[] { (Animator)ObjectAnimator.ofFloat((Object)this.mView, "elevation", new float[] { elevation }).setDuration(0L), (Animator)ObjectAnimator.ofFloat((Object)this.mView, View.TRANSLATION_Z, new float[] { this.mView.getTranslationZ() }).setDuration(100L), (Animator)ObjectAnimator.ofFloat((Object)this.mView, View.TRANSLATION_Z, new float[] { 0.0f }).setDuration(100L) });
