        ...
        return new ObjectConstructor<T>() {
            ...
            public T construct() {
                try {
                    ...
                    throw new RuntimeException("Unable to invoke no-args constructor for " + type + ". Registering an InstanceCreator with Gson for this type may fix this problem.", cause);
                }
            }
        };
    }
