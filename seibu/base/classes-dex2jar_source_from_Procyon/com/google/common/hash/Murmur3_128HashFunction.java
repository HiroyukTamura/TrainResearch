    ...
    private static final class Murmur3_128Hasher extends AbstractStreamingHasher
    {
        ...
        protected void processRemaining(final ByteBuffer byteBuffer) {
            ...
            switch (byteBuffer.remaining()) {
                ...
                case 15: {
                    n3 = (0x0L ^ (long)UnsignedBytes.toInt(byteBuffer.get(14)) << 48);
                }
                case 14: {
                    n4 = (n3 ^ (long)UnsignedBytes.toInt(byteBuffer.get(13)) << 40);
                }
                case 13: {
                    n5 = (n4 ^ (long)UnsignedBytes.toInt(byteBuffer.get(12)) << 32);
                }
                case 12: {
                    n6 = (n5 ^ (long)UnsignedBytes.toInt(byteBuffer.get(11)) << 24);
                }
                case 11: {
                    n7 = (n6 ^ (long)UnsignedBytes.toInt(byteBuffer.get(10)) << 16);
                }
                case 10: {
                    n8 = (n7 ^ (long)UnsignedBytes.toInt(byteBuffer.get(9)) << 8);
                }
                case 9: {
                    n9 = (n8 ^ (long)UnsignedBytes.toInt(byteBuffer.get(8)));
                }
                case 8: {
                ...
                case 7: {
                    n10 = (0x0L ^ (long)UnsignedBytes.toInt(byteBuffer.get(6)) << 48);
                }
                case 6: {
                    n11 = (n10 ^ (long)UnsignedBytes.toInt(byteBuffer.get(5)) << 40);
                }
                case 5: {
                    n12 = (n11 ^ (long)UnsignedBytes.toInt(byteBuffer.get(4)) << 32);
                }
                case 4: {
                    n13 = (n12 ^ (long)UnsignedBytes.toInt(byteBuffer.get(3)) << 24);
                }
                case 3: {
                    n14 = (n13 ^ (long)UnsignedBytes.toInt(byteBuffer.get(2)) << 16);
                }
                case 2: {
                    n = (n14 ^ (long)UnsignedBytes.toInt(byteBuffer.get(1)) << 8);
                }
                case 1: {
                    n15 = (n ^ (long)UnsignedBytes.toInt(byteBuffer.get(0)));
                    break;
                }
            }
            this.h1 ^= mixK1(n15);
