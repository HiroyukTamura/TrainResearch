...
final class EANManufacturerOrgSupport
{
    ...
    private void add(final int[] array, final String s) {
        this.ranges.add(array);
        this.countryIdentifiers.add(s);
    }
