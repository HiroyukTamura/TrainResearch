...
{
    private final Map<zzbbe<?>, Boolean> zzaCR;
    private final Map<TaskCompletionSource<?>, Boolean> zzaCS;
    
    public zzbbt() {
        this.zzaCR = Collections.synchronizedMap(new WeakHashMap<zzbbe<?>, Boolean>());
        this.zzaCS = Collections.synchronizedMap(new WeakHashMap<TaskCompletionSource<?>, Boolean>());
    }
    
    private final void zza(final boolean p0, final Status p1) {
        // 
        // This method could not be decompiled.
        // 
        // Original Bytecode:
        // 
        //     1: getfield        com/google/android/gms/internal/zzbbt.zzaCR:Ljava/util/Map;
        //     4: astore_3       
        //     5: aload_3        
        //     6: monitorenter   
        ...
        //    10: dup            
        //    11: aload_0        
        //    12: getfield        com/google/android/gms/internal/zzbbt.zzaCR:Ljava/util/Map;
        //    15: invokespecial   java/util/HashMap.<init>:(Ljava/util/Map;)V
        //    18: astore          4
        //    20: aload_3        
        //    21: monitorexit    
        //    22: aload_0        
        //    23: getfield        com/google/android/gms/internal/zzbbt.zzaCS:Ljava/util/Map;
        //    26: astore          5
        //    28: aload           5
        //    30: monitorenter   
        ...
        //    34: dup            
        //    35: aload_0        
        //    36: getfield        com/google/android/gms/internal/zzbbt.zzaCS:Ljava/util/Map;
        ...
        //   109: checkcast       Lcom/google/android/gms/internal/zzbbe;
        //   112: aload_2        
        //   113: invokevirtual   com/google/android/gms/internal/zzbbe.zzs:(Lcom/google/android/gms/common/api/Status;)V
        //   116: goto            60
        //   119: astore_2       
        //   120: aload_3        
        //   121: monitorexit    
    ...
    final void zza(final zzbbe<? extends Result> zzbbe, final boolean b) {
        this.zzaCR.put(zzbbe, b);
    ...
    final <TResult> void zza(final TaskCompletionSource<TResult> taskCompletionSource, final boolean b) {
        this.zzaCS.put(taskCompletionSource, b);
        taskCompletionSource.getTask().addOnCompleteListener((OnCompleteListener<TResult>)new zzbbv(this, taskCompletionSource));
    }
