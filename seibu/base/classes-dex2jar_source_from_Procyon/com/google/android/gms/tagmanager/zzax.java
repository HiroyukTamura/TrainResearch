...
final class zzax extends SQLiteOpenHelper
{
    ...
    zzax(final zzat zzbEt, final Context context, final String s) {
        this.zzbEt = zzbEt;
            ...
            if (Build$VERSION.SDK_INT < 15) {
                while (true) {
                    ...
                    try {
                        ...
                        rawQuery2.close();
                        if (!zza("datalayer", rawQuery)) {
                            rawQuery.execSQL(zzat.zzbEn);
                            return;
                        }
                    }
                    finally {
                    ...
                    rawQuery = (SQLiteDatabase)sqLiteDatabase.rawQuery("SELECT * FROM datalayer WHERE 0", (String[])null);
