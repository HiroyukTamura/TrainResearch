...
public class GenericRequestBuilder<ModelType, DataType, ResourceType, TranscodeType> implements Cloneable
{
    ...
    public GenericRequestBuilder<ModelType, DataType, ResourceType, TranscodeType> clone() {
        try {
            ...
            ChildLoadProvider<ModelType, DataType, ResourceType, TranscodeType> clone;
            if (this.loadProvider != null) {
                clone = this.loadProvider.clone();
            }
            else {
                clone = null;
            }
    ...
    public GenericRequestBuilder<ModelType, DataType, ResourceType, TranscodeType> sizeMultiplier(final float f) {
        if (f < 0.0f || f > 1.0f) {
    ...
    public GenericRequestBuilder<ModelType, DataType, ResourceType, TranscodeType> thumbnail(final float f) {
        if (f < 0.0f || f > 1.0f) {
            throw new IllegalArgumentException("sizeMultiplier must be between 0 and 1");
        }
    ...
    public GenericRequestBuilder<ModelType, DataType, ResourceType, TranscodeType> thumbnail(final GenericRequestBuilder<?, ?, ?, TranscodeType> genericRequestBuilder) {
