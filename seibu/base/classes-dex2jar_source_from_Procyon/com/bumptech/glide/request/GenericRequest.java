...
public final class GenericRequest<A, T, Z, R> implements Request, SizeReadyCallback, ResourceCallback
{
    ...
    private static void check(final String str, final Object o, final String str2) {
        if (o == null) {
    ...
    private void onResourceReady(final Resource<?> resource, final R r) {
        ...
        if (Log.isLoggable("GenericRequest", 2)) {
            this.logV("Resource ready in " + LogTime.getElapsedMillis(this.startTime) + " size: " + resource.getSize() * 9.5367431640625E-7 + " fromCache: " + this.loadedFromMemoryCache);
        }
    }
    ...
    @Override
    public void onResourceReady(final Resource<?> obj) {
        if (obj == null) {
        ...
        if (value == null || !this.transcodeClass.isAssignableFrom(value.getClass())) {
            ...
            final StringBuilder append = new StringBuilder().append("Expected to receive an object of ").append(this.transcodeClass).append(" but instead got ");
            Serializable class1;
            if (value != null) {
            ...
            final StringBuilder append2 = append.append(class1).append("{").append(value).append("}").append(" inside Resource{").append(obj).append("}.");
            String str;
            if (value != null) {
                str = "";
            }
            ...
            this.onException(new Exception(append2.append(str).toString()));
            return;
        }
        ...
        this.onResourceReady(obj, (R)value);
    }
