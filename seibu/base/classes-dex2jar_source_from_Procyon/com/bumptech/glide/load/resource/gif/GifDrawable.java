...
public class GifDrawable extends GlideDrawable implements FrameCallback
{
    ...
    GifDrawable(final GifState state) {
        ...
        (this.frameLoader = new GifFrameLoader(state.context, (GifFrameLoader.FrameCallback)this, this.decoder, state.targetWidth, state.targetHeight)).setFrameTransformation(state.frameTransformation);
    }
    
    public GifDrawable(final GifDrawable gifDrawable, final Bitmap bitmap, final Transformation<Bitmap> transformation) {
