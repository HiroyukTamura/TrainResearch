...
public class Engine implements EngineJobListener, ResourceRemovedListener, ResourceListener
{
    ...
    private EngineResource<?> loadFromActiveResources(final Key key, final boolean b) {
        if (b) {
            ...
            if (weakReference != null) {
                final EngineResource<?> engineResource = weakReference.get();
    ...
    private EngineResource<?> loadFromCache(final Key key, final boolean b) {
        ...
        if (!b) {
            ...
            if ((engineResource = engineResourceFromCache) != null) {
    ...
    private static void logWithTimeAndKey(final String str, final long n, final Key obj) {
        Log.v("Engine", str + " in " + LogTime.getElapsedMillis(n) + "ms, key: " + obj);
    }
