...
class NeuQuant
{
    ...
    Label_0171_Outer:
        ...
        Label_0289:
            while (true) {
                ...
                n2 = n + 1;
                final int[] array = network[n];
                try {
                    array[0] -= (array[0] - n3) * n10 / 262144;
                    array[1] -= (array[1] - n4) * n10 / 262144;
                    array[2] -= (array[2] - n5) * n10 / 262144;
                    n = n2;
                    if (n9 > n6) {
                        final int[][] network2 = this.network;
                        n2 = n9 - 1;
                        final int[] array2 = network2[n9];
                        try {
                            array2[0] -= (array2[0] - n3) * n10 / 262144;
                            array2[1] -= (array2[1] - n4) * n10 / 262144;
                            array2[2] -= (array2[2] - n5) * n10 / 262144;
                            n9 = n2;
                            n2 = n8;
                        }
                        catch (Exception ex) {
    ...
    protected int contest(final int n, final int n2, final int n3) {
        ...
        int n15;
        int n17;
        for (int i = 0; i < 256; ++i, n5 = n17, n4 = n15) {
    ...
    public void inxbuild() {
        ...
        int n10;
        int n11;
        for (int i = 0; i < 256; ++i, n = n10, n2 = n11) {
            final int[] array = this.network[i];
            int n3 = i;
            int n4 = array[1];
            int n5;
            for (int j = i + 1; j < 256; ++j, n4 = n5) {
            ...
            final int[] array3 = this.network[n3];
            if (i != n3) {
                ...
                array3[1] = array[1];
                array[1] = n7;
                final int n8 = array3[2];
                array3[2] = array[2];
                array[2] = n8;
                final int n9 = array3[3];
                array3[3] = array[3];
                array[3] = n9;
            }
            n10 = n;
    ...
    public void learn() {
        ...
        for (int i = 0; i < n6; ++i) {
            this.radpower[i] = (n6 * n6 - i * i) * 256 / (n6 * n6) * 1024;
        }
        int n7;
        if (this.lengthcount < 1509) {
            n7 = 3;
        ...
        int n8 = n6;
        while (j < n2) {
            final int n9 = (thepicture[n + 0] & 0xFF) << 4;
            final int n10 = (thepicture[n + 1] & 0xFF) << 4;
            final int n11 = (thepicture[n + 2] & 0xFF) << 4;
            final int contest = this.contest(n9, n10, n11);
            this.altersingle(n4, contest, n9, n10, n11);
            if (n8 != 0) {
                this.alterneigh(n8, contest, n9, n10, n11);
            }
            final int n12 = n + n7;
            int n13;
            if ((n13 = n12) >= lengthcount) {
                n13 = n12 - this.lengthcount;
            }
            final int n14 = j + 1;
            int n15;
            if ((n15 = n3) == 0) {
            ...
            n = n13;
            if (n14 % n15 == 0) {
                final int n16 = n4 - n4 / this.alphadec;
                final int n17 = n5 - n5 / 30;
                int n18;
                if ((n18 = n17 >> 6) <= 1) {
                    n18 = 0;
                }
                ...
                while (true) {
                    ...
                    this.radpower[n19] = (n18 * n18 - n19 * n19) * 256 / (n18 * n18) * n16;
                    ++n19;
                }
            }
        }
